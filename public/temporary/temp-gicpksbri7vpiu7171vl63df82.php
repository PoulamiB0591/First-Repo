        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff"><a href="uid-gicpksbri7vpiu7171vl63df82/index.php" title="Kies je tegel en foto"  class="active">1) Kies je tegel en foto</a></li>
                    	<li class="explicit_edit enteroff"><a class="" href="uid-gicpksbri7vpiu7171vl63df82/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff"><a class="" href="uid-gicpksbri7vpiu7171vl63df82/bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
                    </ul>
                    </div>
                </div><!-- end of container -->
            </div><!-- end of top -->           
            ...
            <!-- end of masterslider -->
                ...
                <p class="explicit_edit upload_fbbt">
                	<a class="" style="cursor: pointer;" id="getprf" onclick="facebookconnect();"><span class="explicit_edit">Gebruik mijn</span><strong class="explicit_edit">PROFIELFOTO</strong></a>
                     ...
                     <form class="upload_fbbt" enctype="multipart/form-data" method="post" id="target" action="uid-gicpksbri7vpiu7171vl63df82/run.php">
                	...
                	<p class="explicit_edit"><a class="" style="cursor:pointor;"><span class="explicit_edit">Upload je eigen</span><strong class="explicit_edit">FOTO</strong></a>
                     ...
                     <form method="post" id="targetfb" action="uid-gicpksbri7vpiu7171vl63df82/save.php">
