...
@require_once ($_SERVER['DOCUMENT_ROOT']."/facePub/facebook/facebook.php");  
   $facebook = new Facebook(array(
			...
			'secret' => '95a245e556432f1dd8fffe2fee9b54ec',
			'cookie' => true)
	     );
...
if(is_array( $str )){
       ...
       $sql = mysql_query("select * from  `userTemplate` where `pageId`='".$page_id."' and `appId` = '898221286878657'");
...
?>
<iframe name="iframe2" src="<?php echo 'https://'.$_SERVER['SERVER_NAME'].'/facebook/pageTab/'.$arrayData['facebook_number'].'/index.php';?>" style="border: 0; width: 100%; height: 1549px;"></iframe>
<div id="fb-root"></div>
