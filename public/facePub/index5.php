...
@require_once ($_SERVER['DOCUMENT_ROOT']."/facePub/facebook/facebook.php");  
   $facebook = new Facebook(array(
			...
			'secret' => 'd677d78439f646749cf99d85c9cef4b9',
			'cookie' => true)
	     );
...
if(is_array( $str )){
        ...
        $page_id = $page["id"]; 
        //$page_id; 
       //echo "select * from  `userTemplate` where `pageId`='".$page_id."' and `appId` = '912288285450859'";
       $sql = mysql_query("select * from  `userTemplate` where `pageId`='".$page_id."' and `appId` = '912288285450859'");
      ...
      // echo 'https://'.$_SERVER['SERVER_NAME'].'/facebook/pageTab/'.$arrayData['facebook_number'].'/index.php';exit;
