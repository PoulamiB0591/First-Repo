...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-o82q6enuogh6nl7gd5jv75hgn5//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/publish/uid-o82q6enuogh6nl7gd5jv75hgn5//<?php echo $new_image_name;?>"/></div>
                </div> </div>
