...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-9tknqll50o65831kgl2spa8lq3//upload/'.$fid.'.jpg';
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont"><img id="front-img" src="/publish/uid-9tknqll50o65831kgl2spa8lq3//<?php echo $new_image_name;?>" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="/publish/uid-9tknqll50o65831kgl2spa8lq3//<?php echo $new_image_name;?>"/>
</body>
</html>
