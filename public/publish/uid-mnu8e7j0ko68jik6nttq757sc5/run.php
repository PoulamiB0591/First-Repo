...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-mnu8e7j0ko68jik6nttq757sc5//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/publish/uid-mnu8e7j0ko68jik6nttq757sc5//<?php echo $new_image_name;?>"/></div>
                </div> </div>
