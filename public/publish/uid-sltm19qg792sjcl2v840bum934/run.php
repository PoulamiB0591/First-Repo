...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-sltm19qg792sjcl2v840bum934//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/publish/uid-sltm19qg792sjcl2v840bum934//<?php echo $new_image_name;?>"/></div>
                </div> </div>
