...
file_put_contents($_SERVER['DOCUMENT_ROOT']."/publish/uid-vri6rhb8trll669nv32mgsjqn3//upload/".$imgs, $unencodedData);
$imglink = $_SERVER['DOCUMENT_ROOT']."/publish/uid-vri6rhb8trll669nv32mgsjqn3//upload/".$imgs;
