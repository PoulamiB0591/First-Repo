...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-gicpksbri7vpiu7171vl63df82//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/publish/uid-gicpksbri7vpiu7171vl63df82//<?php echo $new_image_name;?>"/></div>
                </div> </div>
