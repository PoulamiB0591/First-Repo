...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-rvhbho8mc8uijj3eot67q170p1//upload/'.$fid.'.jpg';
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont"><img id="front-img" src="/publish/uid-rvhbho8mc8uijj3eot67q170p1//<?php echo $new_image_name;?>" /></div>
