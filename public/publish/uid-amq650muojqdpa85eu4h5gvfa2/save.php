...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-amq650muojqdpa85eu4h5gvfa2//upload/'.$fid.'.jpg';
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont"><img id="front-img" src="/publish/uid-amq650muojqdpa85eu4h5gvfa2//<?php echo $new_image_name;?>" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="/publish/uid-amq650muojqdpa85eu4h5gvfa2//<?php echo $new_image_name;?>"/>
</body>
</html>
