...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-t38ult302rpi4dbhbb846jmk47//upload/'.$fid.'.jpg';
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont"><img id="front-img" src="/publish/uid-t38ult302rpi4dbhbb846jmk47//<?php echo $new_image_name;?>" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="/publish/uid-t38ult302rpi4dbhbb846jmk47//<?php echo $new_image_name;?>"/>
</body>
</html>
