...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/publish/uid-3ur9e8j5tt2go1flrl5uahvmg6//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/publish/uid-3ur9e8j5tt2go1flrl5uahvmg6//<?php echo $new_image_name;?>"/></div>
                </div> </div>
