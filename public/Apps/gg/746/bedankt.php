        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff" contenteditable="false"><a class="disabled" href="/Apps/gg/746/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
                ...
                <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Bedaryryrnkt!</h2></div>
