...
file_put_contents("/var/www/staging/public/Apps/gg/436/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/gg/436/upload/".$imgs;
//echo $imglink;
...
<style>
    ...
    <body style="position: inherit;">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT"><a href="/Apps/gg/436/index.php" class="" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
        ...
        <script> window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script> 
