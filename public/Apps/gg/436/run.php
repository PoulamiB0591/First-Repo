...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/jquery.alerts.css">
 ...
 <scriptsrc="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/jquery.alerts.js"></script> 
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/gg/436/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//test.scampaigns.com//Apps/gg/436/<?php echo $new_image_name;?> 
"/></div>
                </div> </div>
