...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/img/favicon.ico"> 
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
      
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/normalize.css">
         <link rel="stylesheet" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/main.css">
        
        <!-- MAS slider -->
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/mas-slider.css">
		<link href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/mas-default.css" rel="stylesheet" type="text/css">
		<link href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/mas-part-view.css" rel="stylesheet" type="text/css">
       <link rel="stylesheet" href="//test.scampaigns.com/css/templateform.css"> 
       <link rel="stylesheet" href="//test.scampaigns.com/user_template/60854882971992288-roelpro/css/jquery.alerts.css"> 
      <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script> 
             <script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/vendor/modernizr-2.6.2.min.js"></script> 
       ...
       <!--[if lt IE 7]>
        ...
        <input id="getslideid" type="hidden">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_1"><a href="/Apps/rfwer/664/index.phpindex.php" title="Kies je tegel en foto" class="active">1) Kies je tegel en foto</a></li>
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/60854882971992288-roelpro/img/1.png" alt="lorem ipsum dolor sit"> 
                    <div class="ms-info">
                       
                    </div>  
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/60854882971992288-roelpro/img/2.png" alt="lorem ipsum dolor sit">    
                      <div class="ms-info">
                        
                    </div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/60854882971992288-roelpro/img/3.png" alt="lorem ipsum dolor sit">   
                     <div class="ms-info"></div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/60854882971992288-roelpro/img/4.png" alt="lorem ipsum dolor sit">   
                      <div class="ms-info"> </div>  
                </div>
            ...
            <!-- end of masterslider -->
                ...
                <p class="upload_fbbt SFPTWO_TAGEDIT tag_6">
                	<a class="" style="cursor: pointer;" id="getprf" onclick="facebookconnect();"><span class="explicit_edit" contenteditable="false">Gebruik mijn</span><strong class="explicit_edit" contenteditable="false">PROFIELFOTO</strong></a>
                     ...
                     <form name="form_1746650" class="upload_fbbt" enctype="multipart/form-data" method="post" id="target" action="run.php">
                	...
                	<p class="SFPTWO_TAGEDIT tag_7"><a class="" style="cursor:pointor;"><span class="explicit_edit" contenteditable="false">Upload je eigen</span><strong class="explicit_edit" contenteditable="false">FOTO</strong></a>
                     ...
                     <form name="form_1746650" method="post" id="targetfb" action="save.php">
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/jquery.easing.min.js"></script>
               <script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/jquery.alerts.js"></script>
               
		<script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/mas.min.js"></script>
	<script script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/mas-part.dev.js"></script>
        <script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/plugins.js"></script>
       <script src="//test.scampaigns.com/user_template/60854882971992288-roelpro/js/main.js"></script>
