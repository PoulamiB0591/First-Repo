    ...
    <div class="col-sm-6 col-md-5">
        <div class="row">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3 texttagdelete">
              ...
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_1117615" id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_736" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_805" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_591" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_853" required="required" class="SFPEMAIL form-control" type="email"></li>  
