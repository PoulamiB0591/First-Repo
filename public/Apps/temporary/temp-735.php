...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/423547d9c96cf1af13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/423547d9c96cf1af13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
  ...
  <div>dd</div> 
	...
	<li style="" class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_3 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font color="#15ace7">What kind of campaign are you Looking for? </font>
	 ...
	 <li style="display: list-item;" class="ui-draggable">
    	<li class="dottedLi SFPTWO_TEXTEDIT tags_5"><div id="labeledit" class="labeledit datedrag"><p id="pid_661" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">Label</font></p></div><input name="" id="datepicker1" onclick="datepick(1)" type="text"></li>
