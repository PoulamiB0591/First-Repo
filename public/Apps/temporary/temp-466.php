        ...
        <input id="getslideid" type="hidden">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="enteroff autosize SFPTWO_TAGEDIT tag_1" rel="24"><a href="/Apps/roel/466/index.php" title="Kies je tegel en foto" class="active autosizethis">1) Kies je tegel en foto</a></li>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/jquery.easing.min.js"></script>
               <script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/jquery.alerts.js"></script>
               
		<script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/mas.min.js"></script>
	<script script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/mas-part.dev.js"></script>
        <script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/plugins.js"></script>
       <script src="//test.scampaigns.com/user_template/143547c651beaad46-roelpro/js/main.js"></script>
