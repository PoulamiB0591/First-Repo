...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <script type="text/javascript" src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/js/jquery-1.9.1.min.js"></script>
           <script type="text/javascript" src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/js/html5shiv.js"></script>
             <script type="text/javascript" src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/js/functions.js"></script>
         <script type="text/javascript" src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/js/wow.min.js"></script>
 ...
 <div class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
      -->        
            <div id="wrapper " class="">
                ...
                <div id="logo-badge" class="logo-badge">
                    <div class="textme" style="display:inline-block;"></div><div class="logo-badge-inner SFPTWO_IMAGEEDIT tagsimg_1">
                        <img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
                                                ...
                                                <div class="hero-btn-area wow fadeIn" data-wow-delay=".9s">
                                                    <ul class="list-inline">
                                                        <li data-lead-id="hero-info-btn-container">
                                                            <div class="textme" style="display: inline-block; height: 86px;"></div><div class="SFPTWO_TEXTEDIT tags_3 texttagdelete">
                                                        ...
                                                        <li data-lead-id="hero-btn-container">
                                                            ...
                                                            <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT tagsimg_2">
                                                               ...
                                                               <div class="textme" style="display: inline-block; height: 0px;"></div><div class="SFPTWO_TEXTEDIT tags_4 texttagdelete randtxt_441" style="display: block;">
                                                                <a href="www.google.com" data-lead-id="btn-hero" class="sfpDynamic btn btn-primary btn-hero btn-top-hero textedit SFPTWO_TAGEDIT edit tag_4 tagdelete" target="_blank">hello gg</a>
                                                           </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div id="hero-trust-container" class="trust-area wow fadeIn" data-wow-delay=".9s">
                                                    <ul class="list-inline">
                                                        ...
                                                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_TEXTEDIT tags_5 texttagdelete">
                                                            ...
                                                            <p id="hero-trust-text" class="trust-text textedit SFPTWO_TAGEDIT edit tag_5 tagdelete">Also Available in the <a href="www.yahoo.com" class="sfpDynamic" target="_blank">hello yhh</a> and <a class="sfpDynamic" href="www.yahoo.com" target="_blank">hello yhh</a></p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="textme" style="display: inline-block; height: 0px;"></div><div class="col-sm-6 SFPTWO_IMAGEEDIT tagsimg_4 spaceedit">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div id="video0-wrapper" class="video-wrapper">
                                            <div class="video-container wow fadeIn" data-wow-delay=".7s">
                                                <div class="textme" style="display:inline-block;"></div><div class="vid-wrapper text-center SFPTWO_IMAGEEDIT tagsimg_5">
                                            ...
                                            <ul class="list-unstyled list-inline text-center">
                                                ...
                                                <li id="buy-btn2-container">
                                                  ...
                                                  <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_23 texttagdelete">
                                                        <a href="www.facebook.com" data-lead-id="buy-btn2" class="sfpDynamic btn btn-primary btn-hero btn-p52 textedit SFPTWO_TAGEDIT edit tag_23 tagdelete" target="_blank">hllo fb</a>
                                                   </div>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="col-sm-4 text-center">
                                        ...
                                        <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT tagsimg_18">
                                            ...
                                            <ul class="list-unstyled list-inline author-social-icon-list">
                                                <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicShare tagsimg_19 imgEdit2" id="editable"><div class="textme" style="display:inline-block;"></div><a href="#" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_20"><img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/author_social_1.png" class="img-responsive block-center"></a>
        ...
        var child = window.open('http://twitter.com/share?url=' + encodeURIComponent(u) + '&t=' + encodeURIComponent(t), 'sharer', 'toolbar=0,status=0,width=626,height=436');
                                        ...
                                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicLinkedin tagsimg_23"><div class="textme" style="display:inline-block;"></div><a href="" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_24"><img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/author_social_3.png" class="img-responsive block-center"></a>
                                    </li>
                                    <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicGoogle tagsimg_25"><div class="textme" style="display:inline-block;"></div><a href="#" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_26"><img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/author_social_4.png" class="img-responsive block-center"></a>
    	...
    	window.open('https://plus.google.com/share?url='+encodeURIComponent(url)+'
    	  ...
    	  scrollbars=no');
                                ...
                                <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicInstagram tagsimg_27"><div class="textme" style="display:inline-block;"></div><a href="#" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_28"><img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/author_social_5.png" class="img-responsive block-center"></a>
                            </li>
                            <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicYoutube tagsimg_29"><div class="textme" style="display:inline-block;"></div><a href="#" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_30"><img src="//test.scampaigns.com/user_template/87254f5559d7a2e86-elegantapp/img/author_social_6.png" class="img-responsive block-center"></a>
                        </li>
                    </ul> 
                </div>
            </div>
            ...
            <div class="col-sm-12 text-center">
                ...
                <div id="social-share-btn-area" class="social-share-btn-area wow fadeIn" data-wow-delay="1s">
                    <ul class="list-unstyled list-inline wow tada" data-wow-delay="1.9s">
                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicLike tagsimg_31 sfplikeme">
