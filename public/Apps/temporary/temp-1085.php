...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <script type="text/javascript" src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/js/jquery-1.9.1.min.js"></script>
           <script type="text/javascript" src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/js/html5shiv.js"></script>
             <script type="text/javascript" src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/js/functions.js"></script>
         <script type="text/javascript" src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/js/wow.min.js"></script>
            ...
            <div id="wrapper" class="">
                ...
                <div class="textme" style="display:inline-block;"></div><div id="logo-badge" class="logo-badge SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_1">
                    <div class="logo-badge-inner">
                        <img src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
                                                    ...
                                                    <ul class="list-inline">
                                                        ...
                                                        <li data-lead-id="hero-info-btn-container">
                                                            <div class="dl-btn-container">
                                                               ...
                                                               <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_4 texttagdelete"> <img src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/img/download-btn-icon.png" data-lead-id="btn-hero-icon" class="btn-icon">
                            ...
                            <div class="container">
                                ...
                                <div class="row author-info-area">
                                    ...
                                    <div class="col-sm-4 text-center">
                                        ...
                                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_19"><div class="textme" style="display:inline-block;"></div><a href="" id="page6-social3" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_20"><img src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/img/author_social_3.png" class="img-responsive block-center"></a>
                                    </li>
                                ...
                                <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_23"><div class="textme" style="display:inline-block;"></div><a href="#" id="page6-social5" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_24"><img src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/img/author_social_5.png" class="img-responsive block-center"></a>
                            </li>
                            <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_25"><div class="textme" style="display:inline-block;"></div><a href="#" id="page6-social6" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_26"><img src="//test.scampaigns.com/user_template/9115507e7a6524447-elegantapp/img/author_social_6.png" class="img-responsive block-center"></a>
                        </li>
                    </ul> 
                </div>
            </div>
