...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/img/favicon.ico"> 
      ...
      <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
             <script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/vendor/modernizr-2.6.2.min.js"></script>
        ...
        <input id="getslideid" type="hidden">
        	<div class="container-fluid top">
                ...
                <div class="textme" style="display:inline;"></div><div class="SFPTWO_IMAGEEDIT expl nownsfpimgdel tagsimg_1">
                	<img id="images1" src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/img/logo.jpg" alt=""><!-- end of logo -->
                      ...
                      <div class="explicit_edit"><a style="cursor: pointor;" title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_1 tagdelete"><a href="/Apps/ghgh/293/index.php" title="Kies je tegel en foto" class="active">1) Kies je tegel en foto</a></li>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/jquery.easing.min.js"></script>
               <script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/jquery.alerts.js"></script>
               
		<script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/mas.min.js"></script>
	<script script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/mas-part.dev.js"></script>
        <script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/plugins.js"></script>
       <script src="//test.scampaigns.com/user_template/747550a9cd0414368-roelpro/js/main.js"></script>
