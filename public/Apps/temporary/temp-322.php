...
<img src="https://test.scampaigns.com/img/divider.png" id="imgdragable" style="position: absolute; top: 934px; display: none;">
...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/28254a10689c99666-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/28254a10689c99666-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/28254a10689c99666-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/28254a10689c99666-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form name="form_1228737" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">

 <img src="https://test.scampaigns.com/img/divider.png" id="imgdrag" style="position: relative; top: 292px; display: none;">
 <img src="https://test.scampaigns.com/img/divider.png" id="imgdragable" style="display: none;">
  ...
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font>What kind of campaign are you Looking for? </font>
	 ...
	 <li style="display: list-item;" class="">
    	</li><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_6 tags_4 element3"><p id="pid_557" class="opt SFPTWO_TAGEDIT tag_8 undefined tag_7"><font class="SFPCOLOR">dropdown</font></p><div class="dropdowndrag adddrop"><select name="selectboxelement3" class="select undefined" id="hours209" style="font-family: times new roman;font-size: 15px; height: 30px;margin-bottom: 10px;width: 120px;"><option value="0">Select</option><option id="1" value="option1">option1</option><option id="2" value="option2">option2</option></select>   <div class="seteditdrop"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> </div></li>
    <li style="display: list-item;" class="">
    	</li><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_7 tags_5 element4"><div id="labeledit" class="labeledit datedrag"><p id="pid_85" class="opt SFPTWO_TAGEDIT tag_9 undefined tag_8"><font class="SFPCOLOR">date</font></p></div><input name="textboxelement4" id="datepicker1" onclick="datepick(1)" type="text"></li>
    <li style="" class="dottedLi SFPTWO_TEXTEDIT tags_4 element3 tags_6 element5"><div id="diveditme" class="labeledit"><p style="font-size: 19px;" id="pid_formmsg" class="opt SFPTWO_TAGEDIT tag_7 tag_9"><font>Your message</font></p><div><textarea id="editmetext" name="textareaelement5" class="textareaforform SFPTEXTAREA"></textarea></div></div></li>
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_5 element4 tags_7 element6"><div id="getbtnme" class="submitdrag"><input class="SFPsubmit" name="submit" value="Send" type="submit"></div></li>
