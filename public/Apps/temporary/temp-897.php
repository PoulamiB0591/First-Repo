...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/img/favicon.ico"> 
      ...
      <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
             <script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/vendor/modernizr-2.6.2.min.js"></script>
        ...
        <input id="getslideid" type="hidden">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_1"><a href="/Apps/roelpro/897/index.phpindex.php" title="Kies je tegel en foto" class="active">1) Kies je tegel en foto</a></li>
             ...
             <div class="main_content">
                ...
                <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="SFPTWO_TAGEDIT tag_4 editme bydelete">Kies een tegel...</h2></div>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/jquery.easing.min.js"></script>
               <script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/jquery.alerts.js"></script>
               
		<script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/mas.min.js"></script>
	<script script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/mas-part.dev.js"></script>
        <script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/plugins.js"></script>
       <script src="//test.scampaigns.com/user_template/20754acda0f3c0f46-roelpro/js/main.js"></script>
