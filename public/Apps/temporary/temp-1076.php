...
<div style="display: none;" class="SFPTWO_IMAGEEDIT tagsimg_1 rand_815 rand_188"><img id="images1" src="//test.scampaigns.com/user_template/813548057cf103769-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div style="display: block;" class="SFPTWO_IMAGEEDIT tagsimg_2 rand_421"><img id="images1" src="//test.scampaigns.com/user_template/813548057cf103769-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="display: list-item;" class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_3 randtxt_75 randtxt_52 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font color="#15ace7">What kind of campaign are you Looking for? </font>
