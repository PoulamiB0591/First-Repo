...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/408547dbd8643ca612-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div style="display: none;" class="SFPTWO_IMAGEEDIT tagsimg_2 rand_418"><img id="images1" src="//test.scampaigns.com/user_template/408547dbd8643ca612-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;">
 <li id="lilabelme" style="position: relative; top: -2px; left: 0px; display: none;"><a style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="email" id="email"><span>Email</span><img src="https://test.scampaigns.com/formbuild/email_icon.png" alt=""></a></li>
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="position: relative; left: 0px; top: 0px;" class="dottedLi SFPTWO_TEXTEDIT tags_2 element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;color:#15ace7" id="pid_" class="opt SFPTWO_TAGEDIT tag_2"><font color="#15ace7">EmaiL address</font></p></div><input name="email" type="email">
    
    </li>
    

	<li style="display: list-item;" class="">
    	<li class="dottedLi SFPTWO_TEXTEDIT tags_5"><p id="pid_532" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">Wat wil je winnen?<br></font></p><div onclick="selectboxclick(this)" class="dropdowndrag adddrop"><select class="select" id="hours475" style="font-family: times new roman;font-size: 20px; height: 30px;margin-bottom: 10px;width: 120px;"><option value="0">Select</option><option id="1" value="Beer">Beer</option><option id="2" value="option2">option2</option><option value="Option3">Option3</option><option value="Option4">Option4</option></select></div></li>
    </li><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font color="#15ace7">What kind of campaign are you Looking for? </font>
