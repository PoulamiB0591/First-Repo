...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <script type="text/javascript" src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/js/jquery-1.9.1.min.js"></script>
           <script type="text/javascript" src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/js/html5shiv.js"></script>
             <script type="text/javascript" src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/js/functions.js"></script>
         <script type="text/javascript" src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/js/wow.min.js"></script>
            ...
            <div id="wrapper" class="">
                ...
                <div id="logo-badge" class="logo-badge">
                    <div class="textme" style="display:inline-block;"></div><div class="logo-badge-inner SFPTWO_IMAGEEDIT tagsimg_1">
                        <img src="//test.scampaigns.com/user_template/2354f96f372b56210-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="sfpDynamic btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
                                                        ...
                                                        <li data-lead-id="hero-btn-container">
                                                            ...
                                                            <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT tagsimg_2">
                                                               ...
                                                               <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_4 texttagdelete">
                                                                <a target="_blank" href="www.google.com" data-lead-id="btn-hero" class="sfpDynamic btn btn-primary btn-hero btn-top-hero textedit SFPTWO_TAGEDIT edit tag_4 tagdelete">DOWNLOAD THE APP</a>
                                                           </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div id="hero-trust-container" class="trust-area wow fadeIn" data-wow-delay=".9s">
                                                    <ul class="list-inline">
                                                        ...
                                                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_TEXTEDIT tags_5 texttagdelete">
                                                            ...
                                                            <p id="hero-trust-text" class="trust-text textedit SFPTWO_TAGEDIT edit tag_5 tagdelete justifyme">Also Available in the <a href="#" class="sfpDynamic">App Store</a> and <a class="sfpDynamic" href="#">Play Store</a></p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
