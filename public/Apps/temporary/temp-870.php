...
<div style="top: 0px; left: 0px; width: 763px; height: 570px;" id="editable" class="SFPTWO_IMAGEEDIT tagsimg_1 imgEdit1 ui-resizable"><div class="ui-draggable" id="draggable2" style="z-index: 2; position: absolute; left: -737px; top: 46px;"><div><div class="ui-resizable" id="resizable2" style="z-index:2; height:1080px; width:1920px;"><img class="layeredImage" id="images2" src="http://test.scampaigns.com/library/b14b60935c5be1471480678b413fca76.jpg" style="height:100%; width:100%; z-index:2;"></div></div></div><img id="images1" src="//test.scampaigns.com/user_template/797547c26487a32c14-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/797547c26487a32c14-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_2 element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;color:#15ace7" id="pid_" class="opt SFPTWO_TAGEDIT tag_2"><font color="#15ace7">EmaiL address</font></p></div><input name="email" type="email">
    	...
    	<li class="dottedLi"><div id="diveditme" class="labeledit"><p id="pid_257" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">Label</font></p></div></li>
    </li>
