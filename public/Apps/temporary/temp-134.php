    ...
    <div class="col-sm-6 col-md-5">
        <div class="row">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3 texttagdelete">
              ...
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_546" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input type="text" name="textboxelement1" id="txtbox_221" class="SFPTEXT form-control"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_752" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input type="email" name="textBoxEmailelement2" id="email_125" class="SFPEMAIL form-control"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 texttagdelete element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" type="submit" name="submit" value="Send the eCourse"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 texttagdelete element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_377" class="opt SFPTWO_TAGEDIT note tag_6 tagdelete"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
