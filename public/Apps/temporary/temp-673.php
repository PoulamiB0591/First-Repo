...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <script type="text/javascript" src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/js/jquery-1.9.1.min.js"></script>
           <script type="text/javascript" src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/js/html5shiv.js"></script>
             <script type="text/javascript" src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/js/functions.js"></script>
         <script type="text/javascript" src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/js/wow.min.js"></script>
 ...
 <div class="fb-like" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="true"></div>
      -->        
            <div id="wrapper" class="">
                ...
                <div id="logo-badge" class="logo-badge">
                    <div class="textme" style="display:inline-block;"></div><div class="logo-badge-inner SFPTWO_IMAGEEDIT tagsimg_1">
                        <img src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="sfpDynamic btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                       ...
                                       <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_21 texttagdelete">
                                            <h3 id="page5-sub-header" class="text-center textedit SFPTWO_TAGEDIT edit tag_21 tagdelete justifyme">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor</h3>
                                      </div>
                                        </div>
                                            ...
                                            <ul class="list-unstyled list-inline text-center">
                                                <li id="buy-btn1-container">
                                                    ...
                                                    <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_22 texttagdelete">
                                                        <a href="www.google.com" data-lead-id="buy-btn1" class="sfpDynamic btn btn-primary btn-hero btn-p51 textedit SFPTWO_TAGEDIT edit tag_22 tagdelete">DOWNLOAD HERE</a>
                                                  </div>
                                                    </div>
                                                </li>
        ...
        var child = window.open('http://twitter.com/share?url=' + encodeURIComponent(u) + '&t=' + encodeURIComponent(t), 'sharer', 'toolbar=0,status=0,width=626,height=436');
                                        ...
                                        <div class="textme" style="display:inline-block;"></div><li class="SFPTWO_IMAGEEDIT sfpDynamicLinkedin tagsimg_23"><div class="textme" style="display:inline-block;"></div><a href="" id="page6-social3" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_24"><img src="//test.scampaigns.com/user_template/54454f967c31743610-elegantapp/img/author_social_3.png" class="img-responsive block-center"></a>
