...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/63454787c978678d11-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/63454787c978678d11-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<li class="dottedLi ui-draggable element4"><div id="labeledit" class="labeledit"><p id="pid_722" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">Label</font></p></div></li><li class="dottedLi element5"><div id="labeledit" class="labeledit multilinedrag"><p id="pid_109" class="opt SFPTWO_TAGEDIT tag_9"><font color="#15ace7">Label</font></p></div><div class="checksboxes p_scents multilineme" id="checksboxes_603"><div id="multiclone"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-row603"><p style="border: 1px solid #eee; padding: 10px; min-height: 30px; text-decoration: underline;" class="opt explicit_edit" id="1"><font color="#15ace7">Text1</font></p> </div><div class="jui-checkbox-row"></div></div><p id="mepp" class="meline"></p></div></li><li class="dottedLi ui-draggable element6"><div id="labeledit" class="labeledit emaildrag"><p id="pid_874" class="opt SFPTWO_TAGEDIT tag_10"><font color="#15ace7">Label</font></p></div><input name="" id="email_364" type="email"></li><li class="dottedLi ui-draggable element7"><div id="labeledit" class="labeledit emaildrag"><p id="pid_871" class="opt SFPTWO_TAGEDIT tag_11"><font color="#15ace7">Label</font></p></div><input name="" id="email_960" type="email"></li><br><br><li class="dottedLi ui-draggable element8"><div class="editmybtn" id="getbtnme"><input class="" name="submit" value="submit" type="submit"></div></li></ul>
</form>
</div>
</div>