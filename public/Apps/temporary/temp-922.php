...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/115547c26b83182714-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/115547c26b83182714-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div style="height: 562px; width: 763px; top: 0px; left: 0px;" id="editable" class="SFPTWO_IMAGEEDIT tagsimg_1 imgEdit1 ui-resizable"><div class="ui-draggable" id="draggable2" style="z-index:2; position:absolute;"><div><div class="ui-resizable" id="resizable2" style="z-index:2; height:627px; width:940px;"><img class="layeredImage" id="images2" src="http://test.scampaigns.com/library/03c5c2ceda24a1d391b26a99d04370d3.jpg" style="height:100%; width:100%; z-index:2;"></div></div></div><img id="images1" src="//test.scampaigns.com/user_template/115547c26b83182714-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/115547c26b83182714-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<form name="form_1336295" id="" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
