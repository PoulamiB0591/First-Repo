...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <script type="text/javascript" src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/js/jquery-1.9.1.min.js"></script>
           <script type="text/javascript" src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/js/html5shiv.js"></script>
             <script type="text/javascript" src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/js/functions.js"></script>
         <script type="text/javascript" src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/js/wow.min.js"></script>
            ...
            <div id="wrapper " class="">
                ...
                <div id="logo-badge" class="logo-badge">
                    <div class="textme"></div><div class="logo-badge-inner SFPTWO_IMAGEEDIT tagsimg_1">
                        <img src="//test.scampaigns.com/user_template/95954f45c1f56dcb5-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
