...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/70549a64246cdbb14-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/70549a64246cdbb14-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div style="height: 594px; width: 763px; top: 0px; left: 0px;" id="editable" class="SFPTWO_IMAGEEDIT tagsimg_1 imgEdit1 ui-resizable imgEdit2"><div class="ui-draggable" id="draggable2" style="z-index:2; position:absolute;"><div><div class="ui-resizable" id="resizable2" style="z-index:2; height:768px; width:1024px;"><img class="layeredImage" id="images2" src="http://test.scampaigns.com/library/6aec928730d7bfe7f4bd3d30c8eadb4e.jpg" style="height:100%; width:100%; z-index:2;"></div></div></div><img id="images1" src="//test.scampaigns.com/user_template/70549a64246cdbb14-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/70549a64246cdbb14-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form name="form_1042549" id="" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
