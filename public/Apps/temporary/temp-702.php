...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/jquery-1.9.1.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/bootstrap.min.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/html5shiv.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/functions.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/classie.js"></script>
            <script type="text/javascript" src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/js/custom.js"></script>
                                ...
                                <li data-lead-id="details-box2">
                                    <div class="details-box">
                                        ...
                                        <div class="details-info">
                                            ...
                                            <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_24 texttagdelete"><p data-lead-id="details-box2-subheader" class="textedit SFPTWO_TAGEDIT edit tag_24 tagdelete justifyme">1548 MEETING ROAD STE: 101</p></div>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="col-md-7">
                        <div data-lead-id="about-image-container" class="about-image-container">
                            <ul class="list-inline">
                                ...
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_7"><img src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/img/about_img2.jpg" data-lead-id="about-image2" class="img-responsive center-block"></div></li>
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_8"><img src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/img/about_img3.jpg" data-lead-id="about-image3" class="img-responsive center-block"></div></li>
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_9"><img src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/img/about_img4.jpg" data-lead-id="about-image4" class="img-responsive center-block"></div></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <li data-lead-id="time-slot4-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_14">
                                        <img src="//test.scampaigns.com/user_template/38155016b7cac16a10-event/img/clock_icon.png" data-lead-id="time-slot4-img" class="img-responsive textedit SFPTWO_TAGEDIT edit tag_44 tagdelete">
                                        </div>
