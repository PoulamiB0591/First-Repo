        ...
        <div class="main_wrapper" id="change">
        	...
        	<div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                      ...
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff autosize" rel="24"><a href="/Apps/fdgfgdgdfg/78/index.php" title="Kies je tegel en foto"  class="active autosizethis">1) Kies je tegel en foto</a></li>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <script <script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/jquery.easing.min.js"></script>
               <script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/jquery.alerts.js"></script>
               
		<script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/mas.min.js"></script>
	<script script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/mas-part.dev.js"></script>
        <script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/plugins.js"></script>
       <script src="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/js/main.js"></script>
