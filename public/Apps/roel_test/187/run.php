...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/900546329fc75f1c6-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'//var/www/staging/public/Apps/roel_test/187//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//var/www/staging/public/Apps/roel_test/187//<?php echo $new_image_name;?>"/></div>
                </div> </div>
