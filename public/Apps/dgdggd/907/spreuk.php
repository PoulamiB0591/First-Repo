...
file_put_contents($_SERVER['DOCUMENT_ROOT']."//var/www/staging/public/Apps/dgdggd/907/upload/".$imgs, $unencodedData);
$imglink = "//var/www/staging/public/Apps/dgdggd/907/upload/".$imgs;
$imglink=explode('/',$imglink);
$imglinkadd = $imglink[6]."/".$imglink[8]."/".$imglink[9];
$imglinkaddme = $imglink;
//echo $imglink;
?>
<!DOCTYPE html>
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/js/app.js"></script>
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/901546334a2e16305-roelpro/712.GIF" /> 
        </div> 
