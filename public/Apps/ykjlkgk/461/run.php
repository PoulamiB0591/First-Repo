...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/8935469c3275e5f49-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/ykjlkgk/461/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="https://test.scampaigns.com//Apps/ykjlkgk/461/<?php echo $new_image_name;?>"/></div>
                </div> </div>
