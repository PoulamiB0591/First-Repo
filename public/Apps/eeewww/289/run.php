...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/8225463556716cce10-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/eeewww/289/upload/'.$newName;
