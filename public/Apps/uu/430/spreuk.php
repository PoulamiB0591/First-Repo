...
file_put_contents("/var/www/staging/public/Apps/uu/430/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/uu/430/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/app.js"></script>
    ...
    if (x == null || x == "" || x == 'Jouw lijfspreuk') {
      ...
      //alert(abc);
    	...
    	$('#target').html2canvas({
           ...
           setTimeout(function(){ //$('form#frms').submit(); 
           }, 1500);
       }     
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/712.GIF" /> 
        </div> 
