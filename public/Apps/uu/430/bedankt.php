...
file_put_contents($_SERVER['DOCUMENT_ROOT']."//var/www/staging/public/Apps/uu/430/upload/".$imgs, $unencodedData);
$imglink = $_SERVER['DOCUMENT_ROOT']."//var/www/staging/public/Apps/uu/430/upload/".$imgs;
...
<style>
    ...
    <body style="position: inherit;">
        ...
        <script>window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/plugins.js"></script>
        <script src="//test.scampaigns.com/user_template/0546347d0f08c911-roelpro/js/main.js"></script>
