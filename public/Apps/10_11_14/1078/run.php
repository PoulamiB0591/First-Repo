...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/2745460714c4eb485-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/mobileview//upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/mobileview//<?php echo $new_image_name;?>"/></div>
                </div> </div>
