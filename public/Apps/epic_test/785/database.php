...
if(isset($_POST['param']) && $_POST['param'] == 'UIDs')
{
    ...
    {
        // echo 'https://graph.facebook.com/'.$array[$i].'?access_token=1505052056407910|0e28a426dc5f7e532fa6caa490b4d4ca';
        $pageContent = file_get_contents('https://graph.facebook.com/'.$array[$i].'?access_token=1505052056407910|0e28a426dc5f7e532fa6caa490b4d4ca');
