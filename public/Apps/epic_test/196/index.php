...
chmod($userfolder."/upload", 0777);
  ...
  foreach (glob($userfolder."/*.php") as $search) {
   ...
   /* if ($file = fopen($search,"r")) 
    ...
    $contents = file_get_contents($search);
    if($search != $userfolder."index.php"){
        if (!strpos($contents, "/Apps/epic_test/196/index.phpindex.php")) continue;
        ...
        str_replace("/Apps/epic_test/196/","/Apps/".$values2."/".$values."/",$contents);
        $file_contents = str_replace("/Apps/epic_test/196/index.phpindex.php",$getindex,$contents);
...
foreach (glob($userfolder."/*.php") as $search) {
   ...
   $contents = str_replace("/var/www/staging/public/Apps/epic_test/196",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$contents);
   ...
   $contents = str_replace("/Apps/epic_test/196/","/Apps/".$values2."/".$values."/",$contents);
   $contents = str_replace("script","script",$contents);
    $contents=str_replace(" "," ",$contents);
  $contents=str_replace(""," ",$contents);
 ...
 $str = str_replace("/Apps/epic_test/196/","/Apps/".$values2."/".$values."/",$str);
  $str=str_replace("/Apps/epic_test/196/index.phpindex.php",$getindex,$str);
 $str=str_replace("/var/www/staging/public/Apps/epic_test/196",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$str);
 $str = str_replace(" "," ",$str);
...
chmod($pathfolder1, 0777);
   ...
   $file_contents = str_replace("/Apps/epic_test/196/","/Apps/".$values2."/".$values."/",$contents); 
