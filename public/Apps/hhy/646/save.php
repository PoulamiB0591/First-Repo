...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  '/var/www/staging/public/Apps/hhy/646/upload/'.$fid.'.jpg';
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont textup"><img id="front-img" src="https://test.scampaigns.com//Apps/hhy/646/<?php echo $new_image_name;?> 
" /></div>
               <div class="front-img-cont textbellow"><img id="front-img" src="https://test.scampaigns.com//Apps/hhy/646/<?php echo $new_image_name;?> 
" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="https://test.scampaigns.com//Apps/hhy/646/<?php echo $new_image_name;?> "/>
</body>
</html>
