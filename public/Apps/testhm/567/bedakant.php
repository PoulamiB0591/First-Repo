...
<?php
	...
	if($lastId =="")
	{
	header("Location: /Apps/testhm/567/index.phpindex.php");
	}
...
//echo "/Apps/testhm/567/". $rowFetchCurrent['imagePath'];
session_unset();  ?>
<body>
<div id="fb-root"></div>
<script>
...
<div class="top_section">
        <div class="SFPTWO_IMAGEEDIT logo"><a href="/Apps/testhm/567/index.phpindex.php" title="H &amp; M"><img src="http://test.scampaigns.com/user_template/9755530c13683f7013-hmPhotoSfpContest/images/logo.png" alt="" /></a></div><!-- end of logo -->
...
<div class="thanks">
        <img src="<?php if($resultCurrent[0]['watermarkImage']==""){echo "http://test.scampaigns.com/user_template/9755530c13683f7013-hmPhotoSfpContest/images/thanks_img.jpg";}else{ echo "/Apps/testhm/567/". $resultCurrent[0]['watermarkImage'];}?>"  id="ImgCanvas">
            ...
            <div class="advertise">
                ...
                <div class="FacebookLike"><div class="fb-like" data-href="<?php if($resultCurrent[0]['watermarkImage']==""){echo "";}else{ echo "/Apps/testhm/567/". $resultCurrent[0]['watermarkImage'];}?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></div>
                </div>
