...
file_put_contents("/var/www/staging/public/Apps/rtete/185/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/rtete/185/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/92654742b2e3182e10-roelpro/js/style.css" />
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/92654742b2e3182e10-roelpro/js/html2canvas.js"></script> 
        <script type="text/javascript" src="//test.scampaigns.com/user_template/92654742b2e3182e10-roelpro/js/jquery.plugin.html2canvas.js"></script> 
        <script src="//test.scampaigns.com/user_template/92654742b2e3182e10-roelpro/js/app.js"></script> 
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/92654742b2e3182e10-roelpro/712.GIF" /> 
        </div> 
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff"><a href="/Apps/rtete/185/index.php" title="Kies je tegel en foto" id="Kies" >1) Kies je tegel en foto</a></li>
