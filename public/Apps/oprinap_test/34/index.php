...
chmod($userfolder."/upload", 0777);
  ...
  foreach (glob($userfolder."/*.php") as $search) {
    ...
    $contents = file_get_contents($search);
    if($search != $userfolder."index.php"){
        if (!strpos($contents, "/Apps/oprinap_test/34/index.php")) continue;
        ...
        str_replace("/Apps/oprinap_test/34/","/Apps/".$values2."/".$values."/",$contents);
        $file_contents = str_replace("/Apps/oprinap_test/34/index.php",$getindex,$contents);
...
foreach (glob($userfolder."/*.php") as $search) {
   ...
   $contents = str_replace("/var/www/staging/public/Apps/oprinap_test/34",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$contents);
   ...
   $contents = str_replace("/Apps/oprinap_test/34/","/Apps/".$values2."/".$values."/",$contents);
   $contents = str_replace("script","script",$contents);
    $contents=str_replace(" "," ",$contents);
  $contents=str_replace(""," ",$contents);
  $contents=str_replace('1,email',$var,$contents);
 ...
 $str = str_replace("/Apps/oprinap_test/34/","/Apps/".$values2."/".$values."/",$str);
  $str=str_replace("/Apps/oprinap_test/34/index.php",$getindex,$str);
 $str=str_replace("/var/www/staging/public/Apps/oprinap_test/34",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$str);
 $str = str_replace(" "," ",$str);
 $str=str_replace('1,email',$var,$str);
...
chmod($pathfolder1, 0777);
   ...
   $file_contents = str_replace("/Apps/oprinap_test/34/","/Apps/".$values2."/".$values."/",$contents); 
   ...
   $file_content = str_replace('1,email',$sql['check_fbtag'],$file_contents);
 ...
 foreach (glob($pathfolder1."/*.php") as $searches1) {
   ...
   $file_content = str_replace('1,email',$sql['check_fbtag'],$file_contents);
    ...
    file_put_contents($searches1,$file_content); 
