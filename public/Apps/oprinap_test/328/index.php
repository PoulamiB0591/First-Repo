...
chmod($userfolder."/upload", 0777);
    ...
    if (!strpos($contents, "//test.scampaigns.com/")) continue;
   
    //str_replace("//test.scampaigns.com/","mobileview/",$contents);
   $file_contents = str_replace("//test.scampaigns.com/",$userfilename,$contents);
  ...
  foreach (glob($userfolder."/*.php") as $search) {
    $contents = file_get_contents($search);
    if($search != $userfolder."index.php"){
        if (!strpos($contents, "/Apps/oprinap_test/328/index.php")) continue;
       
        str_replace("//test.scampaigns.com/","//".$_SERVER['SERVER_NAME']."/",$contents);
        str_replace("http://test.scampaigns.com/","http://".$_SERVER['SERVER_NAME']."/",$contents);
        str_replace("/Apps/oprinap_test/328/","/Apps/".$values2."/".$values."/",$contents);
        $file_contents = str_replace("/Apps/oprinap_test/328/index.php",$getindex,$contents);
        if (strpos($file_contents, "SFPTWO_EDITFORM"))
          {
            $file_contents = str_replace("<?php include_once('/var/www/staging/public/sfpForm.php');?>",$form,$file_contents);
          }
        file_put_contents($search,$file_contents); 
    } 
} 
...
foreach (glob($userfolder."/*.php") as $search) {
   ...
   $contents = str_replace("/var/www/staging/public/Apps/oprinap_test/328",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$contents);
   $contents =  str_replace("//test.scampaigns.com/","//".$_SERVER['SERVER_NAME']."/",$contents); 
   $contents =  str_replace("http://test.scampaigns.com/","http://".$_SERVER['SERVER_NAME']."/",$contents);
   $contents = str_replace("/Apps/oprinap_test/328/","/Apps/".$values2."/".$values."/",$contents);
   $contents = str_replace("script","script",$contents);
    $contents=str_replace(" "," ",$contents);
  $contents=str_replace(""," ",$contents);
  ...
  if (strpos($contents, "SFPTWO_EDITFORM"))
  {
    $contents=str_replace("<?php include_once('/var/www/staging/public/sfpForm.php');?>",$form,$contents);
  }
 ...
 $str=str_replace("//test.scampaigns.com/","//".$_SERVER['SERVER_NAME']."/",$str);
 $str =  str_replace("http://test.scampaigns.com/","http://".$_SERVER['SERVER_NAME']."/",$str);
 $str = str_replace("/Apps/oprinap_test/328/","/Apps/".$values2."/".$values."/",$str);
  $str=str_replace("/Apps/oprinap_test/328/index.php",$getindex,$str);
 $str=str_replace("/var/www/staging/public/Apps/oprinap_test/328",$_SERVER['DOCUMENT_ROOT']."/Apps/".$values2."/".$values,$str);
 $str = str_replace(" "," ",$str);
 ...
 if (strpos($str, "SFPTWO_EDITFORM"))
  {
    $str=str_replace("<?php include_once('/var/www/staging/public/sfpForm.php');?>",$form,$str);
  }
...
chmod($pathfolder1, 0777);
   ...
   $file_contents = str_replace("//test.scampaigns.com/","//".$_SERVER['SERVER_NAME']."/",$contents);
   $file_contents = str_replace("http://test.scampaigns.com/","http://".$_SERVER['SERVER_NAME']."/",$contents);
   $file_contents = str_replace("/Apps/oprinap_test/328/","/Apps/".$values2."/".$values."/",$contents); 
 ...
 foreach (glob($pathfolder1."/*.php") as $searches1) {
   ...
   if (strpos($file_content, "SFPTWO_EDITFORM"))
  {
    $file_content=str_replace("<?php include_once('/var/www/staging/public/sfpForm.php');?>",$form,$file_content);
  }
