    ...
    {    
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <header>
                           <div class="SFPTWO_IMAGEEDIT img_section tagsimg_1"><a style="cursor: pointer;" title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/75854991054221fc15-indexus/img/logo.png" alt=""></a></div>
                        ...
                        <div class="main_content">
                           ...
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT tag_2">Met welk doel <span>belegt u?</span></h2></div>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/75854991054221fc15-indexus/img/icon4.png" alt=""></div>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT tag_3" style="cursor: pointer;" onclick="check()">Volgende stap <img src="//test.scampaigns.com/user_template/75854991054221fc15-indexus/img/icon3.png" alt=""></a>
                        </div>
                        <div>
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/75854991054221fc15-indexus/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/75854991054221fc15-indexus/js/plugins.js"></script>
