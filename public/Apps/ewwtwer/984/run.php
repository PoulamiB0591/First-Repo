...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/92654746403193306-roelpro/jquery.alerts.css">
 <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script> 
 <scriptsrc="//test.scampaigns.com/user_template/92654746403193306-roelpro/js/jquery.alerts.js"></script> 
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/ewwtwer/984/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//test.scampaigns.com//Apps/ewwtwer/984/<?php echo $new_image_name;?> 
"/></div>
                </div> </div>
