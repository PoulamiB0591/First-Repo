    ...
    {    
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <header>
                           <div class="SFPTWO_IMAGEEDIT img_section tagsimg_1"><a style="cursor: pointer;" title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/724548806e59fd1d10-indexus/img/logo.png" alt=""></a></div>
                        ...
                        <div class="main_content">
                           ...
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT tag_2">Met welk doel <span>belegt u?</span></h2></div>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/724548806e59fd1d10-indexus/img/icon4.png" alt=""></div>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT tag_3" style="cursor: pointer;" onclick="check()">Volgende stap <img src="//test.scampaigns.com/user_template/724548806e59fd1d10-indexus/img/icon3.png" alt=""></a>
                        </div>
                        <div>
                        <input id="v1" value="10" type="hidden">
                        <input id="v2" value="20" type="hidden">
                        <input id="v3" value="30" type="hidden">
                        <input id="v4" value="40" type="hidden">
                        <input id="v5" value="50" type="hidden">
                        </div>
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/724548806e59fd1d10-indexus/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/724548806e59fd1d10-indexus/js/plugins.js"></script>
