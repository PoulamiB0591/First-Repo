...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  '/var/www/staging/public/Apps/tttttryr/199/upload/'.$fid.'.jpg';
...
$manipulator = new ImageManipulator($new_image_name);
 ...
 $imglink=explode('/',$filename);
print_r($imglink);
$imglinkadd = $imglink[5]."/".$imglink[6]."/".$imglink[7]."/".$imglink[8];
...
<input type="hidden" id="uploadimgtext" value="https://test.scampaigns.com/<?php echo $imglinkaddme.$new_image_name;?>"/>
</body>
</html>
