...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/911546348c0c1de28-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/iii/381/upload/'.$newName;
