...
file_put_contents($_SERVER['DOCUMENT_ROOT']."//var/www/staging/public/Apps/uiiyiy/453/upload/".$imgs, $unencodedData);
$imglink = $_SERVER['DOCUMENT_ROOT']."//var/www/staging/public/Apps/uiiyiy/453/upload/".$imgs;
...
<style>
    ...
    <body style="position: inherit;">
        ...
        <script>window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/1145463495aa68bc14-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="//test.scampaigns.com/user_template/1145463495aa68bc14-roelpro/js/plugins.js"></script>
        <script src="//test.scampaigns.com/user_template/1145463495aa68bc14-roelpro/js/main.js"></script>
