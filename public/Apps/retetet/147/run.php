...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/84154635746b883713-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/retetet/147/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="https://test.scampaigns.com//Apps/retetet/147/<?php echo $new_image_name;?>"/></div>
                </div> </div>
