...
file_put_contents("/var/www/staging/public/Apps/loestegel/646/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/loestegel/646/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
       ...
       <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/3554b6721683bea6-roelpro/img/favicon.ico"> 
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/3554b6721683bea6-roelpro/js/style.css">
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/3554b6721683bea6-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/3554b6721683bea6-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/3554b6721683bea6-roelpro/js/app.js"></script>
...
<div id="fb-root">
    ...
    <div class="main_wrapper SFPTWO_BACKGROUND">
          <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1 imgEdit4" id="editable">
                	<div id="wrapimgdiv" style="width: 84px;"><img id="images1" src="http://test.scampaigns.com/library/33961b5b3c0a6698a28f6631ae2ab51a.jpg" alt="" class="" style="width: 100%;"></div><!-- end of logo -->
                   <div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input type="hidden" value="3554b6721683bea6-roelpro" id="hid"><input type="hidden" value="3" id="imgCount"></div></div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_1" contenteditable="false"><a class="disabled" href="/Apps/loestegel/646/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="SFPTWO_TAGEDIT explicit_edit  tag_4 bydelete editme" contenteditable="false"><i><font face="Georgia" color="#f1505d">live life to the fullest</font></i></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
