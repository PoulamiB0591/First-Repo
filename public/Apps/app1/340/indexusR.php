...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <div style="display: none;" class="popup">        	
            ...
            <form action="/" name="form_1662116" method="post">
            <ul>
            	<li>
        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT tag_2 explicit_edit" contenteditable="false">Uw verwachte<span>doelvermogen is...</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                            <h3><p id="resHide" style="display: none;">result</p><p id="res">€ </p></h3>
                            <p class="SFPTWO_TAGEDIT tag_3 explicit_edit" contenteditable="false">Wij kunnen u ook een uitgebreide analyse toesturen, gebaseerd op de door u ingevoerde gegevens. Weten hoe? Ga verder via onderstaande knop.</p>
                            
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/286548826fa3182b11-indexus/img/icon7.png" alt="" class="img_response"><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="286548826fa3182b11-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="286548826fa3182b11-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
