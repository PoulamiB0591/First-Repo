   ...
   $.ajax({
    ...
    <body>
        ...
        <section class="main_step4">
            <div class="container">
                        <header>
                            <div class="SFPTWO_IMAGEEDIT img_section"><a title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/47054877f267f2a89-indexus/img/logo.png" alt="" /></a></div>
                        ...
                        <div class="main_content">
                            ...
                            <h3><p id="resHide" style="display: none;">result</p><p id="res">&euro;<?php echo $_COOKIE['answer']; ?></p></h3>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section"><img src="//test.scampaigns.com/user_template/47054877f267f2a89-indexus/img/icon7.png" alt="" class="img_response" /></div>
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/47054877f267f2a89-indexus/js/main.js"></script>
