            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" type="radio" name="jaar"> 20 jaar</label>
                                <label class="label_radio"><input value="2" type="radio" name="jaar"> 15 jaar</label>
                                <label class="label_radio"><input value="2" type="radio" name="jaar"> 10 jaar</label>
                                <label class="label_radio"><input value="2" type="radio" name="jaar"> 5 jaar</label>
                            </fieldset>
                            <div class="jaar">
                            	<span>20 jaar</span>
                            	<span>15 jaar</span>
