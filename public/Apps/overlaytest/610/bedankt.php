...
<style>
    ...
    <div class="main_wrapper">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT"><a href="/Apps/overlaytest/610/index.phpindex.php" class="" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
        ...
        <script> window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/555548fd584872069-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="//test.scampaigns.com/user_template/555548fd584872069-roelpro/js/plugins.js"></script>
        <script src="//test.scampaigns.com/user_template/555548fd584872069-roelpro/js/main.js"></script>
