...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/0546ee92632b2a12-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/ghghfg/309/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="https://test.scampaigns.com//Apps/ghghfg/309/<?php echo $new_image_name;?>"/></div>
                </div> </div>
