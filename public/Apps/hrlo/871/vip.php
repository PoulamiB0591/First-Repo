...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
    ...
    <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/159547832fa4c69d13-epic/img/favicon.ico">
        ...
        <div class="main_wrap">
            ...
            <p class="neon_text"></p>
            <div class="img_pic">
            	<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/159547832fa4c69d13-epic/img/frame_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="159547832fa4c69d13-epic" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
            	<img id="pPic" src="" alt="YOUR PROFILE PICTURE"> 
            </div><!-- end of img_pic -->
            <div class="SFPTWO_TEXTEDIT tags_3"><p class="neon_text SFPTWO_TAGEDIT explicit_edit tag_3" contenteditable="false"><strong>dekhosjhfsh<br><br></strong></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
