...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  '/var/www/staging/public/Apps/hfhhfhfgh/584/upload/'.$fid.'.jpg';
...
$filename='/var/www/staging/public/Apps/hfhhfhfgh/584/upload/'.$fid.'.jpg';
$filename=explode('/',$filename);
$filename = $filename[5]."/".$filename[6]."/".$filename[7]."/".$filename[8]."/".$filename[9];
echo($filename);
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont textup"><img id="front-img" src="https://test.scampaigns.com/<?php echo $new_image_name;?>" /></div>
               <div class="front-img-cont textbellow"><img id="front-img" src="https://test.scampaigns.com/<?php echo $new_image_name;?>" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="https://test.scampaigns.com/<?php echo $new_image_name;?>"/>
</body>
</html>
