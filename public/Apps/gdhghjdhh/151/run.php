...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/193546337f0e3e7a14-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/gdhghjdhh/151/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//var/www/staging/public/Apps/gdhghjdhh/151/<?php echo $new_image_name;?>"/></div>
                </div> </div>
