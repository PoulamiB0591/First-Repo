...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/908546f46f6a644412-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/roelpro_test/929/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="https://test.scampaigns.com//Apps/roelpro_test/929/<?php echo $new_image_name;?>"/></div>
                </div> </div>
