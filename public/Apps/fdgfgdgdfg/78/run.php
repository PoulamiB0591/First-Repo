...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/3935463357e50bfb9-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/fdgfgdgdfg/78/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//var/www/staging/public/Apps/fdgfgdgdfg/78/<?php echo $new_image_name;?>"/></div>
                </div> </div>
