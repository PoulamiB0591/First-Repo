...
file_put_contents("/var/www/staging/public/Apps/arnabWebRoelproTest/140/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/arnabWebRoelproTest/140/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]--><head>
       ...
       <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/img/favicon.ico"> 
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/js/style.css" />
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/js/app.js"></script>
          ...
          <div class="container-fluid top"> 
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                      ...
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/84854d359d9b6e6e10-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT"><a class=""  href="/Apps/arnabWebRoelproTest/140/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
