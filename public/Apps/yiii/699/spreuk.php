...
file_put_contents("//var/www/staging/public/Apps/yiii/699/upload/".$imgs, $unencodedData);
$imglink = "//var/www/staging/public/Apps/yiii/699/upload/".$imgs;
echo $imglink;
$imglink=explode('/',$imglink);
print_r($imglink);
$imglinkadd = $imglink[6]."/".$imglink[7]."/".$imglink[8]."/".$imglink[9];
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/28546337518e93213-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/28546337518e93213-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/28546337518e93213-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/28546337518e93213-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/28546337518e93213-roelpro/js/app.js"></script>
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/28546337518e93213-roelpro/712.GIF" /> 
        </div> 
