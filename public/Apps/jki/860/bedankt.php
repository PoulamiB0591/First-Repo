...
<style>
    ...
    <div class="main_wrapper">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT"><a href="/Apps/jki/860/index.phpindex.php" class="" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
        ...
        <script> window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/54754c21514cc7445-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
