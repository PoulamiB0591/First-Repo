...
session_start();
     ...
     $sqlUser = mysql_query("SELECT * FROM `userTemplateDetails` WHERE `folder_name`='72554870beea0f2414-indexus'");
   
     $data =  mysql_fetch_assoc($sqlUser);
...
$result = $sfp->UpdateData($dataUpdate);
  ...
  $results =  $sfp->select_table($dataselect);
      ...
      $selected_array=mysql_fetch_assoc($results);
