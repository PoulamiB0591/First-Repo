...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <script type="text/javascript" src="SFPURLLINK/js/vendor/modernizr-2.6.2.min.js"></script>
        ...
        <script type="text/javascript">window.jQuery || document.write('<script src="SFPURLLINK/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script type="text/javascript" src="SFPURLLINK/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="SFPURLLINK/js/plugins.js"></script>
        <script type="text/javascript" src="SFPURLLINK/js/main.js"></script>
