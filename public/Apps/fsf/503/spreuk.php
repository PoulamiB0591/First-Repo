...
file_put_contents("/var/www/staging/public/Apps/fsf/503/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/fsf/503/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/html2canvas.js"></script> 
        <script type="text/javascript" src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/jquery.plugin.html2canvas.js"></script> 
        <script src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/app.js"></script> 
          ...
          <div class="container-fluid top">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff" contenteditable="false"><a class="" href="/Apps/fsf/503/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT">Voer je spreuk in ...</h2></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="SFPTWO_TEXTEDIT"><h3 class="SFPTWO_TAGEDIT">Wat is jouw lijfspreuk als professional?</h3></div>
                </div>
                </div><!-- end of container -->
