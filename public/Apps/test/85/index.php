  ...
  foreach (glob($userfolder."/*.php") as $search) {
    ...
    if($search != $userfolder."/index.php"){
        ...
        if (strpos($file_contents, "SFPTWO_EDITFORM"))
          {
            $file_contents = str_replace("<!--SFPPAGE-->",$form,$file_contents);
          }
        file_put_contents($search,$file_contents); 
    } 
} 
...
foreach (glob($userfolder."/*.php") as $search) {
  ...
  {
    $contents=str_replace("<!--SFPPAGE-->",$form,$contents);
  }
...
chmod($pathfolder1, 0777);
 ...
 foreach (glob($pathfolder1."/*.php") as $searches1) {
  ...
  {
    $file_content=str_replace("<!--SFPPAGE-->",$form,$file_content);
  }
