...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/95754900a0bb8e0b13-roelpro/jquery.alerts.css">
 ...
 <scriptsrc="//test.scampaigns.com/user_template/95754900a0bb8e0b13-roelpro/js/jquery.alerts.js"></script>
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  '/var/www/staging/public/Apps/test/295/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//test.scampaigns.com//Apps/test/295/<?php echo $new_image_name;?> 
"/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="//test.scampaigns.com//Apps/test/295/<?php echo $new_image_name;?> 
"/>
</body>
</html>
