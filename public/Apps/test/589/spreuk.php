...
<meta http-equiv="X-UA-Compatible" content="IE=edge"> 
 ...
 <link rel="shortcut icon" type="image/x-icon" href="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/favicon.ico"> 

<link type="text/css" rel="stylesheet" href="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/css/style.css" />
<script  type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>

<script type="text/javascript" src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/js/jquery.cropit.js"></script>
</head>
...
//right slide	
        ...
        $('.image-editor').cropit({
          imageState: {
            src: 'http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/bg_img.png'
          }
        });
...
<form method="POST" enctype="multipart/form-data" action="fileupload.php" id="myForm">
	...
	<watermark>
<default name ="SfpDefault" value='http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/watermark/watermark.png'/>

</watermark>
</form>
  <div class="container SFPTWO_BACKGROUND">
  <div style="display: none;" id="loaderTime" class="loaderOverlay">
	<img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/loading.gif">
	</div>
   <div class="top_section">
        <div class="SFPTWO_IMAGEEDIT logo"><a href="/Apps/test/589/index.php" title="H &amp; M"><img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/logo.png" alt="" /></a></div><!-- end of logo -->
        <div class="SFPTWO_IMAGEEDIT top_banner"><img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/top_banner.jpg" alt="" /></div><!-- end of top_banner -->
        </div>
         <div class="contest">
            <div class="text two">
            ...
            <div class="SFPTWO_TAGEDIT explicit_edit">
                ...
                <a href="#"><div class="SFPTWO_IMAGEEDIT"><img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/join_arrow.png" alt="" /></div></a>
            </div><!-- end of text/two -->
 ...
 <div class="image-editor">
         <div class="drop_browse">
         	<span><img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/drag.png" alt="" /></span>
     ...
     <!-- <div class="image-size-label">
      ...
      <div class="footer">
        ...
        <div class="SFPTWO_TAGEDIT explicit_edit">
            ...
            <div class="SFPTWO_IMAGEEDIT"><a href="#"><img src="http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/footer_logo.png" alt="" /></a></div>
        </div>
        </div>
