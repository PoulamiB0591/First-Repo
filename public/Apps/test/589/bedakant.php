...
<?php
	...
	if($lastId =="")
	{
	header("Location: /Apps/test/589/index.php");
	}
...
//echo "/Apps/test/589/". $rowFetchCurrent['imagePath'];
session_unset();  ?>
<body>
<div id="fb-root"></div>
<script>
...
<div class="thanks">
        <img src="<?php if($resultCurrent[0]['watermarkImage']==""){echo "http://test.scampaigns.com/user_template/5435530c05d2ccc410-hmPhotoSfpContest/images/thanks_img.jpg";}else{ echo "/Apps/test/589/". $resultCurrent[0]['watermarkImage'];}?>"  id="ImgCanvas">
            ...
            <div class="advertise">
                ...
                <div class="FacebookLike"><div class="fb-like" data-href="<?php if($resultCurrent[0]['watermarkImage']==""){echo "";}else{ echo "/Apps/test/589/". $resultCurrent[0]['watermarkImage'];}?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></div>
                </div>
