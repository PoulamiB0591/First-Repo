...
<script type="text/javascript" src="http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/js/jquery.cropit.js"></script>
</head>
...
//right slide	
        ...
        $('.image-editor').cropit({
          imageState: {
            src: 'http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/images/bg_img.png'
          }
        });
...
<form method="POST" enctype="multipart/form-data" action="fileupload.php" id="myForm">
	...
	<watermark>
<default name ="SfpDefault" value='http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/watermark/watermark.png'/>

</watermark>
</form>
  <div class="container SFPTWO_BACKGROUND">
  <div style="display: none;" id="loaderTime" class="loaderOverlay">
	<img src="http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/images/loading.gif">
	</div>
        ...
        <div class="SFPTWO_IMAGEEDIT top_banner"><img src="http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/images/top_banner.jpg" alt="" /></div><!-- end of top_banner -->
         ...
         <div class="contest">
            ...
            <div class="SFPTWO_TAGEDIT explicit_edit">
                ...
                <a href="#"><div class="SFPTWO_IMAGEEDIT"><img src="http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/images/join_arrow.png" alt="" /></div></a>
            </div><!-- end of text/two -->
 ...
 <div class="image-editor">
         <div class="drop_browse">
         	<span><img src="http://test.scampaigns.com/user_template/2805530bf42bad6a15-hmPhotoSfpContest/images/drag.png" alt="" /></span>
