...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/831546306c48a2f215-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'//var/www/staging/public/Apps/test_upload/657/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="//var/www/staging/public/Apps/test_upload/657/<?php echo $new_image_name;?>"/></div>
                </div> </div>
