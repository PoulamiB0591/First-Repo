       ...
       // 
        ...
        if($("#img_val").length)
          var val="";
            ...
            jAlert("Image is not well percept.");
              window.history.back();
            }
          }
         }, 70);
...
$detector = new svay\FaceDetector('detection.dat');
    ...
    $file =  '/var/www/staging/public/Apps/khjkhkhk/157/upload/'.$fid.'.jpg';
...
<body style="position: inherit;">
 <div class="overlay_div" style="opacity: 0.40;">
  ...
  <input type="text" class="width" value="<?php echo $width;?>"/>
  <input type="text" class="height" value="<?php echo $height;?>"/>
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont textup"><img id="front-img" src="//test.scampaigns.com//Apps/khjkhkhk/157/<?php echo $new_image_name;?> 
" /></div>
               <div class="front-img-cont textbellow"><img id="front-img" src="//test.scampaigns.com//Apps/khjkhkhk/157/<?php echo $new_image_name;?> 
" /></div>
                <div class="back-img-cont">
                <img  id="back-img" src=""/></div>
                </div> </div>

<input type="hidden" id="uploadimgtext" value="//test.scampaigns.com//Apps/khjkhkhk/157/<?php echo $new_image_name;?> "/>
</body>
</html>
