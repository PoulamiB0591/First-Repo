    ...
    <link rel="shortcut icon" type="image/x-icon" href="SFPURLLINK/img/favicon.ico">
        ...
        <div class="main_wrap SFPTWO_BACKGROUND">
          ...
          <div class="img_pic" style="display: none;">
            	<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="SFPURLLINK/img/frame_img.png" alt=""></div>
            ...
            <ul class="option">
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="SFPURLLINK/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">VIP Threathments</p></div></li>
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="SFPURLLINK/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">Epic night with your friends</p></div></li>
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="SFPURLLINK/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">Your favorite cocktail</p></div></li>
            </ul><!-- end of option -->
