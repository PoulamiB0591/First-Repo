...
<!--SFPScript type="text/javascript" src="SFPURLLINK/js/jquery.cropit.js"></SFPScript-->
</head>
...
//right slide	
        ...
        $('.image-editor').cropit({
          imageState: {
            src: 'SFPURLLINK/images/bg_img.png'
          }
        });
...
<form method="POST" enctype="multipart/form-data" action="fileupload.php" id="myForm">
	...
	<watermark>
<default name ="SfpDefault" value='SFPURLLINK/watermark/watermark.png'/>

</watermark>
</form>
  <div class="container SFPTWO_BACKGROUND">
  <div style="display: none;" id="loaderTime" class="loaderOverlay">
	<img src="SFPURLLINK/images/loading.gif">
	</div>
        ...
        <div class="SFPTWO_IMAGEEDIT top_banner"><img src="SFPURLLINK/images/top_banner.jpg" alt="" /></div><!-- end of top_banner -->
         ...
         <div class="contest">
            ...
            <div class="SFPTWO_TAGEDIT explicit_edit">
                ...
                <a href="#"><div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/images/join_arrow.png" alt="" /></div></a>
            </div><!-- end of text/two -->
 ...
 <div class="image-editor">
         <div class="drop_browse">
         	<span><img src="SFPURLLINK/images/drag.png" alt="" /></span>
