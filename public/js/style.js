...
$(document).ready(function() {
    ...
    var res = uri.split("files/");
    var res2 = res[1].split("/");
    var newurl = res2[0];
   
     $(".imgedit").append("<div class='setting-2'><a title='Edit' class='edit' href='#'>edit</a><a title='delete' class='delete' href='#'>edit</a><input type='hidden' value='"+newurl+"' id='hid' /></div>");
...
//		});
     ...
     $(".imgedit a.edit").live("click",function(){
        ...
        $('#upload').remove();
        var url = $("#hid").val();
        var uri_new = "http://localhost/zf_new/public/Frontend/submit/"+url;
		//$(".what_is_this").fadeIn(500); 
        $(this).parent().css('position','fixed');
        $(this).parent().parent().attr('id','editable');
        $(this).parent().parent().append('<div style="display: block;" id="upload" ><form style="width: 76px; overflow: hidden;" id="image_upload1" enctype="multipart/form-data" action="'+uri_new+'" method="post"><input type="file" style="display: block;" id="images1" name="images1"></form></div>');
...
//    $("#"+imgid).width(widh);
    ...
    //$.ajax({
//                type:'POST',
//                data:{imgid:imgid,imgpath:imgpath,imgsrc:imgsrc,high:high,widh:widh,id:url},
//                url: 'http://localhost/zf_new/public/Frontend/ajaxedit/'+url,
