...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/img/favicon.ico"> SFPhide-->
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link rel="stylesheet" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/css/normalize.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/css/jquery.alerts.css"> 
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/css/main.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/style.css">
        ...
        <!--SFPScript data-require="angular.js@*" data-semver="1.2.0" src="//code.angularjs.org/1.2.0/angular.js"></SFPScript-->
           <!--SFPScript src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/plugins.js"></SFPScript-->
        <!-- </script> -->
        <!--SFPScript src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/jquery.alerts.js"></SFPScript-->
         <!--SFPScript src="https://connect.facebook.net/nl_NL/all.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/js/app.js"></SFPScript-->
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/712.GIF" /> 
        </div> SFPhide-->
    ...
    <div class="main_wrapper">
          <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1">
                	<img id="images1" src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/img/logo.jpg" alt=""><!-- end of logo -->
                   <div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="88354a26a3953dc89-roelpro" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                      <div class="explicit_edit" contenteditable="false"><a style="cursor: pointor;" title="Nodig je vrienden uit" class="invite disabled" onclick="invite()"><img src="//test.scampaigns.com/user_template/88354a26a3953dc89-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit" contenteditable="false">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
