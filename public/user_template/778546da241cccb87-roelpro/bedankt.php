...
<style>
    ...
    <body style="position: inherit;">
       ...
       <!--SFPhide  <div class="overlay_div">
        ...
        <script>window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/778546da241cccb87-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</script>
        <script src="//test.scampaigns.com/user_template/778546da241cccb87-roelpro/js/plugins.js"></script>
        <script src="//test.scampaigns.com/user_template/778546da241cccb87-roelpro/js/main.js"></script>
