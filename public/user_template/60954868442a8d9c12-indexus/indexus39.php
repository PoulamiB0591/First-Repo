...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        function validation() {
            ...
            success:function(data){    
               if(data == "1")
                {
                window.location.href = "indexus40.php";
                }
                //alert(data);
            }
        });  
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/bar1.png" alt="" class="img-responsive"></div>
                            	...
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/bar2.png" alt="" class="img-responsive"></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">€100.000</span></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="3" type="radio"></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/bar3.png" alt="" class="img-responsive"></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">€250.000</span></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="3" type="radio"></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/bar4.png" alt="" class="img-responsive"></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">€500.000</span></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="3" type="radio"></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/bar5.png" alt="" class="img-responsive"></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">€1.000.000</span></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="3" type="radio"></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/icon5.png" alt="" class="img-responsive"></div>
