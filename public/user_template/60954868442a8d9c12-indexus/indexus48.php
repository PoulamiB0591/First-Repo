...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        function validation() {
            ...
            success:function(data){    
               if(data == "1")
                {
                window.location.href = "indexus49.php";
                }
                //alert(data);
            }
        });  
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                             <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="heading" id="question">Wat is uw<br><span>&nbsp;&nbsp; risico profiel?</span></h2></div>
                            ...
                            <ul class="profiel">
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img src="SFPURLLINK/img/defensief_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="60954868442a8d9c12-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT tags_2"><span class="SFPTWO_TAGEDIT explicit_edit tag_1" contenteditable="false">Defensief</span><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT tagsimg_3"><img src="SFPURLLINK/img/neutraal_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="60954868442a8d9c12-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT tags_3"><span class="SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">Neutraal</span><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT tagsimg_4"><img src="SFPURLLINK/img/offensief_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="60954868442a8d9c12-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT tags_4"><span class="SFPTWO_TAGEDIT explicit_edit tag_3" contenteditable="false">Offensief</span><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            </ul>
                        </div>
                    </div>
