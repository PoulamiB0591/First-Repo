...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/2405461f1d2e7b6112-roelpro/jquery.alerts.css">
...
if ($_FILES['fileToUpload']['error'] > 0) {
    ...
    if (in_array($fileExtension, $validExtensions)) {
        ...
        $destination =  $_SERVER['DOCUMENT_ROOT'].'/SFPUPLOAD/upload/'.$newName;
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <img  id="back-img" src="/SFPUPLOAD/<?php echo $new_image_name;?>"/></div>
                </div> </div>
