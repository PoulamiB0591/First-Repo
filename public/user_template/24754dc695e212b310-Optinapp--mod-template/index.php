...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/24754dc695e212b310-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/24754dc695e212b310-Optinapp--mod-template/css/jui.checkboxes.css">
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/24754dc695e212b310-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<div class="form-container jui-checkboxes-container" id="checkboxesInit2">
        ...
        <li id="lilabelme" style="position: relative; top: 224px; left: 39px; display: none;"><a style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="email" id="email"><span>Email</span><img src="/formbuild/email_icon.png" alt=""></a></li>
        
        </ul>
        <form id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
        
        <img src="/img/divider.png" id="imgdrag" style="position: relative; top: 224px; display: none;">
