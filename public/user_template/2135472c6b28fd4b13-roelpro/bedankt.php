...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/2135472c6b28fd4b13-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/2135472c6b28fd4b13-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript>    
       ...
       <!--SFPhide  <div class="overlay_div">
        ...
        <div class="main_wrapper">
            ...
            <div class="main_content">
                ...
                <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Bedankt!</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div></div>
                    <div class="SFPTWO_TEXTEDIT"><h3 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Je hebt <i><b>zojuist je tegel gedeeld op Facebook.</b></i></h3><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div></div>
                    </div>
        ...
        <!--SFPScriptwindow.jQuery || document.write('<script src="//test.scampaigns.com/user_template/2135472c6b28fd4b13-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</!--SFPScript> 
