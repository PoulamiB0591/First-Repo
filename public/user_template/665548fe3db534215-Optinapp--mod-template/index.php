...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/665548fe3db534215-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/665548fe3db534215-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/665548fe3db534215-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/665548fe3db534215-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form name="form_1348572" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px; clear:both;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_5 element4"><div id="getbtnme" class="submitdrag"><input class="" name="submit" value="Send" type="submit"></div></li>
