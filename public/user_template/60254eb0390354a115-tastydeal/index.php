    ...
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Sigmar+One' rel='stylesheet' type='text/css'>
            <link href='https://fonts.googleapis.com/css?family=Oswald:400,700' rel='stylesheet' type='text/css'>
                 <!--SFPScript   type="text/javascript" src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/js/jquery-1.9.1.min.js"></SFPScript-->
                <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/js/bootstrap.min.js"></SFPScript-->
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/css/bootstrap.min.css">
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/css/style.css">
            </head>
            <body>
                <div id="wrapper" class="SFPTWO_BACKGROUND">
                    ...
                    <div class="SFPTWO_TEXTEDIT">
                        ...
                        <a href="#" data-lead-id="logo" ID="logo" class="SFPTWO_IMAGEEDIT">
                            <img src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/img/logo.png" class="img-responsive center-block" />
                        </a>
                    </div>
                    <div class="hero-img-section text-center">
                    <div class="SFPTWO_IMAGEEDIT">
                        <img src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/img/hero-image.jpg" data-lead-id="hero-img" class="img-responsive center-block" />
                        </div>
                        <div class="sunburst">
                        <div class="SFPTWO_IMAGEEDIT">
                            <img src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/img/burst.png" data-lead-id="hero-burst" class="img-responsive center-block" />
                            
                          
                         <div data-lead-id="burst-text" class="burst-text textedit SFPTWO_TEXTEDIT edit explicit_edit"><span class="SFPTWO_TAGEDIT">$</span>6</div>
                                                 </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="SFP_ROW">
                            <div class="SFP_BOOT-sm-6">
                                ...
                                <div class="SFPTWO_IMAGEEDIT">
                                    <img src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/img/coupon-bg.jpg" data-lead-id="coupon-bg" class="coupon-bg" />
                                 </div>
                        ...
                        <div class="SFP_ROW">
                            <div class="SFP_BOOT-md-12 text-center">
                                <div data-lead-id="add-this" class="SFPTWO_IMAGEEDIT addthis_sharing_toolbox social-links">
                                    <img src="//test.scampaigns.com/user_template/60254eb0390354a115-tastydeal/img/social_btns.png" />
                                </div>
                                <div>
