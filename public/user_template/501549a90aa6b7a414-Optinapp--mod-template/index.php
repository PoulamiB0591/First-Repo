...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/501549a90aa6b7a414-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/501549a90aa6b7a414-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/501549a90aa6b7a414-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/501549a90aa6b7a414-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
<div class="tool-tip SFPTWO_TEXTEDIT tags_1"><h2 class="textedit SFPTWO_TAGEDIT edit tag_1">Fill in your details and win!gfhfghfghfghfghfghgfh</h2></div>
...
<form name="form_1739317" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2 element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;width:640px;" id="pid_" class="opt SFPTWO_TAGEDIT tag_2"><font>EmaiL addressghfghfghgfhfgh fhfghfghfghfghfhfghfghfg hfghfghf ghfg h fg hfghfghfghfghfghgh</font></p></div><input name="email" type="email">
    
    </li>
    

	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;width:640px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font>What kind of campaign are you Looking for? </font>
	 ...
	 <li style="" class="dottedLi SFPTWO_TEXTEDIT tags_4 element3"><div id="diveditme" class="labeledit"><p style="font-size: 19px;width:640px;" id="pid_formmsg" class="opt SFPTWO_TAGEDIT tag_7"><font>Your message</font></p><div><textarea id="editmetext" name="textareaelement3" class="textareaforform SFPTEXTAREA"></textarea></div></div></li>
