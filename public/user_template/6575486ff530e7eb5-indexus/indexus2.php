        ...
        <section class="main_step3">
            <div class="container">
                        ...
                        <div class="main_content">
                           ...
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/icon3.png" alt=""></a>
