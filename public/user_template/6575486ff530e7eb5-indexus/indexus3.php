...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/js/vendor/modernizr-2.6.2.min.js"><!--SFPScript>
        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/bar1.png" alt="">
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/bar2.png" alt="">
                                    <span>€100.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/bar3.png" alt="">
                                    <span>€250.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/bar4.png" alt="">
                                    <span>€500.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/bar5.png" alt="">
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/icon5.png" alt="">
                                     
                                    <span>€2.500.000</span>
                                    <label class="label_radio"><input type="radio"></label>
                                </li>
                            </ul>
                            <a class="button_btn disabled" style="cursor: pointer;" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/6575486ff530e7eb5-indexus/img/icon3.png" alt=""></a>
