            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s1">2 jaar </span></label>
                            ...
                            <div class="jaar" id="jaarindexus2">
                            	<span id="es1">2 jaar </span>
                            	<span id="es2">15 jaar </span>
                            	<span id="es3">10 jaar</span>
                            	<span id="es4">5 jaar</span>
                            </div>
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/8805497f4bca228610-indexus/img/icon3.png" alt=""></a>
