...
<!--SFPPAGE-->
  ...
  <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">
   <link rel="stylesheet" href="//test.scampaigns.com/user_template/75654899dc122e4910-LorettaWebinarSignupDesk/css/style.css">
...
<div class="header">
  <div class="container">
    <img src="//test.scampaigns.com/user_template/75654899dc122e4910-LorettaWebinarSignupDesk/images/6sr76z-logo.png" class="company-logo">
  </div>
</div>
...
<form name="form_1416179" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_3 element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;color:#15ace7" id="pid_" class="opt SFPTWO_TAGEDIT tag_5"><font color="#15ace7">EmaiL address</font></p></div><input name="email" type="email">
    
    </li>
    

	<li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_4 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_6"><font color="#15ace7">What kind of campaign are you Looking for? </font>
	 ...
	 <li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_5 element3"><div id="diveditme" class="labeledit"><p style="font-size: 19px;" id="pid_formmsg" class="opt SFPTWO_TAGEDIT tag_10"><font color="#15ace7">Your message</font></p><div><textarea id="editmetext" name="textareaelement3"></textarea></div></div></li>
            ...
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
              <div class="row">
                <div class="col-sm-4 SFPTWO_IMAGEEDIT tagsimg_1">
                  <img src="//test.scampaigns.com/user_template/75654899dc122e4910-LorettaWebinarSignupDesk/images/1u1mdnh-bbb.png">
                </div>
                <div class="col-sm-4 SFPTWO_IMAGEEDIT tagsimg_2">
                  <img src="//test.scampaigns.com/user_template/75654899dc122e4910-LorettaWebinarSignupDesk/images/1s97s6s-bizrate.png">
                </div>
                <div class="col-sm-4 SFPTWO_IMAGEEDIT tagsimg_3">
                  <img src="//test.scampaigns.com/user_template/75654899dc122e4910-LorettaWebinarSignupDesk/images/1kbjx83-truste.png">
                </div>
              </div>
            </div>
          </div>
