...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/img/favicon.ico">
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
      
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/normalize.css">
         <link rel="stylesheet" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/main.css">
        
        <!-- MAS slider -->
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/mas-slider.css">
		<link href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/mas-default.css" rel="stylesheet" type="text/css">
		<link href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/mas-part-view.css" rel="stylesheet" type="text/css">
       <link rel="stylesheet" href="//test.scampaigns.com/css/templateform.css"> 
       <link rel="stylesheet" href="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/css/jquery.alerts.css"> 
             <script src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/vendor/modernizr-2.6.2.min.js"></script>
       ...
       <!--[if lt IE 7]>
        ...
        <div class="main_wrapper" id="change">
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/img/1.png" alt="lorem ipsum dolor sit"> 
                    <div class="ms-info">
                       
                    </div>  
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/img/2.png" alt="lorem ipsum dolor sit">    
                      <div class="ms-info">
                        
                    </div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/img/3.png" alt="lorem ipsum dolor sit">   
                     <div class="ms-info"></div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/img/4.png" alt="lorem ipsum dolor sit">   
                      <div class="ms-info"> </div>  
                </div>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <!--SFPScript <script src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/jquery.easing.min.js"></SFPScript-->
               <script src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/jquery.alerts.js"></script>
               
		<!--SFPScript src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/mas.min.js"></SFPScript-->
	<!--SFPScript script src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/mas-part.dev.js"></SFPScript-->
        <script src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/plugins.js"></script>
       <!--SFPScript src="//test.scampaigns.com/user_template/80545c70f5d8a2f7-roelpro/js/main.js"></SFPScript-->
