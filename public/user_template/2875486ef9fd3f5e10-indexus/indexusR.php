   ...
   $.ajax({
        ...
        <footer class="inside_footer">
            <div class="container">
                    	...
                    	<a href="http://www.indexus.nl/" target="_blank" class="web_link SFPTWO_TAGEDIT explicit_edit disabled tag_4" contenteditable="false">www.indexus.nl</a>
