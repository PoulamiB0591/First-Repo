...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/33654a11ed045c1c13-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/33654a11ed045c1c13-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/33654a11ed045c1c13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/33654a11ed045c1c13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form name="form_79616" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
    ...
    </p></div><div class="checksboxes p_scents chkboxaddnow" id="checksboxes_form657"><div id="chkclone" name="checkBox"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-rowform657"><span class="checkboxWrapper"><input value="option1" name="check[]" type="checkbox"> </span> <p class="opt SFPTWO_TAGEDIT tag_4" id="1"><font>option1</font></p> </div><div class="jui-checkbox-row"> <span class="checkboxWrapper"><input value="option2" name="check[]" type="checkbox"></span> <p class="opt SFPTWO_TAGEDIT tag_5" id="2"><font>option2</font></p> </div><div class="jui-checkbox-row"><span class="checkboxWrapper"><input value="option3" name="check[]" type="checkbox"></span><p class="opt SFPTWO_TAGEDIT tag_6" id="3"><font>option3</font></p></div></div><p id="mepp" class="pchkadd"></p><div class="setedit"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> </div> </li>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweBgpTU1BYBggDAgQNBFYIBldXFHhJEg9aWEFFFEgLC10aTQMLRFVQQVxKDwpdUkFIFlxJ","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script>