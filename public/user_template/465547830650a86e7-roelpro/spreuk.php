...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/465547830650a86e7-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/465547830650a86e7-roelpro/js/app.js"></script> 
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff"><a href="/Apps/hrllo/222/index.php" title="Kies je tegel en foto" id="Kies" class="SFPTWO_TAGEDIT" >1) Kies je tegel en foto</a></li>
                    	<li class="explicit_edit enteroff"><a href="//test.scampaigns.com/spreuk.php" id="spreuk" title="Persoonlijke spreuk" class="SFPTWO_TAGEDIT">2) Persoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff"><a href="//test.scampaigns.com/bedankt.php" id="Bedankt" title="Bedankt" class="SFPTWO_TAGEDIT">3) Bedankt</a></li>
                    </ul>
                    </div>
                </div><!-- end of container -->
            </div><!-- end of top -->
