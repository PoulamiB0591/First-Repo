        ...
        <section class="main_step3">
            <div class="container">
                        ...
                        <div class="main_content">
                           ...
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/img/icon3.png" alt=""></a>
                        ...
                        <input id="v4" value="8.8" type="hidden">
                        </div>
