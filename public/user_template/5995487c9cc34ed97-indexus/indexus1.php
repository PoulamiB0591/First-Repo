            ...
            <div class="container">
                        ...
                        <div class="main_content">
                           ...
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/img/icon4.png" alt=""><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="5995487c9cc34ed97-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/img/icon3.png" alt=""></a>
                        ...
                        <div>
                        <input id="v1" value="2" type="hidden">
                        <input id="v2" value="3" type="hidden">
                        <input id="v3" value="6" type="hidden">
                        <input id="v4" value="8" type="hidden">
                        <input id="v5" value="9" type="hidden">
                        </div>
