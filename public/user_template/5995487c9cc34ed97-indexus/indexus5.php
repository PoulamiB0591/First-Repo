...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
        ...
        <section class="main_step6">
                    <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/img/icon1.png" alt=""><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="5995487c9cc34ed97-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
        ...
        <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/5995487c9cc34ed97-indexus/js/plugins.js"></SFPScript-->
