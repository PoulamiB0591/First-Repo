    ...
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Sigmar+One' rel='stylesheet' type='text/css'>
            <link href='https://fonts.googleapis.com/css?family=Oswald:400,700' rel='stylesheet' type='text/css'>
                 <!--SFPScript   type="text/javascript" src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/js/jquery-1.9.1.min.js"></SFPScript-->
                <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/js/bootstrap.min.js"></SFPScript-->
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/css/bootstrap.min.css">
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/css/style.css">
            </head>
            <body>
                    ...
                    <div class="SFPTWO_TEXTEDIT">
                       ...
                       <div class="logo SFPTWO_IMAGEEDIT">
                        <a href="#" data-lead-id="logo" class="">
                            <img src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/img/logo.png" class="img-responsive center-block" />
                        </a>
                        </div>
                    </div>
                    <div class="hero-img-section text-center">
                    <div class="SFPTWO_IMAGEEDIT">
                        <img src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/img/hero-image.jpg" data-lead-id="hero-img" class="img-responsive center-block" />
                        </div>
                        <div class="sunburst">
                        <div class="SFPTWO_IMAGEEDIT">
                            <img src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/img/burst.png" data-lead-id="hero-burst" class="img-responsive center-block" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div data-lead-id="coupon-container" class="coupon-container">
                                    <img src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/img/coupon-bg.jpg" data-lead-id="coupon-bg" class="coupon-bg" />
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div data-lead-id="add-this" class="SFPTWO_IMAGEEDIT addthis_sharing_toolbox social-links">
                                    <img src="//test.scampaigns.com/user_template/714550a94993289f15-tastydeal/img/social_btns.png" />
                                </div>
                                <div>
