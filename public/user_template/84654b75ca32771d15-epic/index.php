...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
    ...
    <link rel="shortcut icon" type="SFPURLLINK/image/x-icon" href="img/favicon.ico">
        ...
        <div id="index" class="main_wrap SFPTWO_BACKGROUND">
        	...
        	<div style="overflow: hidden;" class="SFPTWO_IMAGEEDIT"><a style="cursor: pointer;" class="logo disabled"><img id="images1" src="SFPURLLINK/img/logo.jpg" alt=""></a><!-- end of logo --></div>
            ...
            <ul class="blog">
            	<li><a class="disabled" style="cursor: pointer;" onclick="Login();"><div class="SFPTWO_IMAGEEDIT"><img id="images" src="SFPURLLINK/img/facebook_btn.png" alt="" /></div></a></li>
