        ...
        <section class="main_step3">
            <div class="container">
                        ...
                        <div class="main_content">
                            <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">Over hoeveel jaar&nbsp; fffffgf<span>wilt u over uw vermogen beschikken?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
