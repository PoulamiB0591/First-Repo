   ...
   $.ajax({
    ...
    <body>
        ...
        <section class="main_step4">
            <div class="container">
                        <header>
                            <div class="SFPTWO_IMAGEEDIT img_section"><a title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/logo.png" alt="" /></a></div>
...
PHP--></p></h3>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section"><img src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/icon7.png" alt="" class="img_response" /></div>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/js/main.js"></SFPScript-->
