...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/favicon.ico">
        ...
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/css/normalize.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/css/reset.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/css/main.css">
    ...
    {    
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <header>
                           <div style="display: inline-block;" class="SFPTWO_IMAGEEDIT img_section tagsimg_1 rand_859 rand_841"><a style="cursor: pointer;" title="Indexus" class="logo disabled"><img src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/logo.png" alt=""></a><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="5515497fdedbaeed9-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                <label id="R1" class="label_radio1"><input id="r1" name="investorR" value="1" type="radio"> <span id="es1"> Pensioen  fgfgfgfgffgf</span></label>
                                ...
                                <label id="R5" class="label_radio1"><input id="r5" name="investorR" value="5" type="radio"> <span id="es5">Aanvulling voor inkohghg</span></label>
                            </div>
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT tag_2 explicit_edit" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                           
                            <div style="display: inline-block;" class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><a style="cursor: pointer;" title="Indexus" class="logo disabled"><img src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/logo.png" alt=""></a><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="5515497fdedbaeed9-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                            <fieldset class="radios">
                                <label id="R11" class="label_radio"><input id="r1" name="investorR1" value="1" type="radio"> <span id="s1"> Pensioen  fgfgfgfgffgf</span></label>
                               ...
                               <label id="R15" class="label_radio"><input id="r5" name="investorR1" value="5" type="radio"> <span id="s5">Aanvulling voor inkohghg</span></label>
                                <input id="val" name="hiddeninputname" value="" type="hidden">
                            </fieldset>
                            <a class="button_btn SFPTWO_TAGEDIT tag_3 explicit_edit disabled" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/img/icon3.png" alt=""></a>
                        <div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                        <div>
                        <input id="v1" value="1" type="hidden">
                        <input id="v2" value="1" type="hidden">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/5515497fdedbaeed9-indexus/js/plugins.js"></SFPScript-->
