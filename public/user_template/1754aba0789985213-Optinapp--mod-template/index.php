...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/1754aba0789985213-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/1754aba0789985213-Optinapp--mod-template/css/jui.checkboxes.css">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="editable" class="opt explicit_edit SFPTWO_TAGEDIT tag_2" contenteditable="false"><font><font color="#50e0f1">EmaiL </font><font color="#50f1ef">address</font></font></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><input name="email" type="email">
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweBA5QUgVbVglRXg0ACQALVFVJdkdNDwhVSUEYFAgJABRDXAsWWFhFUBYMCABcTxcWDkQ=","queueTime":0,"applicationTime":11,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script>