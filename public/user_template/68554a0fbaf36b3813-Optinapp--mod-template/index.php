...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/68554a0fbaf36b3813-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/68554a0fbaf36b3813-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/68554a0fbaf36b3813-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/68554a0fbaf36b3813-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form name="form_1657472" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3"><font>What kind of campaign are you Looking for? </font>
    	...
    	<li class="dottedLi SFPTWO_TEXTEDIT tags_6"><div id="labeledit" class="labeledit radioboxdrag"><p id="pid_694" class="opt SFPTWO_TAGEDIT tag_8 undefined"><font class="SFPCOLOR">radio</font></p></div><div class="checksboxes p_scents selectboxaddnow editmyopt addingselect" id="checksboxes_792"><div id="radioclone"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-row792"><span class="checkboxWrapper"><input value="1" name="name" type="radio"> </span> <p class="opt explicit_edit" id="1" style="display:inline-block;" contenteditable="false"><font class="SFPCOLOR">option1</font></p> </div><div class="jui-checkbox-row"> <span class="checkboxWrapper"><input value="2" name="name" type="radio"></span> <p class="opt explicit_edit" id="2" style="display:inline-block;" contenteditable="false"><font class="SFPCOLOR">option2</font></p> </div></div><p id="mepp" class="pselectadd"></p> <div class="seteditopt"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> </div></li>
    </li>
