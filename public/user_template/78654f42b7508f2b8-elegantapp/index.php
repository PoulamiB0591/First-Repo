...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
           <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/js/jquery-1.9.1.min.js"></SFPScript-->
           <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/js/bootstrap.min.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/js/html5shiv.js"></SFPScript-->
             <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/js/functions.js"></SFPScript-->
         <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/js/wow.min.js"></SFPScript-->
            <link rel="stylesheet" href="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/css/bootstrap.min.css">
            <link rel="stylesheet" href="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/css/animate.css">
            <link rel="stylesheet" href="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/css/style.css">
            ...
            <div id="wrapper " class="">
                ...
                <div id="logo-badge" class="logo-badge">
                    <div class="textme"></div><div class="logo-badge-inner SFPTWO_IMAGEEDIT tagsimg_1">
                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/logo.png" id="logo-badge-logo" class="img-responsive center-block"><a href="#page5-header" id="badge-btn" class="btn btn-primary btn-ribbon btn-block sfpDynamic">DOWNLOAD</a>
                    </div>
                </div>
                                ...
                                <div class="container">
                                    <div class="SFP_ROW">
                                                    ...
                                                    <ul class="list-inline">
                                                        ...
                                                        <li data-lead-id="hero-btn-container">
                                                            ...
                                                            <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_2">
                                                                <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/download-btn-icon.png" data-lead-id="btn-hero-icon" class="btn-icon">
                                                               </div>
                                                ...
                                                <div id="hero-trust-container" class="trust-area wow fadeIn" data-wow-delay=".9s">
                                                    <ul class="list-inline">
                                                        <div class="textme"></div><li class="SFPTWO_IMAGEEDIT tagsimg_3">
                                                            <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/hero-trust-icon.png" id="hero-trust-img" class="trust-img">
                                                        </li>
                                        ...
                                        <div class="textme"></div><div class="SFP_BOOT-sm-6 SFPTWO_IMAGEEDIT tagsimg_4">
                                            <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/hero-app.png" id="hero-img" class="img-responsive center-block wow fadeIn" data-wow-delay=".3s">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div id="video0-wrapper" class="video-wrapper">
                                            <div class="video-container wow fadeIn" data-wow-delay=".7s">
                                                <div class="textme"></div><div id="top-vid-area" class="vid-wrapper text-center SFPTWO_IMAGEEDIT tagsimg_5">
                                                    <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/vid_placeholder.jpg" class="img-responsive center-block">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container">
                                <div class="SFP_ROW">
                                    <div class="textme"></div><div class="SFP_BOOT-sm-6 SFPTWO_IMAGEEDIT tagsimg_6">
                                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/iPhone2.png" id="page2-img" class="wow fadeIn img-responsive center-block" data-wow-delay="1s">
                                    </div>
                                    <div class="SFP_BOOT-sm-6">
                                            ...
                                            <div id="page2-list">
                                                <div data-lead-id="feature1-container" class="feature-point feature-point1 wow fadeIn" data-wow-delay="1s">
                                                   <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_7">
                                                    <img data-lead-id="feature1-icon" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/feature-icon1.png" class="feature-icon img-responsive pull-left">
                                                    </div>
                                                ...
                                                <div data-lead-id="feature2-container" class="feature-point feature-point2 wow fadeIn" data-wow-delay="1.5s">
                                                    ...
                                                    <img data-lead-id="feature2-icon" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/feature-icon2.png" class="feature-icon img-responsive pull-left">
                                                    </div>
                                                ...
                                                <div data-lead-id="feature3-container" class="feature-point feature-point3 wow fadeIn" data-wow-delay="2s">
                                                 <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_9">
                                                    <img data-lead-id="feature3-icon" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/feature-icon3.png" class="feature-icon img-responsive pull-left">
                                                    </div>
                                                ...
                                                <div data-lead-id="feature4-container" class="feature-point feature-point4 wow fadeIn " data-wow-delay="2.5s">
                                                    ...
                                                    <img data-lead-id="feature4-icon" src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/feature-icon4.png" class="feature-icon img-responsive pull-left">
                                                 </div>
                                        ...
                                        <div id="gallery_thumbs" class="gallery_thumbs">
                                            <ul class="list-unstyled list-inline text-center">
                                                ...
                                                <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_11">
                                                    <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/screen1.jpg" id="screen1" class="img-responsive center-block wow zoomIn">
                                                  </div>
                                                ...
                                                <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_12">
                                                    <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/screen2.jpg" id="screen2" class="img-responsive center-block wow zoomIn" data-wow-delay=".6s">
                                                </div>
                                                ...
                                                <li id="img-container3">
                                                 <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_13">
                                                    <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/screen3.jpg" id="screen3" class="img-responsive center-block wow zoomIn" data-wow-delay="1s">
                                                   </div>
                                                ...
                                                <li id="img-container4">
                                                 <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_14">
                                                    <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/screen4.jpg" id="screen4" class="img-responsive center-block wow zoomIn" data-wow-delay="1.5s">
                                                  </div>
                    ...
                    <section id="page5" class="page5 section">
                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/office.jpg" id="page5-bg" class="background-img">
                        <div class="content">
                            <div class="container">
                                <div class="SFP_ROW">
                                            ...
                                            <ul class="list-unstyled list-inline text-center">
                                                <li id="buy-btn1-container">
                                                    ...
                                                    <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_15">
                                                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/download-btn-icon.png" data-lead-id="buy-btn-1-img" class="btn-icon">
                                                    </div>
                                                ...
                                                <li id="buy-btn2-container">
                                                    ...
                                                    <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_16">
                                                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/apple-btn-icon.png" data-lead-id="buy-btn-2-img" class="btn-icon">
                                                  </div>
                                                ...
                                                <li id="buy-btn3-container">
                                                    ...
                                                    <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_17">
                                                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/android-btn-icon.png" data-lead-id="buy-btn-3-img" class="btn-icon">
                                                       </div>
                                ...
                                <div class="SFP_ROW author-info-area">
                                    ...
                                    <div class="SFP_BOOT-sm-4 text-center">
                                        ...
                                        <div class="textme"></div><div class="SFPTWO_IMAGEEDIT tagsimg_18">
                                            <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/company-img.png" id="author-img" class="img-responsive center-block author-img">
                                          </div>
                                            <ul class="list-unstyled list-inline author-social-icon-list">
                                                <div class="textme"></div><li class="SFPTWO_IMAGEEDIT sfpfbDynamicShare tagsimg_19 sfpshareme"><div class="textme"></div><a href="#" id="page6-social1" class="sfpDynamic author-social-icon SFPTWO_IMAGEEDIT tagsimg_20"><img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/author_social_1.png" class="img-responsive block-center"></a>
                                                  
                    <input class="sfpfbpic" value="https://tpc.googlesyndication.com/simgad/5327856819906008937" type="hidden">
                    <input class="sfpfbname" value="https://tpc.googlesyndication.com/simgad/5327856819906008937" type="hidden">
                    <input class="sfpfbcaption" value="https://tpc.googlesyndication.com/simgad/5327856819906008937" type="hidden">
                    <input class="sfpfbdescription" value="https://tpc.googlesyndication.com/simgad/5327856819906008937" type="hidden">
...
<div fb-iframe-plugin-query="action=like&amp;app_id=1546857545560281&amp;container_width=0&amp;href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true" fb-xfbml-state="rendered" class="fb-like disabled fb_iframe_widget" data-href="https://developers.facebook.com/docs/plugins/" data-layout="standard" data-action="like" data-show-faces="true" data-share="false"><span style="vertical-align: bottom; width: 450px; height: 57px;"><iframe class="" src="http://www.facebook.com/v2.0/plugins/like.php?action=like&amp;app_id=1546857545560281&amp;channel=http%3A%2F%2Fstatic.ak.facebook.com%2Fconnect%2Fxd_arbiter%2FrFG58m7xAig.js%3Fversion%3D41%23cb%3Df1710fdf8b87c7c%26domain%3Dtest.scampaigns.com%26origin%3Dhttp%253A%252F%252Ftest.scampaigns.com%252Ff16c86258f246b6%26relation%3Dparent.parent&amp;container_width=0&amp;href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;layout=standard&amp;locale=en_US&amp;sdk=joey&amp;share=false&amp;show_faces=true" style="border: medium none; visibility: visible; width: 450px; height: 57px;" title="fb:like Facebook Social Plugin" scrolling="no" allowtransparency="true" name="f30c7d248d3ed7c" frameborder="0" height="1000px" width="1000px"></iframe></span></div> 
                        </div>
                        </li>
                        <div class="textme"></div><li id="twitter-btn-container" class="SFPTWO_IMAGEEDIT sfpfbDynamicTweet tagsimg_32">
                            <iframe style="width: 106px; height: 20px;" data-twttr-rendered="true" title="Twitter Tweet Button" class="twitter-share-button disabled twitter-tweet-button twitter-share-button twitter-count-horizontal" src="http://platform.twitter.com/widgets/tweet_button.26f01cfa05bff9af89657dcbd8f7b705.en.html#_=1425287708619&amp;count=horizontal&amp;dnt=false&amp;id=twitter-widget-0&amp;lang=en&amp;original_referer=http%3A%2F%2Ftest.scampaigns.com%2FFrontend%2Feditnew%2F78654f42b7508f2b8-elegantapp%2Felegantapp&amp;size=m&amp;text=text&amp;url=http%3A%2F%2Fwww.mylooqi.com&amp;via=ami_koushik" allowtransparency="true" scrolling="no" id="twitter-widget-0" frameborder="0"></iframe>
                        ...
                        <div class="textme"></div><li id="google-btn-container" class="SFPTWO_IMAGEEDIT sfpfbDynamicGoogle tagsimg_33">
                            <div class="textme"></div><div id="google-btn" class="SFPTWO_IMAGEEDIT sfpGoogle tagsimg_34">
                                <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/google-like.jpg" class="img-responsive block-center">
                            </div>
                        </li>
                    </ul>
                    ...
                    <a id="fb-share-btn" class="sfpDynamic sfpShare" rel="http://www.google.com">
                        ...
                        <img src="//test.scampaigns.com/user_template/78654f42b7508f2b8-elegantapp/img/fb_share.png" class="img-responsive block-center">      
                    </a>
                   
                    <input class="sfpfbpic" value="http://www.sharelinkgenerator.com/share-link-generator-logo.png" type="hidden">
                    <input class="sfpfbname" value="fsdf" type="hidden">
                    <input class="sfpfbcaption" value="sdfsf" type="hidden">
                    <input class="sfpfbdescription" value="sdfsf" type="hidden">
