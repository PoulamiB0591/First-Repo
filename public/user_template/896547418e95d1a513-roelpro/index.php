...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/img/favicon.ico">
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
      
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/normalize.css">
         <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/main.css">
        
        <!-- MAS slider -->
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/mas-slider.css">
		<link href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/mas-default.css" rel="stylesheet" type="text/css">
		<link href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/mas-part-view.css" rel="stylesheet" type="text/css">
       <link rel="stylesheet" href="//test.scampaigns.com/css/templateform.css"> 
       <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/css/jquery.alerts.css"> 
      <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></!--SFPScript> 
             <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/vendor/modernizr-2.6.2.min.js"></!--SFPScript> 
       ...
       <!--[if lt IE 7]>
        ...
        <input id="getslideid" type="hidden">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff autosize" rel="270" contenteditable="false"><a style="font-size: 40px;" href="SFP_index" title="Kies je tegel en foto" class="active autosizethis disabled">1) persoonlijke spreuk sdfsfsdfdsfdfsdfsdfdsfdsfsdfdsfdsfdsfdsfsdfsdf<br></a></li>
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/img/1.png" alt="lorem ipsum dolor sit"> 
                    <div class="ms-info">
                       
                    </div>  
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/img/2.png" alt="lorem ipsum dolor sit">    
                      <div class="ms-info">
                        
                    </div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/img/3.png" alt="lorem ipsum dolor sit">   
                     <div class="ms-info"></div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/img/4.png" alt="lorem ipsum dolor sit">   
                      <div class="ms-info"> </div>  
                </div>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/jquery.easing.min.js"></SFPScript-->
               <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/jquery.alerts.js"></SFPScript-->
               
		<!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/mas.min.js"></SFPScript-->
	<!--SFPScript script src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/mas-part.dev.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/plugins.js"></SFPScript-->
       <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/main.js"></SFPScript-->
