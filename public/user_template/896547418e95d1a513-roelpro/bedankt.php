...
<style>
    ...
    <body style="position: inherit;">
       ...
       <!--SFPhide  <div class="overlay_div">
            ...
            <div class="main_content">
              ...
              <!--PHP echo '<img id ="imgscreen" src="'.$fullpath.'" />'PHP-->
                ...
                <div class="btn_blog explicit_edit" style="cursor: pointer;" contenteditable="false">
                	<a href="null" class="disabled" style="cursor:pointor;width: 260px;" onclick="invite()"><font color="#1cff14"><strong><font face="Courier New"><font style="font-size:10px;"><font style="font-size:54px;"><font style="font-size:28px;">FACEBOOK VRIENDENuitn odigen voor deze app</font></font></font></font></strong></font><span></span></a>
                </div><!-- end of btn_blog -->
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</!--SFPScript> 
