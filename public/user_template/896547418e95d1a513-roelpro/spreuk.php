...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/js/app.js"></!--SFPScript> 
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/896547418e95d1a513-roelpro/712.GIF" /> 
        </div> SFPhide-->
         ...
         <!--PHP include("menu.php");PHP-->
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Voer je spreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div></div>
