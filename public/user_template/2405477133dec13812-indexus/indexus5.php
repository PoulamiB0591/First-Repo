                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/defensief_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="2405477133dec13812-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Defensief</span><div class="setting-2" id="text" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/neutraal_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="2405477133dec13812-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Neutraal</span><div class="setting-2" id="text" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="SFPURLLINK/img/offensief_img.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="2405477133dec13812-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                                    <label class="label_radio"><input name="radio" id="rd" value="4" type="radio"></label>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Offensief</span><div class="setting-2" id="text" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                                </li>
                            </ul>
                        </div>
                    </div>
