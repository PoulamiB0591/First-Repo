    ...
    <div class="container-fluid top">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false"><font style="font-size:3px;"><font style="font-size:21px;"><font style="font-size:36px;">dff</font></font></font></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div></div>
                    <div class="SFPTWO_TEXTEDIT randtxt_883"><h3 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Je hebt zojuist je tegel gedeeldffgfgfgfgf d op Facebook.</h3><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete disabled" href="javascript:void(0)"></a></div></div>
                    </div>
              ...
              <!--PHP echo '<img id ="imgscreen" src="'.$fullpath.'" />'PHP-->
                ...
                <div class="btn_blog explicit_edit" style="cursor: pointer;" contenteditable="false">
                	<a class="disabled" style="cursor:pointor;width: 260px;" onclick="invite()"><strong>FACEBOOgddgdgdg gdgdgdgK VRIENDEN</strong><span>uitnodigen voor ddgdgdgdgdgddgdgdgdgdgdgdgdg deze app</span></a>
                </div><!-- end of btn_blog -->
