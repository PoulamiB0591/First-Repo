...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="es1">20 jaar </span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="es2">15 jaar </span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="es3">10 jaar</span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="es4">5 jaar</span></label>
                            </fieldset>
                            <div class="jaar" id="jaarindexus2">
                            	<span id="s1">20 jaardsd</span>
                            	<span id="s2">15 jaar</span>
                            	<span id="s3">10 jaar</span>
                            	<span id="s4">5 jaar</span>
                            </div>
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/4485487dd57b76ec5-indexus/img/icon3.png" alt=""></a>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/4485487dd57b76ec5-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/4485487dd57b76ec5-indexus/js/plugins.js"></SFPScript-->
