...
<link rel="stylesheet" href="/editcss/jquery.timepicker.css">
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/39754be552c4c6da11-Loretta_Email_Course/css/style.css">
...
<div class="header">
    <div class="container">
    	<div style="display: none;" class="SFPTWO_IMAGEEDIT tagsimg_1 rand_405">
    		<img src="//test.scampaigns.com/user_template/39754be552c4c6da11-Loretta_Email_Course/images/1b2ayl6-fake-logo.png" class="company-logo">
        </div>
    </div>
</div>
<div class="main">
...
<div class="main-heading tool-tip">
 <div style="display: none;" class="SFPTWO_TEXTEDIT tags_1 texttagdelete randtxt_232">      
    <h1 class="textedit SFPTWO_TAGEDIT edit tag_1 tagdelete bydelete editme"><br></h1></div>
     <div style="display: none;" class="SFPTWO_TEXTEDIT tags_2 texttagdelete randtxt_33">      
    <h4 class="textedit SFPTWO_TAGEDIT edit tag_2 tagdelete"><br></h4>
  </div>
</div>
<div class="SFP_ROW main-center">
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-7 SFPTWO_IMAGEEDIT tagsimg_2">
        <img src="//test.scampaigns.com/user_template/39754be552c4c6da11-Loretta_Email_Course/images/ar0imc-email-envelope.png" class="envelope img-responsive">
    </div>
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-5">
        <div class="SFP_ROW">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3 texttagdelete">
              ...
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_903807" id="" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul style="" class="sortable-list"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_608" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_495" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_566" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete justifyme"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_587" class="SFPEMAIL form-control" type="email"></li>  
	...
	<div class="SFP_BOOT-sm-10 SFP_BOOT-sm-offset-1 SFP_BOOT-md-8 SFP_BOOT-md-offset-2">
        ...
        <div class="SFP_ROW has-bullet-line">
            <div class="SFP_BOOT-xs-2 SFP_BOOT-sm-1">
             <div style="display: none;" class="SFPTWO_TEXTEDIT tags_10 texttagdelete randtxt_269">
            ...
            <div class="SFPTWO_TEXTEDIT tags_11 texttagdelete">
                <h4 class="textedit SFPTWO_TAGEDIT edit tag_10 tagdelete"><br></h4></div>
