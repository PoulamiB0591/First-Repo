...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/js/app.js"></script>
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/924546729cc5ef5e11-roelpro/712.GIF" /> 
        </div> SFPhide-->
