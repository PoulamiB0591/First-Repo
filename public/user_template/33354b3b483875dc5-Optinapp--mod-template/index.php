...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/33354b3b483875dc5-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/33354b3b483875dc5-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div id="editable" class="SFPTWO_IMAGEEDIT tagsimg_1 imgEdit1"><img id="images1" src="//test.scampaigns.com/user_template/33354b3b483875dc5-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="undefined" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/33354b3b483875dc5-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<div class="form-container jui-checkboxes-container" id="checkboxesInit2">
        ...
        <div class="setting-2 prevnext"><a title="delete" class="delete" href="javascript:void(0)"></a><input id="hid" name="email_hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div>
        </li>
