...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
    ...
    <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/41054782db2393cd14-epic/img/favicon.ico">
        ...
        <div class="main_wrap">
            ...
            <div class="img_pic">
            	<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/41054782db2393cd14-epic/img/frame_img.png" alt=""></div>
            ...
            <ul class="option">
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="//test.scampaigns.com/user_template/41054782db2393cd14-epic/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">VIP Threathments</p></div></li>
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="//test.scampaigns.com/user_template/41054782db2393cd14-epic/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">Epic night with your friends</p></div></li>
            	<li class="clearfix"><div class="SFPTWO_IMAGEEDIT"><span><img id="images1" src="//test.scampaigns.com/user_template/41054782db2393cd14-epic/img/bottle_icon.png" alt=""></span></div> <div class="SFPTWO_TEXTEDIT"><p class="SFPTWO_TAGEDIT explicit_edit">Your favorite cocktail</p></div></li>
            </ul><!-- end of option -->
