...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/377550fb2678a1f38-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/377550fb2678a1f38-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="textme" style="display:inline;"></div><div style="overflow: visible;" class="SFPTWO_IMAGEEDIT ui-droppable nownsfpimgdel tagsimg_1 ui-sortable ui-draggable textimgSFPdrag"><img id="images1" src="//test.scampaigns.com/user_template/377550fb2678a1f38-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;">
<div class="textme" style="display: inline;"></div><div aria-disabled="true" id="dragfirst" class="SFPTWO_TEXTEDIT getdragit dragSFPfirst ui-draggable tags_1 texttagdelete dropped" style="position: absolute; z-index: 999; left: -23px; top: 5px;"><div id="nowdrag" class="explicit_edit nowdrag SFPTWO_TAGEDIT tag_1 tagdelete editme bydelete justifyme" <p="" contenteditable="false"><font style="font-size: 15px;">Publish your photocontest template on Facebook and web.<br>Have fun!</font><p></p></div><div><a class="imgedivdrg"></a><a class="closethisdrag deleteme"></a></div></div>
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/377550fb2678a1f38-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
