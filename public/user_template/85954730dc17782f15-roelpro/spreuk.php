...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/85954730dc17782f15-roelpro/js/style.css" />
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/85954730dc17782f15-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/85954730dc17782f15-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/85954730dc17782f15-roelpro/js/app.js"></!--SFPScript> 
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/85954730dc17782f15-roelpro/712.GIF" /> 
        </div> SFPhide-->
