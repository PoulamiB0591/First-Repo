...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/favicon.ico">
        ...
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/css/normalize.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/css/reset.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/css/main.css">
        <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></SFPScript-->
        
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
    ...
    <body>
        ...
        <section class="main_step4">
            <div class="container">
                        <header>
                            <div class="SFPTWO_IMAGEEDIT img_section"><a title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/logo.png" alt="" /></a></div>
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/bar1.png" alt="" />
                                    <span id="s1">€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/bar2.png" alt="" />
                                    <span id="s2">€100.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/bar3.png" alt="" />
                                    <span id="s3">€250.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/bar4.png" alt="" />
                                    <span id="s4">€500.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/bar5.png" alt="" />
                                    <span id="s5">€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/icon5.png" alt="" />
                                     
                                    <span id="s6">€2.500.000</span>
                                    <label class="label_radio"><input type="radio" value="3" name="indexusapp" /></label>
                                </li>
                            </ul>
                            <a class="button_btn" style="cursor: pointer;" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/img/icon3.png" alt="" /></a>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6954a8cdcd27d4d6-indexus/js/plugins.js"></SFPScript-->
