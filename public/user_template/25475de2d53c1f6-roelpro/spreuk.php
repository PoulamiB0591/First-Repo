...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/js/style.css" />
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/js/app.js"></!--SFPScript> 
          ...
          <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                      ...
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/25475de2d53c1f6-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
