...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/94954e704f41e1ca5-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/94954e704f41e1ca5-Optinapp--mod-template/css/jui.checkboxes.css">
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/94954e704f41e1ca5-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<div class="form-container jui-checkboxes-container" id="checkboxesInit2">
        ...
        <div class="textme"></div><li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_2 texttagdelete"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="pid_" class="opt explicit_edit SFPTWO_TAGEDIT tag_2 tagdelete" contenteditable="false"><font>EmaiL address</font></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><input name="email" type="email">
        ...
        <div class="textme"></div><li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_3 texttagdelete"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt explicit_edit SFPTWO_TAGEDIT tag_3 tagdelete" contenteditable="false"><font>What kind of campaign are you Looking for? </font>
        ...
        <div class="textme"></div><li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_4 texttagdelete spaceedit"><div id="diveditme" class="labeledit"><p style="font-size: 19px;" id="pid_formmsg" class="opt explicit_edit SFPTWO_TAGEDIT tag_7 tagdelete justifyme" contenteditable="false"><font>Your message</font></p><div><textarea id="editmetext" name="textarea_edit1" class="textareaforform SFPTEXTAREA"></textarea></div><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><div id="ullidrag" class="ullidrag" style="cursor: move; display: none;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div style="display: none;" class="setting-2 prevnext"><a title="delete" class="delete" href="javascript:void(0)"></a><input id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div><div id="ullidrag" class="ullidrag" style="cursor: move; display: none;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div class="setting-2 prevnext" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a><input id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></li>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweDA1cU1BcAAlSAAAIVARaBFNJdkdNDwhVSUEYFAgJABRDXAsWWFhFUBYMCABcTxcWDkQ=","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script>



<div class="spacediv" style="display: block;"><span>Vertical Slider:</span> <b><span class="lblVertical">50</span></b><br><br><div class="sliderVer ui-slider ui-slider-vertical ui-widget ui-widget-content ui-corner-all" style="height:200px;"><a style="bottom: 25%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
</div>
