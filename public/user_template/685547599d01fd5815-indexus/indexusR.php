                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                            ...
                            <a class="button_btn button_btn3" style="cursor: pointer;" title="Volgende stap"><span>Ja, ik wil de uitgebreide analyse opvragen</span> <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/icon3.png" alt="" /></div></a>
                            <a class="vorige_stap" style="cursor: pointer;" title="Vorige stap">Vorige stap</a>
                            <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/icon7.png" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
