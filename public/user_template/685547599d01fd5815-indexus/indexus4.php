        ...
        <section class="main_step4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <header>
                            <a style="cursor: pointer;" title="Indexus" class="logo"><div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/logo.png" alt="" /></div></a>
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/defensief_img.png" alt="" /></div>
                            	...
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/neutraal_img.png" alt="" /></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="4" /></label>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">Neutraal</span></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/685547599d01fd5815-indexus/img/offensief_img.png" alt="" /></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="4" /></label>
