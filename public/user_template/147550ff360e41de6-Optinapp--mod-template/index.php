...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/147550ff360e41de6-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/147550ff360e41de6-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="textme" style="display:inline;"></div><div style="overflow: visible;" class="SFPTWO_IMAGEEDIT textimgSFPdrag ui-droppable nownsfpimgdel tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/147550ff360e41de6-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;">
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/147550ff360e41de6-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;">
 <li id="lilabelme" style="position: relative; top: -4px; left: 0px; display: none;"><a style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="email" id="email"><span>Email</span><img src="/formbuild/email_icon.png" alt=""></a></li>
   
</ul>
<form id="" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">

 <img src="/img/divider.png" id="imgdrag" style="position: relative; top: -4px; display: none;">
 <img src="/img/divider.png" id="imgdragable" style="display: none;">
...
<li id="trigme" style="display: none;">
  ...
  <div id="ullidrag" class="ullidrag" style="display:none; cursor:move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div class="setting-2 prevnext" style="display:none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a><input id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></li>
	<div class="textme" style="display: inline;"></div><li style="position: relative; z-index: 1; left: 0px; top: 0px;" class="dottedLi SFPTWO_TEXTEDIT tags_3 texttagdelete"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="pid_" class="opt explicit_edit SFPTWO_TAGEDIT tag_3 tagdelete editme bydelete justifyme" contenteditable="false"><font>Email address</font></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div><input name="email" type="email">
