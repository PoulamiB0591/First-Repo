...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/801546ee1cc8dac711-roelpro/js/style.css">
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/801546ee1cc8dac711-roelpro/712.GIF" /> 
        </div> SFPhide-->
    ...
    <div class="container-fluid top">
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Voer je sptetereuk in ...</h2><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
