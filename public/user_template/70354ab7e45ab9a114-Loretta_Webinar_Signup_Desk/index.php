...
<!--SFPPAGE-->
  ...
  <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css">
   <link rel="stylesheet" href="//test.scampaigns.com/user_template/70354ab7e45ab9a114-Loretta_Webinar_Signup_Desk/css/style.css">
...
<div class="header">
  <div class="container">
    ...
    <img src="//test.scampaigns.com/user_template/70354ab7e45ab9a114-Loretta_Webinar_Signup_Desk/images/6sr76z-logo.png" class="company-logo"></div>
  </div>
</div>
<div class="main">
  <div class="container">
        ...
        <div class="SFP_BOOT-sm-6 SFP_BOOT-md-4 SFP_BOOT-sm-offset-1 tool-tip">
          ...
          <h3 class="textedit SFPTWO_TAGEDIT edit tag_4">Register Today</h3></div>
             <div style="overflow: hidden; width: 100%;">
              ...
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_406" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_323" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_6 element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_163" class="opt SFPTWO_TAGEDIT getme tag_6"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_876" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_7 element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-primary btn-block" name="submit" value="Save My Spot" type="submit"></div></li>
               <li class="dottedLi SFPTWO_TEXTEDIT tags_8 element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_455" class="opt SFPTWO_TAGEDIT note tag_7"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
            ...
            <div class="SFP_BOOT-sm-10 SFP_BOOT-sm-offset-1 SFP_BOOT-md-8 SFP_BOOT-md-offset-2">
              <div class="SFP_ROW">
                ...
                <div class="SFPTWO_IMAGEEDIT tagsimg_2">
                  <img src="//test.scampaigns.com/user_template/70354ab7e45ab9a114-Loretta_Webinar_Signup_Desk/images/1u1mdnh-bbb.png">
                  </div>
                </div>
                <div class="SFP_BOOT-sm-4">
                <div class="SFPTWO_IMAGEEDIT tagsimg_3">
                  <img src="//test.scampaigns.com/user_template/70354ab7e45ab9a114-Loretta_Webinar_Signup_Desk/images/1s97s6s-bizrate.png">
                  </div>
                </div>
                <div class="SFP_BOOT-sm-4">
                <div class="SFPTWO_IMAGEEDIT tagsimg_4">
                  <img src="//test.scampaigns.com/user_template/70354ab7e45ab9a114-Loretta_Webinar_Signup_Desk/images/1kbjx83-truste.png">
                  </div>
                </div>
              </div>
            </div>
