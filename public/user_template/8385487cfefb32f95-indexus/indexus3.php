            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/bar1.png" alt="">
                                    <span id="s1">50.0</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/bar2.png" alt="">
                                    <span id="s2">100.</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/bar3.png" alt="">
                                    <span id="s3">250.00</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/bar4.png" alt="">
                                    <span id="s4">500.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/bar5.png" alt="">
                                    <span id="s5">1004534</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/8385487cfefb32f95-indexus/img/icon5.png" alt="">
                                     
                                    <span id="s6">20000.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            </ul>
                        ...
                        <input id="v4" value="354" type="hidden">
                        <input id="v5" value="354" type="hidden">
                        <input id="v6" value="35" type="hidden">
                        </div>
            </div>
		</section>
