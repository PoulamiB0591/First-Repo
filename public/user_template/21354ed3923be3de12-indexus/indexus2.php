        ...
        <section class="main_step3">
            <div class="container">
                        ...
                        <div class="main_content">
                           ...
                           <a class="button_btn" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/21354ed3923be3de12-indexus/img/icon3.png" alt="" /></a>
