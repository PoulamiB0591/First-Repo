...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/favicon.ico">
        ...
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/css/normalize.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/css/reset.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/css/main.css">
    ...
    {    
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                <label id="R1" class="label_radio1"><input id="r1" name="investorR" value="1" type="radio"> <span id="es1"> Pensi</span></label>
                                <label id="R2" class="label_radio1"><input id="r2" name="investorR" value="2" type="radio"> <span id="es2">Groei van ve</span></label>
                                <label id="R3" class="label_radio1"><input id="r3" name="investorR" value="3" type="radio"> <span id="es3">Behoud van vermo</span></label>
                           ...
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">&nbsp;do<span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                           
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/icon4.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="4325487e0dce6b277-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                            <fieldset class="radios">
                                <label id="R11" class="label_radio"><input id="r1" name="investorR1" value="1" type="radio"> <span id="s1"> Pensi</span></label>
                                <label id="R12" class="label_radio"><input id="r2" name="investorR1" value="2" type="radio"> <span id="s2">Groei van ve</span></label>
                                <label id="R13" class="label_radio"><input id="r3" name="investorR1" value="3" type="radio"> <span id="s3">Behoud van vermo</span></label>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/icon3.png" alt=""></a>
                        <div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                        <div>
                        <input id="v1" value="" type="hidden">
                        <input id="v2" value="" type="hidden">
                        <input id="v3" value="" type="hidden">
                        <input id="v4" value="" type="hidden">
                        <input id="v5" value="" type="hidden">
                        </div>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/js/plugins.js"></SFPScript-->
