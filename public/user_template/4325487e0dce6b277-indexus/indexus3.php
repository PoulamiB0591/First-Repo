            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/bar1.png" alt="">
                                    <span id="s1">50.</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/bar2.png" alt="">
                                    <span id="s2">100</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/bar3.png" alt="">
                                    <span id="s3">250</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/bar4.png" alt="">
                                    <span id="s4">500</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/bar5.png" alt="">
                                    <span id="s5">10000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/icon5.png" alt="">
