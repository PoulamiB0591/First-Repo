            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                ...
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s3">10 jahhfgh</span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s4">5 j</span></label>
                            </fieldset>
                            <div class="jaar" id="jaarindexus2">
                            	<span id="es1">20</span>
                            	<span id="es2">15 jaar</span>
                            	<span id="es3">10 jahhfgh</span>
                            	<span id="es4">5 j</span>
                            </div>
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/4325487e0dce6b277-indexus/img/icon3.png" alt=""></a>
