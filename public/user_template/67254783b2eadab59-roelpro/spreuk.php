...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/67254783b2eadab59-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/67254783b2eadab59-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/67254783b2eadab59-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/67254783b2eadab59-roelpro/js/app.js"></!--SFPScript> 
          ...
          <div class="container-fluid top">
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 style="display: block;" class="SFPTWO_TAGEDIT explicit_edit tag_4" contenteditable="false">Voer je sdadasdspreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="SFPTWO_TEXTEDIT tags_2"><h3 class="SFPTWO_TAGEDIT explicit_edit tag_5" contenteditable="false">Wat is jouw lijfasdasdasdasdspreuk als professional?</h3><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                </div>
                </div><!-- end of container -->
