   ...
   $.ajax({
        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <p class="SFPTWO_TAGEDIT explicit_edit tag_3" contenteditable="false"><br></p>
                            
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/7115486f16eb09a77-indexus/img/icon7.png" alt="" class="img_response"><div class="setting-2" style="display: block;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="7115486f16eb09a77-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
        ...
        <footer class="inside_footer">
            <div class="container">
                    	...
                    	<a href="http://www.indexus.nl/" target="_blank" class="web_link disabled"><span class="SFPTWO_TAGEDIT explicit_edit tag_4" contenteditable="false">www.indexus.nl</span><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></a>
