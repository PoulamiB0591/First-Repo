...
<link rel="stylesheet" href="/editcss/jquery.timepicker.css">
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/317550686f1a9d677-Loretta_Webinar_Signup_Desk/css/style.css">
...
<div class="header">
  <div class="container">
    ...
    <img src="//test.scampaigns.com/user_template/317550686f1a9d677-Loretta_Webinar_Signup_Desk/images/6sr76z-logo.png" class="company-logo"></div>
  </div>
</div>
<div class="main">
  <div class="container">
        ...
        <div class="col-sm-6 col-md-4 col-sm-offset-1 tool-tip">
          ...
          <h3 class="textedit SFPTWO_TAGEDIT edit tag_4 tagdelete">Register Today</h3></div>
             <div style="overflow: hidden; width: 100%;">
              ...
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_740" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_862" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_6 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_213" class="opt SFPTWO_TAGEDIT getme tag_6 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_295" required="required" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_7 texttagdelete element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-primary btn-block" name="submit" value="Save My Spot" type="submit"></div></li>
               <li class="dottedLi SFPTWO_TEXTEDIT tags_8 texttagdelete element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_446" class="opt SFPTWO_TAGEDIT note tag_7 tagdelete"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
            ...
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
              <div class="row">
                ...
                <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_2">
                  <img src="//test.scampaigns.com/user_template/317550686f1a9d677-Loretta_Webinar_Signup_Desk/images/1u1mdnh-bbb.png">
                  </div>
                </div>
                <div class="col-sm-4">
                <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_3">
                  <img src="//test.scampaigns.com/user_template/317550686f1a9d677-Loretta_Webinar_Signup_Desk/images/1s97s6s-bizrate.png">
                  </div>
                </div>
                <div class="col-sm-4">
                <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_4">
                  <img src="//test.scampaigns.com/user_template/317550686f1a9d677-Loretta_Webinar_Signup_Desk/images/1kbjx83-truste.png">
                  </div>
                </div>
              </div>
            </div>
