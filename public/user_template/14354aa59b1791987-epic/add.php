    ...
    (function(d, s, id) {
      ...
      window.fbAsyncInit = function (){
        ...
        <div class="main_wrap">
            ...
            <a onclick="fInvMulti()" style="cursor: pointer;" class="app"><div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/14354aa59b1791987-epic/img/facebook_app.png" alt="" /></div></a>
