...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <div class="main_wrap">
            ...
            <div class="SFPTWO_IMAGEEDIT tagsimg_1"><span class="img"><img id="images1" src="//test.scampaigns.com/user_template/831547d9d782e0788-epic/img/crying_img.png" alt=""></span><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="831547d9d782e0788-epic" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div><!-- end of img -->
