...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/878550a77da3abc515-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/878550a77da3abc515-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div style="background-image: url(&quot;http://test.scampaigns.com/library/797ee7838e6a3131d98213e14b6b3b89.jpg&quot;); background-position: left top; background-repeat: repeat;" class="details-n-winn-wrapper SFPTWO_BACKGROUND">
<div class="textme" style="display:inline;"></div><div id="editable" class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_1 imgEdit1 imgEdit2 imgEdit3 imgEdit5"><div style="width: 785px; height: auto;" id="wrapimgdiv"><img class="" id="images1" src="http://test.scampaigns.com/library/797ee7838e6a3131d98213e14b6b3b89.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/878550a77da3abc515-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
<div class="textme" style="display:inline;"></div><div class="tool-tip SFPTWO_TEXTEDIT tags_1 texttagdelete"><h2 class="textedit SFPTWO_TAGEDIT edit tag_1 tagdelete">Fill in your details and win! </h2></div>
...
<form name="form_1516993" id="" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2 texttagdelete element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="pid_" class="opt SFPTWO_TAGEDIT tag_2 tagdelete editme bydelete"><font>Email address</font></p></div><input name="textBoxEmailelement1" type="email">
    
    </li>
    

	<div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 texttagdelete element2"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt SFPTWO_TAGEDIT tag_3 tagdelete"><font>What kind of campaign are you Looking for? </font>
	 ...
	 <div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element3"><div id="diveditme" class="labeledit"><p style="font-size: 19px;" id="pid_formmsg" class="opt SFPTWO_TAGEDIT tag_7 tagdelete"><font>Your message</font></p><div><textarea id="editmetext" name="textareaelement3" class="textareaforform SFPTEXTAREA"></textarea></div></div></li>
	<div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element4"><div id="getbtnme" class="submitdrag"><input class="SFPsubmit" name="submit" value="Send" type="submit"></div></li>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweDQ5dU1EJVg5RAlUKUFdaUFdRFHhJEg9aWEFFFEgLC10aTQMLRFVQQVxKDwpdUkFIFlxJ","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-593.min.js"}</script>