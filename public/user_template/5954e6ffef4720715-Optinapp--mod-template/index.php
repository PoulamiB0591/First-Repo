...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/5954e6ffef4720715-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/5954e6ffef4720715-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="form-container jui-checkboxes-container" id="checkboxesInit2">
        ...
        <div class="textme"></div><div class="textme"></div><li class="dottedLi SFPTWO_TEXTEDIT tags_2 texttagdelete"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="pid_" class="opt explicit_edit SFPTWO_TAGEDIT tag_2 tagdelete justifyme" contenteditable="false"><font>EmaiL address</font></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><input name="email" type="email">
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweAABQUgEPUV8DAAAOAwUOVFNJdkdNDwhVSUEYFAgJABRDXAsWWFhFUBYMCABcTxcWDkQ=","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script>



<div class="spacediv" style="display: block;"><span>Vertical Slider:</span> <b><span class="lblVertical">50</span></b><br><br><div class="sliderVer ui-slider ui-slider-vertical ui-widget ui-widget-content ui-corner-all" style="height:200px;"><a style="bottom: 25%;" class="ui-slider-handle ui-state-default ui-corner-all disabled" href="#"></a></div>
</div>
...
<div class="spacediv" style="display:none;"><span>Vertical Slider:</span> <b><span class="lblVertical">50</span></b><br><br><div class="sliderVer ui-slider ui-slider-vertical ui-widget ui-widget-content ui-corner-all" style="height:200px;"><a style="bottom: 25%;" class="ui-slider-handle ui-state-default ui-corner-all" href="#"></a></div>
</div>
