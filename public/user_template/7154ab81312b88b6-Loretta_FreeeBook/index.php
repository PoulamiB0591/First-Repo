...
<!--SFPPAGE-->
 ...
 <link rel="stylesheet" href="/editcss/jquery-ui.css">
  ...
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/css/style.css">
...
<div class="header">
  <div class="container">
    ...
    <img src="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/images/1b2ayl6-fake-logo.png" class="company-logo"></div>
  </div>
</div>
<div class="main">
  <div class="container">
      ...
      <div class="SFP_BOOT-md-7">
        <div class="SFP_ROW">
          <div class="SFP_BOOT-sm-10 SFP_BOOT-md-11 SFP_BOOT-sm-offset-1">
            ...
            <img src="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/images/ebook.png" class="ebook img-responsive">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="SFP_ROW">
          <div class="SFP_BOOT-sm-10 SFP_BOOT-sm-offset-1">
            ...
            <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul style="" class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_428" class="opt SFPTWO_TAGEDIT getme tag_4"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_233" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_184" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_938" class="SFPEMAIL form-control" type="email"></li>  
      ...
      <div class="SFP_BOOT-sm-10 SFP_BOOT-sm-offset-1">
        ...
        <div class="SFP_ROW feature-list">
          <div class="SFP_BOOT-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/images/1s37lxi-icon-camera.png"></div>
          ...
          <div class="SFP_BOOT-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/images/p04nuf-icon-pencil.png"></div>
          ...
          <div class="SFP_BOOT-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/7154ab81312b88b6-Loretta_FreeeBook/images/1enkdxx-icon-handshake.png"></div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweAghQUgVbDwhVVwZbCQ1bU0soVkVcEhJVZndHXAADJlZYUkkPWl1UTRcVDhQ=","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script></body>
</html>
