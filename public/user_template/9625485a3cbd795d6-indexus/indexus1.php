...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <header>
                           <div class="SFPTWO_IMAGEEDIT"><a style="cursor: pointer;" title="Indexus" class="logo disabled"><img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/logo.png" alt=""></a></div>
                        ...
                        <div class="main_content">
                           ...
                           <div class="SFPTWO_TEXTEDIT"><h2 class="heading SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Met welk doel <span>belegt u?</span></h2></div>
                            ...
                            <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/icon4.png" alt=""></div>
                            <fieldset class="radios">
                             ...
                             <div class="SFPTWO_TEXTEDIT"><a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/icon3.png" alt=""></a></div>
                        </div>
                    </div>
		</section>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/js/plugins.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/js/main.js"></SFPScript-->
