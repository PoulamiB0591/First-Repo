...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" type="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/image/x-icon" href="img/favicon.ico">
        ...
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/css/bootstrap.min.css">
...
?>      
        ...
        <section class="main_step4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <header>
                            <a style="cursor: pointer;"title="Indexus" class="logo"><div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/logo.png" alt="" /></div></a>
                        ...
                        <div class="main_content">
                            ...
                            <a class="button_btn button_btn3" style="cursor: pointer;" title="Volgende stap"><span>Ja, ik wil de uitgebreide analyse opvragen</span> <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/icon3.png" alt="" /></div></a>
                            <a class="vorige_stap" style="cursor: pointer;" title="Vorige stap">Vorige stap</a>
                            <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/img/icon7.png" alt="" /></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--SFPScript type="text/javascript">window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/9625485a3cbd795d6-indexus/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
