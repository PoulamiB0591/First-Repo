...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/37254db60c64353f12-Optinapp-mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/37254db60c64353f12-Optinapp-mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/37254db60c64353f12-Optinapp-mod-template/img/top-img.jpg" alt=""><div id="nowdrag" class="explicit_edit nowdrag bydelete editme" style="position: absolute; margin: 0px 0px 8px 200px; height: 100px; width: 200px; top: 30px; z-index: 9999; left: 84.5px;" contenteditable="false">h<img src="http://test.scampaigns.com/img/drag_icon.png" class="imgedivdrg" contenteditable="false">ii<img src="http://test.scampaigns.com/img/drag_icon.png" class="imgedivdrg" contenteditable="false">hihiih<img src="/img/drag_icon.png" class="imgedivdrg" contenteditable="false"></div><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><a title="imgcaption" class="imgcaption" href="javascript:void(0)"></a><input value="undefined" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/37254db60c64353f12-Optinapp-mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
