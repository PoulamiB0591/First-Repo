<img src="https://test.scampaigns.com/img/divider.png" id="imgdragable" style="position: absolute; top: 626px; display: none;">
...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/17547c664783c1b13-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/17547c664783c1b13-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div style="display: none;" class="SFPTWO_IMAGEEDIT tagsimg_1 rand_100"><img id="images1" src="//test.scampaigns.com/user_template/17547c664783c1b13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div style="height: 292px; width: 763px;" id="editable" class="SFPTWO_IMAGEEDIT tagsimg_2 imgEdit2 ui-resizable"><div class="ui-draggable" id="draggable0" style="z-index: 0; position: absolute; left: -745px; top: -424px;"><div><div class="ui-resizable" id="resizable0" style="z-index: 0; height: 467px; width: 748.735px; top: 432px; left: 755px;"><img class="layeredImage" id="images0" src="http://test.scampaigns.com/library/81e4ad034d70ea9429091232cf27dcdb.jpg" style="height:100%; width:100%; z-index:0;"></div></div></div></div>         
...
<form name="form_136372" id="" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">

 <img src="https://test.scampaigns.com/img/divider.png" id="imgdrag" style="position: relative; top: 540px; display: none;">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2 element1"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;color:#15ace7" id="pid_" class="opt SFPTWO_TAGEDIT tag_2"><font color="#15ace7">EmaiL address</font></p></div><input name="email" type="email">
    	...
    	<li class="dottedLi SFPTWO_TEXTEDIT tags_5"><div id="labeledit" class="labeledit addmechk checkboxdrag"><p id="pid_143" class="opt SFPTWO_TAGEDIT tag_8">Wat is jouw favoriete kleur? <br></p></div><div class="checksboxes p_scents chkboxaddnow editmyopt adding" id="checksboxes_452"><div id="chkclone"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-row452"><span class="checkboxWrapper"><input value="1" name="name" type="checkbox"> </span> <p class="opt explicit_edit" id="1" contenteditable="false">Blauw<br></p> </div><div class="jui-checkbox-row"> <span class="checkboxWrapper"><input value="2" name="name" type="checkbox"></span> <p class="opt explicit_edit" id="2" contenteditable="false"><font color="#15ace7">option2</font></p> </div><div class="jui-checkbox-row"><span class="checkboxWrapper"><input value="3" name="name" type="checkbox"></span><p class="opt explicit_edit" id="3" contenteditable="false"><font color="#15ace7">option3</font></p></div></div><p id="mepp" class="pchkadd"></p></div></li>
    </li>
