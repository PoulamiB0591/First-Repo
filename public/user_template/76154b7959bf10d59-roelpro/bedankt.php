...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/76154b7959bf10d59-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/76154b7959bf10d59-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->   
...
<style>
    ...
    <div class="main_wrapper">
         ...
         <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/76154b7959bf10d59-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                      ...
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/76154b7959bf10d59-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/76154b7959bf10d59-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
