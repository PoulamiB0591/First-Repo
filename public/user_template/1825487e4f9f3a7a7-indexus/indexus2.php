            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s1">20 ja</span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s2">15 jaar </span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s3">10ar</span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s4">5 </span></label>
                            </fieldset>
                            <div class="jaar" id="jaarindexus2">
                            	<span id="es1">20 ja</span>
                            	<span id="es2">15 jaar </span>
                            	<span id="es3">10ar</span>
                            	<span id="es4">5 </span>
                            </div>
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/icon3.png" alt=""></a>
