...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/favicon.ico">
        ...
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/css/normalize.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/css/reset.css">
        <link type="text/css" rel="stylesheet" href="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/css/main.css">
    ...
    {    
            ...
            <div class="container">
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                ...
                                <label id="R2" class="label_radio1"><input id="r2" name="investorR" value="2" type="radio"> <span id="es2">gfhen </span></label>
                                <label id="R3" class="label_radio1"><input id="r3" name="investorR" value="3" type="radio"> <span id="es3">Beghn vermogen </span></label>
                                <label id="R4" class="label_radio1"><input id="r4" name="investorR" value="4" type="radio"> <span id="es4">hssing </span></label>
                                <label id="R5" class="label_radio1"><input id="r5" name="investorR" value="5" type="radio"> <span id="es5">ghfor </span></label>
                            </div>
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                           
                            <div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/icon4.png" alt=""><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="1825487e4f9f3a7a7-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="1825487e4f9f3a7a7-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="1825487e4f9f3a7a7-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                            <fieldset class="radios">
                                <label id="R11" class="label_radio"><input id="r1" name="investorR1" value="1" type="radio"> <span id="s1"> Pensioen </span></label>
                                <label id="R12" class="label_radio"><input id="r2" name="investorR1" value="2" type="radio"> <span id="s2">gfhen </span></label>
                                <label id="R13" class="label_radio"><input id="r3" name="investorR1" value="3" type="radio"> <span id="s3">Beghn vermogen </span></label>
                                <label id="R14" class="label_radio"><input id="r4" name="investorR1" value="4" type="radio"> <span id="s4">hssing </span></label>
                               <label id="R15" class="label_radio"><input id="r5" name="investorR1" value="5" type="radio"> <span id="s5">ghfor </span></label>
                                <input id="val" name="hiddeninputname" value="" type="hidden">
                            </fieldset>
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/icon3.png" alt=""></a>
                        <div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                        <div>
                        <input id="v1" value="234" type="hidden">
                        <input id="v2" value="324" type="hidden">
                        <input id="v3" value="534" type="hidden">
                        <input id="v4" value="43" type="hidden">
                        <input id="v5" value="3453" type="hidden">
                        </div>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/js/bootstrap.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/js/plugins.js"></SFPScript-->
