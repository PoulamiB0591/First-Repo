            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/bar1.png" alt="">
                                    <span id="s1">€50.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/bar2.png" alt="">
                                    <span id="s2">€100.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/bar3.png" alt="">
                                    <span id="s3">€250.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/bar4.png" alt="">
                                    <span id="s4">€500.000</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/bar5.png" alt="">
                                    <span id="s5">€50.</span>
                                    <label class="label_radio"><input value="3" name="indexusapp" type="radio"></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/1825487e4f9f3a7a7-indexus/img/icon5.png" alt="">
                        ...
                        <div>
                        <input id="v1" value="1345" type="hidden">
                        <input id="v2" value="2345" type="hidden">
                        <input id="v3" value="345" type="hidden">
                        <input id="v4" value="443" type="hidden">
                        <input id="v5" value="534" type="hidden">
                        <input id="v6" value="6345" type="hidden">
                        </div>
            </div>
		</section>
