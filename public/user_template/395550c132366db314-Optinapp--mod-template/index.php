...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/395550c132366db314-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/395550c132366db314-Optinapp--mod-template/css/jui.checkboxes.css">
...
<li id="trigme" style="display: none;">
  ...
  <div id="ullidrag" class="ullidrag" style="display:none; cursor:move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div class="setting-2 prevnext" style="display:none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a><input id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></li>
	<div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2 texttagdelete"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;" id="pid_" class="opt explicit_edit SFPTWO_TAGEDIT tag_2 tagdelete" contenteditable="false"><font>Ema<font color="#d49d9d">il address</font></font></p><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div><input name="email" type="email">
	...
	<div class="textme" style="display:inline;"></div><li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3 texttagdelete"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;" id="pid_form" class="opt explicit_edit SFPTWO_TAGEDIT tag_3 tagdelete justifyme" contenteditable="false"><font>What kind of campaign are you Looking for? </font>
