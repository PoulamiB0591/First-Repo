...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
    ...
    <link rel="shortcut icon" type="//test.scampaigns.com/user_template/6254c230e4bb6835-epic/image/x-icon" href="img/favicon.ico">
    ...
    (function(d, s, id) {
      ...
      window.fbAsyncInit = function (){
        ...
        <div class="main_wrap SFPTWO_BACKGROUND">
            ...
            <a onclick="fInvMulti()" style="cursor: pointer;" class="app"><div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/6254c230e4bb6835-epic/img/facebook_app.png" alt="" /></div></a>
