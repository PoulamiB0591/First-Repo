                ...
                <div class="row">
                    <div class="col-lg-12">
                        <header>
                            ...
                            <p class="info">Bel: 020 - 697 20 66<br>Mail: <a href="SFPURLLINK/mailto:contact@indexus.nl" class="">contact@indexus.nl</a></p>
                        </header>
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	...
                            	<li class="col-lg-2">
                                    ...
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT">€500.000</span></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="3"></label>
                                </li>
                            	<li class="col-lg-2">
