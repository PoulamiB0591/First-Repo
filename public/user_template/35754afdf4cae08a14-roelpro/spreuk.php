...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/35754afdf4cae08a14-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/35754afdf4cae08a14-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/35754afdf4cae08a14-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/35754afdf4cae08a14-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/35754afdf4cae08a14-roelpro/js/app.js"></SFPScript-->
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_2 texttagdelete"><h3 class="SFPTWO_TAGEDIT explicit_edit tag_5 tagdelete" contenteditable="false">Wat is jouw lijfspreuk als professional?</h3><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div>
                </div>
                </div><!-- end of container -->
