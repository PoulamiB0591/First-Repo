...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/192546c6ecf20dec11-indexus/http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></SFPScript-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                            ...
                            <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/192546c6ecf20dec11-indexus/img/icon1.png" alt="" class="img-responsive"><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="192546c6ecf20dec11-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
                            <div class="jaar">
                            	<span>20 jaar</span>
                            	<span>15 jaar</span>
                            	<span>10 jaar</span>
