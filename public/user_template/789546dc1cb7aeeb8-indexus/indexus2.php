...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <!--SFPScript type="text/javascript">window.jQuery || document.write('<script src="//test.scampaigns.com/user_template/789546dc1cb7aeeb8-indexus/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
