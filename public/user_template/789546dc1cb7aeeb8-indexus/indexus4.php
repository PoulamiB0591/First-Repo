...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/789546dc1cb7aeeb8-indexus/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/789546dc1cb7aeeb8-indexus/img/defensief_img.png" alt="" /></div>
                            	...
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/789546dc1cb7aeeb8-indexus/img/neutraal_img.png" alt="" /></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="4" /></label>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">Neutraal</span></div>
                                </li>
                            	<li class="col-lg-4">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/789546dc1cb7aeeb8-indexus/img/offensief_img.png" alt="" /></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="4" /></label>
