        ...
        <section class="main_step3">
            <div class="container">
                        ...
                        <div class="main_content">
                           ...
                           <a class="button_btn" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/914550683b1ef3a115-indexus/img/icon3.png" alt="" /></a>
