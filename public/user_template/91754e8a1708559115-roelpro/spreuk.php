...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/91754e8a1708559115-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/91754e8a1708559115-roelpro/js/style.css">
        ...
        <!--SFPScript src="//test.scampaigns.com/user_template/91754e8a1708559115-roelpro/js/app.js"></SFPScript-->
    ...
    <div class="main_wrapper SFPTWO_BACKGROUND">
          <div class="container-fluid top"> 
                ...
                <div class="textme"></div><div class="SFPTWO_IMAGEEDIT expl tagsimg_1">
                	<img id="images1" src="//test.scampaigns.com/user_template/91754e8a1708559115-roelpro/img/logo.jpg" alt=""><div id="dragfirst" class="SFPTWO_TEXTEDIT tags_4 texttagdelete" style="position:absolute; padding:0px;  margin-bottom:0px;  margin:0px;  margin-top:0px; margin-left:0px; margin-right:0px;  top: 0; z-index:999;"><div id="nowdrag" class="explicit_edit nowdrag SFPTWO_TAGEDIT tag_7 tagdelete" contenteditable="false">Text</div><div><a class="imgedivdrg"></a><a class="closethisdrag deleteme"></a></div></div><div id="dragfirst" class="SFPTWO_TEXTEDIT tags_3 texttagdelete randtxt_970" style="position: absolute; padding: 0px; margin: 0px; top: 0px; z-index: 999; display: none;"><div id="nowdrag" class="explicit_edit nowdrag SFPTWO_TAGEDIT tag_6 tagdelete" contenteditable="false">Text</div><div><a class="imgedivdrg"></a><a class="closethisdrag deleteme"></a></div></div><!-- end of logo -->
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="SFP_BOOT-lg-12">
                    <div class="textme"></div><div class="SFPTWO_TEXTEDIT tags_1 texttagdelete"><h2 class="SFPTWO_TAGEDIT explicit_edit  tag_4 tagdelete justifyme bydelete editme" contenteditable="false">Voer je spreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="textme"></div><div class="SFPTWO_TEXTEDIT tags_2 texttagdelete"><h3 class="SFPTWO_TAGEDIT explicit_edit tag_5 tagdelete" contenteditable="false">Wat is jouw lijfspreuk als professional?</h3><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                </div>
                </div><!-- end of container -->
