...
<link rel="stylesheet" href="/editcss/jquery.timepicker.css">
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/30155018ff6274a35-Loretta_FreeReport/css/style.css">
...
<div class="header">
  ...
  <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_1">
    <img src="//test.scampaigns.com/user_template/30155018ff6274a35-Loretta_FreeReport/images/1b2ayl6-fake-logo.png" class="company-logo">
    </div>
  </div>
</div>
<div class="main">
      ...
      <div class="col-md-7">
        <div class="row">
          <div class="col-sm-10 col-md-11 col-sm-offset-1">
            ...
            <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_2"><img src="//test.scampaigns.com/user_template/30155018ff6274a35-Loretta_FreeReport/images/1pp8kkl-report.png" class="report-img img-responsive"></div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul style="" class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_569" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_635" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_649" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_749" required="required" class="SFPEMAIL form-control" type="email"></li>  
          ...
          <div class="col-xs-10 col-xs-offset-1">
            ...
            <div class="bullet-points">
              ...
              <div class="row bullet-point">
                <div class="col-sm-1">
                  <img src="//test.scampaigns.com/user_template/30155018ff6274a35-Loretta_FreeReport/images/13813sv-check.png">
                </div>
