...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]--><head>
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/89754d21c9684c6b8-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/89754d21c9684c6b8-roelpro/js/style.css" />
        ...
        <!--SFPScript src="//test.scampaigns.com/user_template/89754d21c9684c6b8-roelpro/js/app.js"></SFPScript-->
          ...
          <div class="container-fluid top"> 
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/89754d21c9684c6b8-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                      ...
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/89754d21c9684c6b8-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
