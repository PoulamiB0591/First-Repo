...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/98548714ca253097-indexus/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/bar1.png" alt="" />
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/bar2.png" alt="" />
                                    <span>€100.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/bar3.png" alt="" />
                                    <span>€250.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/bar4.png" alt="" />
                                    <span>€500.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/bar5.png" alt="" />
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/icon5.png" alt="" />
                                     
                                    <span>€2.500.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            </ul>
                            <a class="button_btn" style="cursor: pointer;" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/98548714ca253097-indexus/img/icon3.png" alt="" /></a>
