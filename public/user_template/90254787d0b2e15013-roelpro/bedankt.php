...
<style>
    ...
    <body style="position: inherit;">
       ...
       <!--SFPhide  <div class="overlay_div">
        ...
        <div class="main_wrapper">
         ...
         <div class="container-fluid top">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_1" contenteditable="false"><a class="disabled" href="SFP_index" title="Kies je tegel en foto" id="Kies">1) Kies je tegel egggn foto</a></li>
            ...
            <div class="main_content">
                ...
                <div class="col-lg-12">
                    <div style="display: block;" class="SFPTWO_TEXTEDIT tags_1 randtxt_758"><h2 style="display: block;" class="SFPTWO_TAGEDIT explicit_edit tag_4" contenteditable="false">Bedankt!</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/90254787d0b2e15013-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</!--SFPScript> 
