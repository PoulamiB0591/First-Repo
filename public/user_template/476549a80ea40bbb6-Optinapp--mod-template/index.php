...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/476549a80ea40bbb6-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/476549a80ea40bbb6-Optinapp--mod-template/css/jui.checkboxes.css">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_2"><div id="labeledit" class="labeledit emaildrag"><p style="font-size: 19px;width:687px;" id="pid_" class="opt explicit_edit SFPTWO_TAGEDIT tag_2" contenteditable="false"><font>EmaiL address</font></p><div class="setting-2" id="text" style=""><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><input name="email" type="email">
    <div id="ullidrag" class="ullidrag" style="cursor: move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div class="setting-2 prevnext"><a title="delete" class="delete" href="javascript:void(0)"></a><input id="hid" name="email_hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div>
    </li>
    

	<li style="" class="dottedLi SFPTWO_TEXTEDIT tags_3"><div id="diveditme" class="labeledit addmechk checkboxdrag"><p style="font-size: 19px;width:687px;" id="pid_form" class="opt explicit_edit SFPTWO_TAGEDIT tag_3" contenteditable="false"><font>What kind of campaign are you Looking for?ddfsdfsdf sdfsdfsdfsdfsdfggdgdfdfgdf</font>
