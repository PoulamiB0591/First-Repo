...
<!--SFPPAGE-->
  ...
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/37054ab7a60f351710-Loretta_Email_Course/css/style.css">
...
<div class="header">
    <div class="container">
    	<div class="SFPTWO_IMAGEEDIT tagsimg_1">
    		<img src="//test.scampaigns.com/user_template/37054ab7a60f351710-Loretta_Email_Course/images/1b2ayl6-fake-logo.png" class="company-logo">
        </div>
    </div>
</div>
<div class="main">
...
<div class="SFP_ROW main-center">
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-7 SFPTWO_IMAGEEDIT tagsimg_2">
        <img src="//test.scampaigns.com/user_template/37054ab7a60f351710-Loretta_Email_Course/images/ar0imc-email-envelope.png" class="envelope img-responsive">
    </div>
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-5">
        <div class="SFP_ROW">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3">
              ...
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_966969" id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul style="" class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_843" class="opt SFPTWO_TAGEDIT getme tag_4"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_933" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_961" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_781" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" name="submit" value="Send the eCourse" type="submit"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_85" class="opt SFPTWO_TAGEDIT note tag_6"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a class="" href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
               ...
               <!-- <[dropdown-option(class)]->"getme"/>-->
                ...
                <li class="dottedLi SFPTWO_TEXTEDIT tags_26 element5" "=""><div id="diveditme class=" labeledit="" paradrag"=""><p id="pid_172" class="opt SFPTWO_TAGEDIT getme tag_24"><font class="SFPCOLOR">Label</font></p><div><p id="editmetext" name="" class="opt explicit_edit form-control" style="border: 1px solid #eee; min-height: 30px; padding: 10px;" contenteditable="false"><font class="SFPCOLOR">Text</font></p></div></div></li><li class="dottedLi SFPTWO_TEXTEDIT tags_27 element6"><div id="labeledit" class="labeledit datedrag"><p id="pid_463" class="opt SFPTWO_TAGEDIT getme tag_25"><font class="SFPCOLOR">Label</font></p></div><input name="textboxelement6" id="datepicker1" onclick="datepick(1)" type="text"></li><li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_28 element7"><div id="labeledit" class="labeledit timedrag"><p id="pid_186" class="opt SFPTWO_TAGEDIT getme tag_26"><font class="SFPCOLOR">Label</font></p></div><input name="textboxelement7" id="timepicker1" onclick="timepick(1)" type="text"></li></ul></form></span></div>
               </div> 
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweBg5VU1BYVQ4HUARfAgAIUldUFHtWFANATVBqfAgHDVVoegkTRkpUGlALAgFBGUkOFg==","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script>