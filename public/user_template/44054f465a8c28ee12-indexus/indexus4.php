            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/44054f465a8c28ee12-indexus/img/defensief_img.png" alt="" />
                                    <label class="label_radio"><input type="radio" value="4" name="indexusapp"/></label>
                                    <span id="s1">Defensief</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/44054f465a8c28ee12-indexus/img/neutraal_img.png" alt="" />
                                    <label class="label_radio"><input type="radio" value="4" name="indexusapp"/></label>
                                    <span id="s2">Neutraal</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/44054f465a8c28ee12-indexus/img/offensief_img.png" alt="" />
                                    <label class="label_radio"><input type="radio" value="4" name="indexusapp"/></label>
