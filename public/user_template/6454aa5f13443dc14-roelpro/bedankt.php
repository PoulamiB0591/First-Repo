...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6454aa5f13443dc14-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/6454aa5f13443dc14-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->   
...
<style>
    ...
    <div class="main_wrapper">
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/6454aa5f13443dc14-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
