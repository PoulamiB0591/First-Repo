...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/4415461c8dc598e97-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/4415461c8dc598e97-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT ui-resizable" id="editable"><img id="images1" src="//test.scampaigns.com/user_template/4415461c8dc598e97-Optinapp--mod-template/img/top-img.jpg" alt=""><div class="ui-resizable-handle ui-resizable-s" style="z-index: 90;"></div><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input type="hidden" value="4415461c8dc598e97-Optinapp--mod-template" id="hid"><input type="hidden" value="0" id="imgCount"></div></div> 
...
<ul class="sortable-list ui-droppable">
	...
	<li><input name="" type="submit" value="Send" class="inputdisabled"></li>

</ul>
<div class="setting-2" style="display:none"><a title="setup" class="setup" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input type="hidden" value="4415461c8dc598e97-Optinapp--mod-template" id="hid"></div></form>[(complete.php)]
</div>
</div>