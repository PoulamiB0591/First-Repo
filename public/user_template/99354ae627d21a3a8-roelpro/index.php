        	...
        	<div class="main_navigation">
             ...
             <div class="main_content">
                ...
                <div class="SFP_BOOT-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 style="display: block;" class="SFPTWO_TAGEDIT tag_4 tagdelete bydelete">Kies een tegel ...</h2></div>
                    <div style="display: block;" class="SFPTWO_TEXTEDIT tags_2 randtxt_2 randtxt_756"><h3 class="SFPTWO_TAGEDIT tag_5 tagdelete">... en profileer jezelf als professional</h3></div>
                </div>
            ...
            <!-- end of masterslider -->
                ...
                <p class="upload_fbbt SFPTWO_TAGEDIT tag_6 tagdelete">
                	<a class="" style="cursor: pointer;" id="getprf" onclick="facebookconnect();"><span class="explicit_edit" contenteditable="false">Gebruik mijn</span><strong class="explicit_edit" contenteditable="false">PROFIELFOTO</strong></a>
                     ...
                     <form name="form_128920" class="upload_fbbt" enctype="multipart/form-data" method="post" id="target" action="run.php">
                	...
                	<p style="display: block;" class="SFPTWO_TAGEDIT tag_7 tagdelete editme bydelete"><a class="" style="cursor:pointor;"><span class="explicit_edit" contenteditable="false">Upload je eigen</span><strong class="explicit_edit" contenteditable="false">FOTO</strong></a>
                    </p>
                     </form>
                    
                     
                     <form name="form_128920" method="post" id="targetfb" action="save.php">
