...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/601550c2df7f33db9-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/601550c2df7f33db9-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="textme" style="display:inline;"></div><div style="overflow: hidden;" class="SFPTWO_IMAGEEDIT nownsfpimgdel tagsimg_1 ui-droppable textimgSFPdrag ui-sortable ui-draggable"><img id="images1" src="//test.scampaigns.com/user_template/601550c2df7f33db9-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"><div aria-disabled="true" id="dragfirst" class="SFPTWO_TEXTEDIT tags_7 texttagdelete dragSFPfirst ui-draggable" style="position: absolute; margin: 0px 0px 8px; z-index: 999; top: 140.5px; left: 373px;"><div id="nowdrag" class="explicit_edit nowdrag SFPTWO_TAGEDIT tag_9 tagdelete bydelete justifyme editme" contenteditable="false">Text</div><div><a class="imgedivdrg"></a><a class="closethisdrag deleteme"></a></div></div>
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/601550c2df7f33db9-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
