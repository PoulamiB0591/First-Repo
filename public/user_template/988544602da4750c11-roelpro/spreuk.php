...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/js/app.js"></script>
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/988544602da4750c11-roelpro/712.GIF" /> 
        </div> SFPhide-->
        ...
        <div id="target" class="img-cont" >
             ...
             <p class="info" id="mepreview"></p>
               <p class="info-new" id="mepreview2"></p>
          </div>
          </div>
                ...
                <form enctype="multipart/form-data" action="bedankt.php" id="frms" name="lijfspreuk1" method="post" class="lijfspreuk"  >
                	<input type="text" name="lijfspreuk" class="meljf" id="lijfspreuk" maxlength="75" value="Jouw lijfspreuk" onBlur="if(this.value=='') this.value='Jouw lijfspreuk';" onFocus="if(this.value=='Jouw lijfspreuk') this.value='';" />
                    <span>Maximaal 75 karakters</span>
     ...
     <input type="text" ng-model="myText" placeholder="Type text to see it shrink">
    <div class="fittext" max-font-size="100" text="myText"></div>
 
  <input type="text" id="inputme" ng-model="myText" placeholder="Type text to see it shrink">
