        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/36954870d698b6c712-indexus/img/defensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Defensief</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/36954870d698b6c712-indexus/img/neutraal_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Neutraal</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/36954870d698b6c712-indexus/img/offensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Offensief</span>
                                </li>
                            </ul>
