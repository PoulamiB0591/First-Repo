...
file_put_contents("/var/www/staging/public/Apps/wase/555/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/wase/555/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]--><head>
       ...
       <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/15054ab758e9854912-roelpro/img/favicon.ico"> 
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/15054ab758e9854912-roelpro/js/style.css" />
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/15054ab758e9854912-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/15054ab758e9854912-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/15054ab758e9854912-roelpro/js/app.js"></script>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT"><a class=""  href="/Apps/wase/555/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
