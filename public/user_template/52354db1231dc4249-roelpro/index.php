...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
       ...
       <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/favicon.ico"> SFPhide-->
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->
      
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/normalize.css">
         <link rel="stylesheet" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/main.css">
        
        <!-- MAS slider -->
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/mas-slider.css">
		<link href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/mas-default.css" rel="stylesheet" type="text/css">
		<link href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/mas-part-view.css" rel="stylesheet" type="text/css">
       <link rel="stylesheet" href="//test.scampaigns.com/css/templateform.css"> 
       <link rel="stylesheet" href="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/css/jquery.alerts.css"> 
      <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></SFPScript-->
             <!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
 ...
 */
     ...
     alert('User cancelled login or did not fully authorize.');
       ...
       <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/712.GIF" /> 
        </div> SFPhide-->
        <input id="getslideid" type="hidden">
        	<div class="container-fluid top">
            	<div class="SFP_ROW roel-container">
                <div class="textme" style="display:inline;"></div><div id="editable" class="SFPTWO_IMAGEEDIT expl tagsimg_1 imgEdit1 nownsfpimgdel">
                	<img id="images1" src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/logo.jpg" alt=""><!-- end of logo -->
                   </div>
                      <div class="explicit_edit"><a style="cursor: pointor;" title="Nodig je vrienden uit" class="invite disabled" onclick="invite()"><img src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container SFP_ROW">
                	<ul>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_1 tagdelete"><a href="SFP_index" title="Kies je tegel en foto" class="active disabled">1) Kies je tegel en foto</a></li>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_2 tagdelete justifyme"><a class="disabled" href="spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="enteroff  SFPTWO_TAGEDIT tag_3 tagdelete"><a class="disabled" href="bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
                    </ul>
                    </div>
                </div><!-- end of container -->
            </div><!-- end of top -->           
             <div class="main_content">
                ...
                <div class="SFP_BOOT-lg-12">
                    <div class="textme" style="display:inline;"></div><div class="SFPTWO_TEXTEDIT tags_1 texttagdelete"><h2 class="SFPTWO_TAGEDIT tag_4 tagdelete bydelete">Kies een tegel ...</h2></div>
                    <div class="textme" style="display:inline;"></div><div class="SFPTWO_TEXTEDIT tags_2 texttagdelete"><h3 class="SFPTWO_TAGEDIT tag_5 tagdelete bydelete editme">... en profileer jezelf als professional</h3></div>
                </div>
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/1.png" alt="lorem ipsum dolor sit"> 
                    <div class="ms-info">
                       
                    </div>  
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/2.png" alt="lorem ipsum dolor sit">    
                      <div class="ms-info">
                        
                    </div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/3.png" alt="lorem ipsum dolor sit">   
                     <div class="ms-info"></div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/img/4.png" alt="lorem ipsum dolor sit">   
                      <div class="ms-info"> </div>  
                </div>
            ...
            <!-- end of masterslider -->
                ...
                <p class="upload_fbbt SFPTWO_TAGEDIT tag_6 tagdelete">
                	<a class="disabled" style="cursor: pointer;" id="getprf" onclick="facebookconnect();"><span class="explicit_edit">Gebruik mijn</span><strong class="explicit_edit">PROFIELFOTO</strong></a>
                     </p>
                     <form name="form_1641106" class="upload_fbbt" enctype="multipart/form-data" method="post" id="target" action="run.php">
                	...
                	<p class="SFPTWO_TAGEDIT tag_7 tagdelete"><a class="disabled" style="cursor:pointor;"><span class="explicit_edit">Upload je eigen</span><strong class="explicit_edit">FOTO</strong></a>
                    </p>
                     </form>
                    
                     
                     <form name="form_1641106" method="post" id="targetfb" action="save.php">
                      
                       <input name="getprflmg" id="getprflmg" type="hidden"> 
                       <input name="getprfId" id="getprfId" type="hidden">
                     </form>
                </div><!-- end of btn_blog -->
                <p class="SFPTWO_TAGEDIT tag_8 tagdelete"><a href="javascript:void(0)" title="Ga verder" class="continue disabled">Ga verder</a></p><!-- end of continue -->
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/jquery.easing.min.js"></SFPScript-->
               <!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/jquery.alerts.js"></SFPScript-->
               
		<!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/mas.min.js"></SFPScript-->
	<!--SFPScript script src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/mas-part.dev.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/plugins.js"></SFPScript-->
       <!--SFPScript src="//test.scampaigns.com/user_template/52354db1231dc4249-roelpro/js/main.js"></SFPScript-->
