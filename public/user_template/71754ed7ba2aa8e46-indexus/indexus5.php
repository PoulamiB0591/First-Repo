            ...
            <div class="container">
                        ...
                        <header>
                           <div class="textme"></div><div class="SFPTWO_IMAGEEDIT img_section tagsimg_1"><a style="cursor: pointer;" title="Indexus" class="logo disabled"><img src="//test.scampaigns.com/user_template/71754ed7ba2aa8e46-indexus/img/logo.png" alt=""></a><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><a title="imgcaption" class="imgcaption" href="javascript:void(0)"></a><input value="71754ed7ba2aa8e46-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                            <p class="info SFPTWO_TAGEDIT explicit_edit tag_1 tagdelete editme bydelete" contenteditable="false">Bel: 020 - 697 20 66<br>Mail: <a class="disabled" href="mailto:contact@indexus.nl">contact@indexus.nl</a></p>
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                ...
                                <label id="R5" class="label_radio1"><input id="r5" name="investorR" value="5" type="radio"> <span id="es5">Aanvulling voor inkomen</span></label>
                            </div>
                           <div style="height: 105px;" class="textme"></div><div class="SFPTWO_TEXTEDIT heading1 tags_1 texttagdelete spaceedit"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2 tagdelete bydelete justifyme" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                           
                            <div class="textme"></div><div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/71754ed7ba2aa8e46-indexus/img/icon4.png" alt=""><div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><a title="imgcaption" class="imgcaption" href="javascript:void(0)"></a><input value="71754ed7ba2aa8e46-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                            <fieldset class="radios">
                               ...
                               <label id="R15" class="label_radio"><input id="r5" name="investorR1" value="5" type="radio"> <span id="s5">Aanvulling voor inkomen</span></label>
                                <input id="val" name="hiddeninputname" value="" type="hidden">
                            </fieldset>
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3 tagdelete" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/71754ed7ba2aa8e46-indexus/img/icon3.png" alt=""></a>
