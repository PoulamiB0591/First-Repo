    ...
    <body>
        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <header>
                           <div class="SFPTWO_IMAGEEDIT img_section"><a style="cursor: pointer;" title="Indexus" class="logo"><img src="//test.scampaigns.com/user_template/8385487db13d7c2512-indexus/img/logo.png" alt="" /></a></div>
                        ...
                        <div class="main_content">
                           ...
                           <div class="SFPTWO_TEXTEDIT heading1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit">Met welk doel <span>belegt u?</span></h2></div>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section"><img src="//test.scampaigns.com/user_template/8385487db13d7c2512-indexus/img/icon4.png" alt="" /></div>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit" style="cursor: pointer;" onclick="check()">Volgende stap <img src="//test.scampaigns.com/user_template/8385487db13d7c2512-indexus/img/icon3.png" alt="" /></a>
                        </div>
                        <div>
