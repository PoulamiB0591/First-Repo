...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/24854aa47f5bc1ce13-Optinapp--mod-template/css/style.css"/>
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/24854aa47f5bc1ce13-Optinapp--mod-template/css/jui.checkboxes.css"/>
...
<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/24854aa47f5bc1ce13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"/></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/24854aa47f5bc1ce13-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
...
<form id="sortable" action="{tag1}" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display:none">
  <div>dd</div> 
    ...
    </div><div class="checksboxes p_scents chkboxaddnow" id="checksboxes_form657"><div id="chkclone" name="checkBox"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-rowform657"><span class="checkboxWrapper"><input type="checkbox" value="option1" name="check_1" > </span> <p class="opt explicit_edit SFPTWO_TAGEDIT"  contenteditable="true" id="1"><font>option1</font></p> </div><div class="jui-checkbox-row"> <span class="checkboxWrapper"><input type="checkbox" value="option2" name="check_2" ></span> <p class="opt explicit_edit SFPTWO_TAGEDIT" contenteditable="true" id="2"><font>option2</font></p> </div><div class="jui-checkbox-row"><span class="checkboxWrapper"><input type="checkbox" value="option3" name="check_3" ></span><p class="opt explicit_edit SFPTWO_TAGEDIT" contenteditable="true" id="3"><font>option3</font></p></div></div><p id="mepp" class="pchkadd"></p><div class="setedit"><a title="edit" class="editnow" href="javascript:void(0)"></a></div></div> <div id="ullidrag" class="ullidrag" style="display:none;cursor:move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"/></div><div class="setting-2 prevnext"><a title="delete" class="delete" href="javascript:void(0)"></a><input type="hidden" id="hid" /><input type="hidden" value="0" id="imgCount" /></div></li>
