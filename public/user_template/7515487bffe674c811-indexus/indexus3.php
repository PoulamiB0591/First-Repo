        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/bar1.png" alt="" />
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/bar2.png" alt="" />
                                    <span>€100.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/bar3.png" alt="" />
                                    <span>€250.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/bar4.png" alt="" />
                                    <span>€500.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/bar5.png" alt="" />
                                    <span>€50.000</span>
                                    <label class="label_radio"><input type="radio" value="3" /></label>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/7515487bffe674c811-indexus/img/icon5.png" alt="" />
