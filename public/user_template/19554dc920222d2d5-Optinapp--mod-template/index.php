...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/19554dc920222d2d5-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/19554dc920222d2d5-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="form-container jui-checkboxes-container" id="checkboxesInit2">
        ...
        <div id="ullidrag" class="ullidrag" style="cursor: move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div style="display: block;" class="setting-2 prevnext"><a title="delete" class="delete" href="javascript:void(0)"></a><input id="hid" name="email_hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div>
        <div id="ullidrag" class="ullidrag" style="cursor: move;"><img src="/img/1416497040_cursor_drag_arrow_2.png"></div><div class="setting-2 prevnext" style="display: block;"><a title="delete" class="delete" href="javascript:void(0)"></a><input id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></li>
