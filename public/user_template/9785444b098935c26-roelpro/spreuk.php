...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script src="//test.scampaigns.com/user_template/9785444b098935c26-roelpro/js/jquery.alerts.js"></script>
         ...
         <script type="text/javascript" src="//test.scampaigns.com/user_template/9785444b098935c26-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/9785444b098935c26-roelpro/js/jquery.plugin.html2canvas.js"></script>
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/9785444b098935c26-roelpro/712.GIF" /> 
        </div> SFPhide-->
