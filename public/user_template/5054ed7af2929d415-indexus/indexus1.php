        ...
        <section class="main_step2">
            <div class="container">
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                <label id="R1" class="label_radio1"><input id="r1" name="investorR" value="1" type="radio"> <span id="es1"> Pensioen uisdfi</span></label>
                           ...
                           <div class="textme"></div><div class="SFPTWO_TEXTEDIT heading1 tags_1 texttagdelete"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2 tagdelete justifyme" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                            ...
                            <div class="textme"></div><div class="SFPTWO_IMAGEEDIT img_section tagsimg_2"><img src="//test.scampaigns.com/user_template/5054ed7af2929d415-indexus/img/icon4.png" alt=""><div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><a title="imgcaption" class="imgcaption" href="javascript:void(0)"></a><input value="5054ed7af2929d415-indexus" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"><a title="Spacing" class="spacing" href="javascript:void(0)">spacing</a></div></div>
                            <fieldset class="radios">
                                <label id="R11" class="label_radio"><input id="r1" name="investorR1" value="1" type="radio"> <span id="s1"> Pensioen uisdfi</span></label>
                            ...
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3 tagdelete" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/5054ed7af2929d415-indexus/img/icon3.png" alt=""></a>
