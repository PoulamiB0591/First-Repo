...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/87654ab8b8658d4b12-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/87654ab8b8658d4b12-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->   
    ...
    <div class="main_wrapper">
         ...
         <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/87654ab8b8658d4b12-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                   </div>
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/87654ab8b8658d4b12-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
