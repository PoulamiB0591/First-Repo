...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/js/app.js"></SFPScript-->
          ...
          <div class="container-fluid top"> 
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1">
                	<img id="images1" src="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/img/logo.jpg" alt=""><!-- end of logo -->
                      ...
                      <div class="explicit_edit"><a style="cursor: pointor;" title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/82854d3380f1a5de6-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container SFP_ROW">
                	<ul>
                    	<li class="enteroff SFPTWO_TAGEDIT tag_1 tagdelete justifyme"><a class="" href="SFP_index" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
                    	<li class="enteroff SFPTWO_TAGEDIT tag_2 tagdelete"><a class="" href="SFP_Redirect/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="enteroff SFPTWO_TAGEDIT tag_3 tagdelete"><a class="" href="SFP_Redirect/bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
                    </ul>
                    </div>
                </div><!-- end of container -->
            </div><!-- end of top -->
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="SFP_BOOT-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1 texttagdelete"><h2 class="SFPTWO_TAGEDIT  tag_4 tagdelete">Voer je spreuk in ...</h2></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="SFPTWO_TEXTEDIT tags_2 texttagdelete"><h3 class="SFPTWO_TAGEDIT tag_5 tagdelete">Wat is jouw lijfspreuk als professional?</h3></div>
                </div>
                </div><!-- end of container -->
                <form enctype="multipart/form-data" action="bedankt.php" id="frms" name="form_1572270" method="post" class="lijfspreuk">
               ...
               <p class="explicit_edit"><input name="submit" class="spreuk_val" value="Deel je tegel op Facebook" onclick="canvas()" type="button" contenteditable="true">
                </p>
