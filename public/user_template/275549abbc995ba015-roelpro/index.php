...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
       ...
       <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <!-- MAS slider -->
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/css/mas-slider.css">
		<link href="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/css/mas-default.css" rel="stylesheet" type="text/css">
		<link href="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/css/mas-part-view.css" rel="stylesheet" type="text/css">
       <link rel="stylesheet" href="//test.scampaigns.com/css/templateform.css"> 
       <link rel="stylesheet" href="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/css/jquery.alerts.css"> 
      <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></SFPScript-->
             <!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
    ...
    <div class=" fb_reset fb_reset" id="fb-root"><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div></div></div><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div></div></div><div style="position: absolute; top: -10000px; height: 0px; width: 0px;"><div><iframe name="fb_xdm_frame_http" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_http" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="http://static.ak.facebook.com/connect/xd_arbiter/7r8gQb8MIqE.js?version=41#channel=f19a94850&amp;origin=http%3A%2F%2Ftest.scampaigns.com" style="border: none;"></iframe><iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="https://s-static.ak.facebook.com/connect/xd_arbiter/7r8gQb8MIqE.js?version=41#channel=f19a94850&amp;origin=http%3A%2F%2Ftest.scampaigns.com" style="border: none;"></iframe></div></div></div>
 ...
 */
 ...
 },{scope: '0,1,email,publish_actions'});
       ...
       <!--[if lt IE 7]>
        ...
        <input type="hidden" id="getslideid">
        	<div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1 imgEdit1 ui-resizable rand_525 imgEdit3 imgEdit4 imgEdit5" id="editable" style="display: block; height: 84px; width: 102px;"><div id="draggable2" style="z-index: 2; position: absolute; left: -105px; top: -19px;" class="ui-draggable"><div><div id="resizable2" style="z-index: 2; height: 67px; width: 236.620253164557px; top: 12px; left: 42.379746835443px;" class="ui-resizable"><img class="layeredImage" id="images2" src="http://test.scampaigns.com/library/f3b3c5c2b421b99ddb7346ea2bb13c88.png" style="height:100%; width:100%; z-index:2;"><div class="ui-resizable-handle ui-resizable-ne" style="z-index: 1000;"></div><div class="ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se" style="z-index: 1000;"></div><div class="ui-resizable-handle ui-resizable-sw" style="z-index: 1000;"></div><div class="ui-resizable-handle ui-resizable-nw" style="z-index: 1000;"></div></div></div></div>
                	<img id="images1" src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/logo.jpg" alt=""><!-- end of logo -->
                   <div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input type="hidden" value="undefined" id="hid"><input type="hidden" value="3" id="imgCount"></div><div class="ui-resizable-handle ui-resizable-s" style="z-index: 1000;"></div></div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container SFP_ROW">
                	<ul>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT tag_1" contenteditable="false"><a href="SFP_index" title="Kies je tegel en foto" class="active disabled">1) Kies je tegel en foto</a></li>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT tag_2" contenteditable="false"><a class="disabled" href="spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff  SFPTWO_TAGEDIT tag_3" contenteditable="false"><a class="disabled" href="bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
             ...
             <div class="main_content">
                ...
                <div class="SFP_BOOT-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="SFPTWO_TAGEDIT explicit_edit tag_4" contenteditable="false">Kies een tegel ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                    <div class="SFPTWO_TEXTEDIT tags_2"><h3 class="SFPTWO_TAGEDIT explicit_edit tag_5" contenteditable="false">... en profileer jezelf als professional</h3><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                </div>
            ...
            <div class="master-slider ms-skin-default" id="masterslider">
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/1.png" alt="lorem ipsum dolor sit"> 
                    <div class="ms-info">
                       
                    </div>  
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/2.png" alt="lorem ipsum dolor sit">    
                      <div class="ms-info">
                        
                    </div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/3.png" alt="lorem ipsum dolor sit">   
                     <div class="ms-info"></div>
                </div>
                <div class="ms-slide">
                    <img src="img/blank.gif" data-src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/img/4.png" alt="lorem ipsum dolor sit">   
                      <div class="ms-info"> </div>  
                </div>
            ...
            <!-- end of masterslider -->
                ...
                <p class="explicit_edit upload_fbbt SFPTWO_TAGEDIT tag_6" contenteditable="false">
                	...
                	<p class="explicit_edit SFPTWO_TAGEDIT tag_7" contenteditable="false"><a class="disabled" style="cursor:pointor;"><span class="explicit_edit" contenteditable="false">Upload je eigen</span><strong class="explicit_edit" contenteditable="false">FOTO</strong></a>
                    </p>
                ...
                <p class="explicit_edit SFPTWO_TAGEDIT tag_8" contenteditable="false"><a href="javascript:void(0)" title="Ga verder" class="continue disabled">Ga verder</a></p><!-- end of continue -->
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/jquery.easing.min.js"></SFPScript-->
               <!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/jquery.alerts.js"></SFPScript-->
               
		<!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/mas.min.js"></SFPScript-->
	<!--SFPScript script src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/mas-part.dev.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/plugins.js"></SFPScript-->
       <!--SFPScript src="//test.scampaigns.com/user_template/275549abbc995ba015-roelpro/js/main.js"></SFPScript-->
