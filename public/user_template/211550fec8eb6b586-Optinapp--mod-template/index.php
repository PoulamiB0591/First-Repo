...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/211550fec8eb6b586-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/211550fec8eb6b586-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="textme" style="display:inline;"></div><div style="overflow: visible;" class="SFPTWO_IMAGEEDIT textimgSFPdrag ui-droppable nownsfpimgdel tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/211550fec8eb6b586-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;">
...
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/211550fec8eb6b586-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
<div class="textme" style="display:inline;"></div><div class="tool-tip SFPTWO_TEXTEDIT tags_2 texttagdelete"><h2 class="textedit SFPTWO_TAGEDIT edit explicit_edit tag_2 tagdelete bydelete justifyme editme" contenteditable="false">Fill in your details and win! </h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div>
