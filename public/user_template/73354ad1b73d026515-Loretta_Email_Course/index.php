...
<link rel="stylesheet" href="/editcss/jquery.timepicker.css">
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/73354ad1b73d026515-Loretta_Email_Course/css/style.css">
...
<div class="header">
    <div class="container">
    	<div class="SFPTWO_IMAGEEDIT tagsimg_1">
    		<img src="//test.scampaigns.com/user_template/73354ad1b73d026515-Loretta_Email_Course/images/1b2ayl6-fake-logo.png" class="company-logo">
        </div>
    </div>
</div>
<div class="main">
...
<div class="SFP_ROW main-center">
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-7 SFPTWO_IMAGEEDIT tagsimg_2">
        <img src="//test.scampaigns.com/user_template/73354ad1b73d026515-Loretta_Email_Course/images/ar0imc-email-envelope.png" class="envelope img-responsive">
    </div>
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-5">
        <div class="SFP_ROW">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3">
              ...
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_1409812" id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_987" class="opt SFPTWO_TAGEDIT getme tag_4"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_932" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_528" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_924" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" name="submit" value="Send the eCourse" type="submit"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_718" class="opt SFPTWO_TAGEDIT note tag_6"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
