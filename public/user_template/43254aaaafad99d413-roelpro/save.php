...
<body style="position: inherit;">
 <div class="overlay_div" style="opacity: 0.40;">
  ...
  <input type="text" class="width" value="<!--PHP echo $width;PHP-->"/>
  <input type="text" class="height" value="<!--PHP echo $height;PHP-->"/>
...
<div style="opacity: 0;">
 <div class="img-cont clearfix" id="target">
                ...
                <div class="front-img-cont textup"><img id="front-img" src="SFP_Redirect/SFP_Link/<!--PHP echo $new_image_name;PHP--> 
" /></div>
               <div class="front-img-cont textbellow"><img id="front-img" src="SFP_Redirect/SFP_Link/<!--PHP echo $new_image_name;PHP--> 
" /></div>
