        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/244548542393bd156-indexus/img/defensief_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Defensief</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/244548542393bd156-indexus/img/neutraal_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Neutraal</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/244548542393bd156-indexus/img/offensief_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Offensief</span>
                                </li>
                            </ul>
                             <a class="button_btn disabled" style="cursor: pointer;" onclick="validation();">Volgende stap<img src="//test.scampaigns.com/user_template/244548542393bd156-indexus/img/icon3.png" alt=""></a>
