    ...
    <head>
        ...
        <link href='https://fonts.googleapis.com/css?family=Sigmar+One' rel='stylesheet' type='text/css'>
            <link href='https://fonts.googleapis.com/css?family=Oswald:400,700' rel='stylesheet' type='text/css'>
                 <!--SFPScript   type="text/javascript" src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/js/jquery-1.9.1.min.js"></SFPScript-->
                <!--SFPScript  type="text/javascript" src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/js/bootstrap.min.js"></SFPScript-->
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/css/bootstrap.min.css">
                <link rel="stylesheet" href="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/css/style.css">
            </head>
            <body>
                <div id="wrapper" class="SFPTWO_BACKGROUND">
                    <div ID="content-wrapper"><!-- START OF SECTION -->
                    <div data-lead-id="top-SFP_ROW" id="top-SFP_ROW" class="text-center">
                    <div
                    <div class="SFPTWO_TEXTEDIT">
                        <h1 data-lead-id="top-SFP_ROW-text" class="textedit SFPTWO_TAGEDIT edit explicit_edit">GRILLED TO PERFECTION - GET IT TODAY!</h1>
                        </div>
                       
                       <div class="logo SFPTWO_IMAGEEDIT">
                        <a href="#" data-lead-id="logo" class="">
                            <img src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/img/logo.png" class="img-responsive center-block" />
                        </a>
                        </div>
                    </div>
                    <div class="hero-img-section text-center">
                    <div class="SFPTWO_IMAGEEDIT">
                        <img src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/img/hero-image.jpg" data-lead-id="hero-img" class="img-responsive center-block" />
                        </div>
                        <div class="sunburst">
                        <div class="SFPTWO_IMAGEEDIT">
                            <img src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/img/burst.png" data-lead-id="hero-burst" class="img-responsive center-block" />
                    ...
                    <div class="container-fluid">
                        <div data-lead-id="hero-text-container" class="SFP_ROW hero-text-container text-center">
                            <div class="SFP_BOOT-md-12 SFPTWO_TEXTEDIT">
                        ...
                        <div class="SFP_ROW">
                            <div class="SFP_BOOT-sm-6">
                                <div data-lead-id="coupon-container" class="coupon-container">
                                    <img src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/img/coupon-bg.jpg" data-lead-id="coupon-bg" class="coupon-bg" />
                                    <div class="coupon-inner">
                                    <div class="SFPTWO_TEXTEDIT">
                                        <h2 data-lead-id="coupon-text1" class="textedit SFPTWO_TAGEDIT edit explicit_edit"><strong>BUY 1 & GET 1 FREE</strong></h2>
                                        </div>
                                        <div class="SFPTWO_TEXTEDIT">
                                        <a href="#" data-lead-id="coupon-btn" class="sfpDynamic coupon-btn textedit SFPTWO_TAGEDIT edit explicit_edit">DOWNLOAD YOUR COUPON
                                        </a>
                                        </div>
                                        <div>
                            ...
                            <div class="SFP_BOOT-sm-6">
                                ...
                                <div>
                                  ...
                                  <div>
                                    <h3 data-lead-id="right-text3" class="SFPTWO_TEXTEDIT"><strong class="textedit SFPTWO_TAGEDIT edit explicit_edit">ORDER ONLINE:<BR />WWW.COOLBURGER.COM</strong></h3>
                               </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="SFP_ROW">
                            <div class="SFP_BOOT-md-12 text-center">
                                <div data-lead-id="add-this" class="SFPTWO_IMAGEEDIT addthis_sharing_toolbox social-links">
                                    <img src="//test.scampaigns.com/user_template/548550bfa59e09e110-tastydeal/img/social_btns.png" />
                                </div>
                                <div>
