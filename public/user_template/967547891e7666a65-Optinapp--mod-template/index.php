...
<form name="form_1408478" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
    ...
    </p></div><div class="checksboxes p_scents chkboxaddnow" id="checksboxes_form657"><div id="chkclone"><div for="p_scnts" class="jui-checkbox-row" id="jui-checkbox-rowform657"><span class="checkboxWrapper"><input value="option1" name="check_1" type="checkbox"> </span> <p class="opt explicit_edit" id="1" contenteditable="false"><font color="#15ace7">option1</font></p> </div><div class="jui-checkbox-row"> <span class="checkboxWrapper"><input value="option2" name="check_2" type="checkbox"></span> <p class="opt explicit_edit" id="2" contenteditable="false"><font color="#15ace7">option2</font></p> </div><div class="jui-checkbox-row"><span class="checkboxWrapper"><input value="option3" name="check_3" type="checkbox"></span><p class="opt explicit_edit" id="3" contenteditable="false"><font color="#15ace7">option3</font></p></div></div><p id="mepp" class="pchkadd"></p></div> </li><li style="display: list-item;" class="ui-draggable">
    	</li><li class="dottedLi SFPTWO_TEXTEDIT tags_NaN tags_2"><div id="labeledit" class="labeledit datedrag"><p id="pid_577" class="opt explicit_edit SFPTWO_TAGEDIT tag_NaN tag_3" contenteditable="false"><font color="#15ace7">Label</font></p><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div><input name="" id="datepicker1" onclick="datepick(1)" type="text"></li>
    
    

	 <li class="dottedLi element3"><div id="diveditme" class="labeledit"><p style="font-size: 19px;" id="pid_formmsg" class="opt explicit_edit" contenteditable="false"><font color="#15ace7">Your message</font></p><div><textarea id="editmetext" name="textareaelement3"></textarea></div></div></li>
	<li><input class="inputdisabled" name="submit" value="Send" type="submit"></li>
