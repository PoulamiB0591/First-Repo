...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/663547da4c6149007-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/663547da4c6149007-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/663547da4c6149007-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/663547da4c6149007-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<form name="form_93983" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
<li class="dottedLi SFPTWO_TEXTEDIT tag_8 element5"><div id="labeledit" class="labeledit datedrag"><p id="pid_975" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">Label</font></p></div><input name="textboxelement5" id="datepicker1" onclick="datepick(1)" type="text"></li></ul>
</form>
</div>
</div>