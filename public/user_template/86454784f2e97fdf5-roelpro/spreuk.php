...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/86454784f2e97fdf5-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/86454784f2e97fdf5-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/86454784f2e97fdf5-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/86454784f2e97fdf5-roelpro/js/app.js"></!--SFPScript> 
        ...
        <div class="main_wrapper">
          <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1">
                   ...
                   <div class="setting-2" style="display:none"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="86454784f2e97fdf5-roelpro" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
             ...
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	...
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_2" contenteditable="false"><a class="disabled" href="SFP_Redirect/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spfghfghreuk</a></li>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_3" contenteditable="false"><a class="disabled" href="SFP_Redirect/bedankt.php" id="Bedankt" title="Bedankt">3) Bedgfhgfhankt</a></li>
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="SFPTWO_TAGEDIT explicit_edit tag_4" contenteditable="false"><font color="#50f1ee">Voer je sprefghgfuk in ...</font></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
