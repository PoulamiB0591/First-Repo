            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" type="radio"><span> 20 jaar </span></label>
                                <label class="label_radio"><input value="2" type="radio"><span>  15 jaar</span></label>
                                <label class="label_radio"><input value="2" type="radio"><span>  10 jaar</span></label>
                                <label class="label_radio"><input value="2" type="radio"><span>  5 jaar</span></label>
                            </fieldset>
                            <div class="jaar">
                            	<span>20 jaar</span>
                            	<span>15 jaar</span>
                           ...
                           <a class="button_btn disabled" style="cursor: pointer;" id="submit" onclick="validation();">Volgende stap <img src="//test.scampaigns.com/user_template/9205487c17fd95936-indexus/img/icon3.png" alt=""></a>
