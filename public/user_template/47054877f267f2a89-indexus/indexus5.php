        ...
        <section class="main_step6">
                    <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <label class="label_radio"><input value="5" type="radio">Ik wil zelf beleggen</label><label class="label_radio"><input value="5" type="radio">Ik wil zelf beleggen</label><label class="label_radio"><input value="5" type="radio">Ik wil zelf beleggen</label><label class="label_radio"><input value="5" type="radio">Ik wil zelf beleggen</label><label class="label_radio"><input value="5" type="radio">Ik wil zelf beleggen</label></fieldset>
