...
<!--SFPPAGE-->
        ...
        <link href="https://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css">
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/jquery-1.9.1.min.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/bootstrap.min.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/html5shiv.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/functions.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/classie.js"></SFPScript-->
            <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/js/custom.js"></SFPScript-->
            
            <link rel="stylesheet" href="//test.scampaigns.com/user_template/99454f97c7651ee16-event/css/bootstrap.min.css">
            <link rel="stylesheet" href="//test.scampaigns.com/user_template/99454f97c7651ee16-event/css/style.css">
        ...
        <div class="wrapper_main">
                        ...
                        <div class="col-md-3">
                            <div class="logo-container">
                               <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_1">
                                	<img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo.png" id="logo" class="img-responsive">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <div class="top-menu-container">
                                <ul data-lead-id="top-menu" class="list-inline">
                                    <li data-lead-id="top-link1-container"><a class="sfpDynamic SFPTWO_TAGEDIT" href="#anchor1"><div style="display:inline-block;" class="textme"></div></a><div style="display: none;" class="SFPTWO_TEXTEDIT tags_1 texttagdelete randtxt_171 randtxt_870"><a class="sfpDynamic SFPTWO_TAGEDIT" href="#anchor1"><span class="textedit SFPTWO_TAGEDIT edit tag_1 tagdelete" data-lead-id="top-link1">ABOUT</span></a></div></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div data-lead-id="hero-info-conatiner" class="hero-info-container">
                           <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_10 texttagdelete"> <h1 data-lead-id="hero-header" class="textedit SFPTWO_TAGEDIT edit tag_10 tagdelete bydelete editme">SOME AWESOME EVENT</h1></div>
                            <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_11 texttagdelete"><h2 data-lead-id="hero-sub-header" class="textedit SFPTWO_TAGEDIT edit tag_11 tagdelete bydelete justifyme">WHERE YOU COME TO LEARN OR SEE AWESOME THINGS</h2></div>
                            <div data-lead-id="counter" class="counter">
                                <ul class="list-inline">
                                    <li>
                                        <div class="counter-box">
                                            <div class="number">
                                            <div class="textme" style="display: inline-block; height: 0px;"></div><div class="SFPTWO_TEXTEDIT tags_12 texttagdelete spaceedit">
                            ...
                            <div>
                              <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_20 texttagdelete">  <a target="_blank" href="https://in.yahoo.com/?p=us" data-lead-id="btn-hero" class="sfpDynamic btn btn-primary btn-hero textedit SFPTWO_TAGEDIT edit tag_20 tagdelete">REGISTER66+</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="details-box">
                                        <div class="pull-left details-img">
                                           <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_2">
                                            	<img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/cal_icon.png" data-lead-id="details-box1-img" class="img-responsive">
                                            </div>
                                        </div>
                                    ...
                                    <div class="details-box">
                                        <div class="pull-left details-img">
                                           <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_3">
                                            	<img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/marker_icon.png" data-lead-id="details-box2-img" class="img-responsive">
                                            </div>
                                        </div>
                                        <div class="details-info">
                                    ...
                                    <div class="details-box">
                                        <div class="pull-left details-img">
                                          <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_4">
                                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker_icon.png" data-lead-id="details-box3-img" class="img-responsive">
                                            </div>
                                        </div>
                                        <div class="details-info">
                                    ...
                                    <div class="details-box">
                                        <div class="pull-left details-img">
                                         <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_5">
                                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/group_icon.png" data-lead-id="details-box4-img" class="img-responsive">
                                            </div>
                                        </div>
                                        <div class="details-info">
                        ...
                        <div data-lead-id="about-image-container" class="about-image-container">
                            <ul class="list-inline">
                                <li>
                                    ...
                                    <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/about_img1.jpg" data-lead-id="about-image1" class="img-responsive center-block">
                                    </div>
                                </li>
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_7"><img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/about_img2.jpg" data-lead-id="about-image2" class="img-responsive center-block"></div></li>
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_8"><img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/about_img3.jpg" data-lead-id="about-image3" class="img-responsive center-block"></div></li>
                                <li> <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_9"><img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/about_img4.jpg" data-lead-id="about-image4" class="img-responsive center-block"></div></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="video-container" data-wow-delay=".7s">
                                <div id="top-vid-area" class="vid-wrapper text-center">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_10">
                                    <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/vid_placeholder.jpg" class="dummy img-responsive center-block dummy">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <li data-lead-id="time-slot1-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_11">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot1-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot2-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_12">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot2-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot3-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_13">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot3-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot4-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_14">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot4-img" class="img-responsive textedit SFPTWO_TAGEDIT edit tag_44 tagdelete">
                                        </div>
                            ...
                            <ul class="list-inline">
                                ...
                                <li data-lead-id="time-slot5-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_15">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot5-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot6-box">
                                    <div class="schedule-box">
                                        ...
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot6-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot7-box">
                                    <div class="schedule-box">
                                        ...
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot7-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot8-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_18">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot8-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot9-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_19">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot9-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot10-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_20">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot10-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot11-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_21">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot11-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot12-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_22">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot12-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot13-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_23">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot13-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot14-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_24">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot14-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot15-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_25">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot15-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot16-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_26">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot16-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot17-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_27">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot17-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot18-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_28">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot18-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot19-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_29">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot19-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot20-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_30">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot20-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot21-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_31">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot21-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot22-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_32">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot22-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot23-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_33">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot23-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot24-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_34">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot24-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot25-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_35">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot25-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot26-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_36">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot26-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot27-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_37">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot27-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="time-slot28-box">
                                    <div class="schedule-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_38">
                                        <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/clock_icon.png" data-lead-id="time-slot28-img" class="img-responsive">
                                        </div>
                                ...
                                <li data-lead-id="presenter1-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_39">
                                        <img data-lead-id="presenter1-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker1.jpg">
                                        </div>
                                ...
                                <li data-lead-id="presenter2-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_40">
                                        <img data-lead-id="presenter2-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker2.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter3-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_41">
                                        <img data-lead-id="presenter3-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker3.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter4-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_42">
                                        <img data-lead-id="presenter4-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker4.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter5-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_43">
                                        <img data-lead-id="presenter5-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker5.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter6-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_44">
                                        <img data-lead-id="presenter6-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker6.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter7-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_45">
                                        <img data-lead-id="presenter7-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker7.jpg">
                                       </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter8-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_46">
                                        <img data-lead-id="presenter8-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker8.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter9-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_47">
                                        <img data-lead-id="presenter9-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker1.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter10-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_48">
                                        <img data-lead-id="presenter10-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker2.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter11-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_49">
                                        <img data-lead-id="presenter11-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker3.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter12-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_50">
                                        <img data-lead-id="presenter12-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker4.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter13-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_51">
                                        <img data-lead-id="presenter13-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker5.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter14-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_52">
                                        <img data-lead-id="presenter14-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker6.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter15-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_53">
                                        <img data-lead-id="presenter15-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker7.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                                ...
                                <li data-lead-id="presenter16-container">
                                    <div class="speaker-profile-box">
                                     <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_54">
                                        <img data-lead-id="presenter16-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/speaker8.jpg">
                                        </div>
                                        <div class="speaker-profile-info">
                            ...
                            <ul class="list-inline text-center">
                                <li data-lead-id="partners-logo1-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_55">
                                    <img data-lead-id="partners-logo1" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo1.png" class="img-responsive center-block">
                                   </div> 
                                </li>
                                <li data-lead-id="partners-logo2-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_56">
                                    <img data-lead-id="partners-logo2" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo2.png" class="img-responsive center-block">
                                    </div>
                                </li>
                                <li data-lead-id="partners-logo3-container">
                                    <img data-lead-id="partners-logo3" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo3.png" class="img-responsive center-block">
                                ...
                                <li data-lead-id="partners-logo4-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_57">
                                    <img data-lead-id="partners-logo4" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo4.png" class="img-responsive center-block">
                                    </div>
                                </li>
                                <li data-lead-id="partners-logo5-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_58">
                                    <img data-lead-id="partners-logo5" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo5.png" class="img-responsive center-block">
                                   </div> 
                                </li>
                                <li data-lead-id="partners-logo6-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_59">
                                    <img data-lead-id="partners-logo6" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo6.png" class="img-responsive center-block">
                                   </div> 
                                </li>
                                <li data-lead-id="partners-logo7-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_60">
                                    <img data-lead-id="partners-logo7" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo7.png" class="img-responsive center-block">
                                    </div>
                                </li>
                                <li data-lead-id="partners-logo8-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_61">
                                    <img data-lead-id="partners-logo8" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo8.png" class="img-responsive center-block">
                                   </div> 
                                </li>
                                <li data-lead-id="partners-logo9-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_62">
                                    <img data-lead-id="partners-logo9" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo9.png" class="img-responsive center-block">
                                   </div> 
                                </li>
                                <li data-lead-id="partners-logo10-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_63">
                                    <img data-lead-id="partners-logo10" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo10.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                                <li data-lead-id="partners-logo11-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_64">
                                    <img data-lead-id="partners-logo11" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo11.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                                <li data-lead-id="partners-logo12-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_65">
                                    <img data-lead-id="partners-logo12" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo12.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                                <li data-lead-id="partners-logo13-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_66">
                                    <img data-lead-id="partners-logo13" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo13.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                                <li data-lead-id="partners-logo14-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_67">
                                    <img data-lead-id="partners-logo14" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo14.png" class="img-responsive center-block">
                                 </div>   
                                </li>
                                <li data-lead-id="partners-logo15-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_68">
                                    <img data-lead-id="partners-logo15" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo15.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                                <li data-lead-id="partners-logo16-container">
                                 <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_69">
                                    <img data-lead-id="partners-logo16" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/logo16.png" class="img-responsive center-block">
                                  </div>  
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="list-inline">
                                <li data-lead-id="testimonial1-container">
                                    ...
                                    <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_195 texttagdelete">
                                        ...
                                        <img data-lead-id="testimonial1-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/testimonial1.jpg" class="img-responsive center-block">
                                        </div>
                                ...
                                <li data-lead-id="testimonial2-container">
                                    ...
                                    <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_197 texttagdelete">
                                        ...
                                        <img data-lead-id="testimonial2-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/testimonial2.jpg" class="img-responsive center-block">
                                        </div>
                                ...
                                <li data-lead-id="testimonial3-container">
                                    ...
                                    <div class="textme" style="display:inline-block;"></div><div class="SFPTWO_TEXTEDIT tags_199 texttagdelete">
                                        ...
                                        <img data-lead-id="testimonial3-image" src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/testimonial3.jpg" class="img-responsive center-block">
                                        </div>
            ...
            <div data-lead-id="location-map">
             <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_73">
                <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/map.jpg" class="img-responsive center-block">
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <li id="fb-btn-container">
                        <div id="fb-btn">
                         <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_74">
                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/fb-like.jpg" class="dummy img-responsive block-center dummy">
                            </div>
                        </div>
                    </li>
                    <li id="twitter-btn-container">
                        <div id="twitter-btn">
                         <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_75">
                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/twitter-like.jpg" class="dummy img-responsive block-center dummy">
                            </div>
                        </div>
                    </li>
                    <li id="google-btn-container">
                        <div id="google-btn">
                         <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_76">
                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/google-like.jpg" class="dummy img-responsive block-center dummy">
                            </div>
                        </div>
                    </li>
                </ul>
                    ...
                    <li id="fb-share-btn-container">
                        <a href="#" id="fb-share-btn" class="sfpDynamic">
                         <div class="textme" style="display:inline-block;"></div><div class="logo-area text-center SFPTWO_IMAGEEDIT tagsimg_77">
                            <img src="//test.scampaigns.com/user_template/99454f97c7651ee16-event/img/fb_share.png" class="dummy img-responsive block-center dummy">
                            </div>
                        </a>
                    </li>
