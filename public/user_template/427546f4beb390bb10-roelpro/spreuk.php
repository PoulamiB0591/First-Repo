...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/style.css" />
        ...
        <!--SFPScript data-require="angular.js@*" data-semver="1.2.0" src="//code.angularjs.org/1.2.0/angular.js"></!--SFPScript> 
           <!--SFPScript src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/plugins.js"></!--SFPScript> 
        <!-- </script> -->
        <!--SFPScript src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/vendor/modernizr-2.6.2.min.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/jquery.alerts.js"></!--SFPScript> 
         <!--SFPScript src="https://connect.facebook.net/nl_NL/all.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/js/app.js"></!--SFPScript> 
...
<div id="fb-root">
    ...
    <!--[if lt IE 7]>
        ...
        <img class="loading_img" src="//test.scampaigns.com/user_template/427546f4beb390bb10-roelpro/712.GIF" /> 
        </div> SFPhide-->
