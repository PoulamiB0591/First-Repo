            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel radios">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/974548a8ae1971056-indexus/img/defensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" name="indexusapp" type="radio"></label>
                                    <span id="s1">Defe</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/974548a8ae1971056-indexus/img/neutraal_img.png" alt="">
                                    <label class="label_radio"><input value="4" name="indexusapp" type="radio"></label>
                                    <span id="s2">Neu</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/974548a8ae1971056-indexus/img/offensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" name="indexusapp" type="radio"></label>
                                    <span id="s3">Off</span>
                                </li>
                            </ul>
