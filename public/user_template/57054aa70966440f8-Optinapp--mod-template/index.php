...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/57054aa70966440f8-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/57054aa70966440f8-Optinapp--mod-template/css/jui.checkboxes.css">
...
<form id="editable" action="abcd.php" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">
...
</form>-&gt;<input id="sfpoptForm" value="abcd.php" type="text">
</div>
</div>
