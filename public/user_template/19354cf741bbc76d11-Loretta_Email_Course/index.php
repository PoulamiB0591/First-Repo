...
<link rel="stylesheet" href="/editcss/jquery.timepicker.css">
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/19354cf741bbc76d11-Loretta_Email_Course/css/style.css">
...
<div class="header">
    <div class="container">
    	<div class="SFPTWO_IMAGEEDIT tagsimg_1">
    		<img src="//test.scampaigns.com/user_template/19354cf741bbc76d11-Loretta_Email_Course/images/1b2ayl6-fake-logo.png" class="company-logo">
        </div>
    </div>
</div>
<div class="main">
...
<div class="SFP_ROW main-center">
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-7 SFPTWO_IMAGEEDIT tagsimg_2">
        <img src="//test.scampaigns.com/user_template/19354cf741bbc76d11-Loretta_Email_Course/images/ar0imc-email-envelope.png" class="envelope img-responsive">
    </div>
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-5">
        <div class="SFP_ROW">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3 texttagdelete">
              ...
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_471" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_231" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_425" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_189" required="required" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 texttagdelete element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" name="submit" value="Send the eCourse" type="submit"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 texttagdelete element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_125" class="opt SFPTWO_TAGEDIT note tag_6 tagdelete"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
