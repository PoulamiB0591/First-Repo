    ...
    (function(d, s, id) {
      ...
      window.fbAsyncInit = function (){
        ...
        <div class="main_wrap SFPTWO_BACKGROUND">
            ...
            <a onclick="fInvMulti()" style="cursor: pointer;" class="app"><div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/67954cff0af95b2314-epic/img/facebook_app.png" alt="" /></div></a>
