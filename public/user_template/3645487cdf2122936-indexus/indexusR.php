...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
   ...
   $.ajax({
    ...
    <body>
        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <h3><p id="resHide" style="display: none;">result</p><p id="res"></p></h3>
                            ...
                            <div class="SFPTWO_IMAGEEDIT img_section"><img src="//test.scampaigns.com/user_template/3645487cdf2122936-indexus/img/icon7.png" alt="" class="img_response" /></div>
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/3645487cdf2122936-indexus/js/main.js"></SFPScript-->
