...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
       ...
       <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/img/favicon.ico"> SFPhide-->
      ...
      <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></!--SFPScript> 
             <!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/vendor/modernizr-2.6.2.min.js"></!--SFPScript> 
       ...
       <!--[if lt IE 7]>
        ...
        <input id="getslideid" type="hidden">
        	<div class="container-fluid top">
                ...
                <div style="height: 84px; width: 102px;" id="editable" class="SFPTWO_IMAGEEDIT expl tagsimg_1 imgEdit1 ui-resizable"><div class="ui-draggable" id="draggable0" style="z-index: 0; position: absolute; left: -10px; top: -3px;"><div><div class="ui-resizable" id="resizable0" style="z-index:0; height:627px; width:940px;"><img class="layeredImage" id="images0" src="http://test.scampaigns.com/library/5b78df9b74e6043e7d7587a23fa63e40.jpg" style="height:100%; width:100%; z-index:0;"></div></div></div>
                	<!-- end of logo -->
                   </div>
                      <div class="explicit_edit"><a style="cursor: pointor;" title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
           ...
           <div class="form-container jui-checkboxes-container" id="checkboxesInit2">
            ...
            <div class="footer"></div><!-- end of footer -->
             ...
             <!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/jquery.easing.min.js"></SFPScript-->
               <!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/jquery.alerts.js"></SFPScript-->
               
		<!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/mas.min.js"></SFPScript-->
	<!--SFPScript script src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/mas-part.dev.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/plugins.js"></SFPScript-->
       <!--SFPScript src="//test.scampaigns.com/user_template/2205485ac0b0a2f115-roelpro/js/main.js"></SFPScript-->
