        ...
        <section class="main_step4">
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/68454874bed1e8d115-indexus/img/defensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Defensief</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/68454874bed1e8d115-indexus/img/neutraal_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Neutraal</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/68454874bed1e8d115-indexus/img/offensief_img.png" alt="">
                                    <label class="label_radio"><input value="4" type="radio"></label>
                                    <span>Offensief</span>
                                </li>
                            </ul>
