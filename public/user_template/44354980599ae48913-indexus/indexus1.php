            ...
            <div class="container">
                        ...
                        <div class="main_content">
                        	<div class="investor">
                                ...
                                <label id="R3" class="label_radio1"><input id="r3" name="investorR" value="3" type="radio"> <span id="es3">Behoud n </span></label>
                                ...
                                <label id="R5" class="label_radio1"><input id="r5" name="investorR" value="5" type="radio"> <span id="es5">Aanvu</span></label>
                            </div>
                           <div class="SFPTWO_TEXTEDIT heading1 tags_1"><h2 class="heading SFPTWO_TAGEDIT explicit_edit tag_2" contenteditable="false">Met welk doel <span>belegt u?</span></h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
                            ...
                            <fieldset class="radios">
                                ...
                                <label id="R13" class="label_radio"><input id="r3" name="investorR1" value="3" type="radio"> <span id="s3">Behoud n </span></label>
                               ...
                               <label id="R15" class="label_radio"><input id="r5" name="investorR1" value="5" type="radio"> <span id="s5">Aanvu</span></label>
                                <input id="val" name="hiddeninputname" value="" type="hidden">
                            </fieldset>
                            <a class="button_btn SFPTWO_TAGEDIT explicit_edit disabled tag_3" style="cursor: pointer;" onclick="check()" contenteditable="false">Volgende stap <img src="//test.scampaigns.com/user_template/44354980599ae48913-indexus/img/icon3.png" alt=""></a>
