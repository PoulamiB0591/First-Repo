        ...
        <section class="main_step2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <header>
                            <a style="cursor: pointer;" title="Indexus" class="logo disabled"><div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/logo.png" alt=""></div></a>
                        ...
                        <div class="main_content">
                            ...
                            <div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/icon4.png" alt="" class="img-responsive"></div>
