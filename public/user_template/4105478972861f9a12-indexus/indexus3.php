                ...
                <div class="row">
                    <div class="col-lg-12">
                        <header>
                            ...
                            <p class="info">Bel: 020 - 697 20 66<br />Mail: <a href="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/mailto:contact@indexus.nl">contact@indexus.nl</a></p>
                        </header>
                        <div class="main_content">
                            ...
                            <ul class="invest">
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/bar1.png" alt="" class="img-responsive" /></div>
                            	...
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/bar2.png" alt="" class="img-responsive" /></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">&euro;100.000</span></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="3" /></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/bar3.png" alt="" class="img-responsive" /></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">&euro;250.000</span></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="3" /></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/bar4.png" alt="" class="img-responsive" /></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">&euro;500.000</span></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="3" /></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/bar5.png" alt="" class="img-responsive" /></div>
                                    <div class="SFPTWO_TEXTEDIT"><span class="SFPTWO_TAGEDIT explicit_edit">&euro;1.000.000</span></div>
                                    <label class="label_radio"><input type="radio" name="radio" id="rd" value="3" /></label>
                                </li>
                            	<li class="col-lg-2">
                                	<div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/4105478972861f9a12-indexus/img/icon5.png" alt="" class="img-responsive" /></div>
