    ...
    (function(d, s, id) {
      ...
      window.fbAsyncInit = function (){
        ...
        <div class="main_wrap">
            ...
            <a onclick="fInvMulti()" style="cursor: pointer;" class="app"><div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/40654a69531dcc4e9-epic/img/facebook_app.png" alt="" /></div></a>
