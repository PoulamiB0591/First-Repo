...
<!--SFPPAGE-->
  ...
  <link rel="stylesheet" href="//test.scampaigns.com/user_template/81854ab7c7a93a508-Loretta_Email_Course/css/style.css">
...
<div class="header">
    <div class="container">
    	<div class="SFPTWO_IMAGEEDIT tagsimg_1">
    		<img src="//test.scampaigns.com/user_template/81854ab7c7a93a508-Loretta_Email_Course/images/1b2ayl6-fake-logo.png" class="company-logo">
        </div>
    </div>
</div>
<div class="main">
...
<div class="SFP_ROW main-center">
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-7 SFPTWO_IMAGEEDIT tagsimg_2">
        <img src="//test.scampaigns.com/user_template/81854ab7c7a93a508-Loretta_Email_Course/images/ar0imc-email-envelope.png" class="envelope img-responsive">
    </div>
    <div class="SFP_BOOT-sm-6 SFP_BOOT-md-5">
        <div class="SFP_ROW">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3">
              ...
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_1754696" id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul style="" class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_125" class="opt SFPTWO_TAGEDIT getme tag_4"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_795" class="SFPTEXT form-control" type="text"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_391" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement2" id="email_849" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 element3"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" name="submit" value="Send the eCourse" type="submit"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 element4"><div id="labeledit" class="labeledit singledrag"><p id="pid_942" class="opt SFPTWO_TAGEDIT note tag_6"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
               ...
               <!-- <[dropdown-option(class)]->"getme"/>-->
                ...
                <li class="dottedLi ui-draggable SFPTWO_TEXTEDIT tags_26 element5"><div id="labeledit" class="labeledit timedrag"><p id="pid_908" class="opt SFPTWO_TAGEDIT getme tag_24"><font class="SFPCOLOR">Label</font></p></div><input name="textboxelement5" id="timepicker1" onclick="timepick(1)" type="text"></li><li class="dottedLi SFPTWO_TEXTEDIT tags_27 element6"><div id="labeledit" class="labeledit datedrag"><p id="pid_395" class="opt SFPTWO_TAGEDIT getme tag_25"><font class="SFPCOLOR">Label</font></p></div><input name="textboxelement6" id="datepicker1" onclick="datepick(1)" type="text"></li></ul></form></span></div>
               </div> 
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-3.newrelic.com","licenseKey":"f767fe6f50","applicationID":"5899235","transactionName":"YFwEMkZYX0ZYBhINVlkWMxRdFkRGXBc5EFxaSQoHQFweDQhdU1BYVQ4FUVUAAlQMVV5JdVhLAxJAWG5wVAQPCGZ0VhMUR1weXFcBAxwXR1EW","queueTime":0,"applicationTime":0,"atts":"TBsHRA5CTEg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script></body>
</html>
...
<div style="display: block;" id="pubCam" class="popup_new">
    ...
    <input value="906" id="cNo" type="hidden">
   ...
   <iframe id="tabPr" src="http://test.scampaigns.com/user_template/81854ab7c7a93a508-Loretta_Email_Course/index.php"></iframe>
    ...
    <div id="fieldLabel" class="radios"><label id="webUrl"> http://test.scampaigns.com/Apps/ffdd/906</label></div>
   </div>
     		...
     		<div>
                <ul class="link_all">
                    ...
                    <li id="webLView" style="">
                    	<strong>Your WEB link is (smartlink):</strong>
                        <a href=" http://test.scampaigns.com/Apps/ffdd/906" class="" id="webLinkView" style="cursor: pointer;" target="_blank"> http://test.scampaigns.com/Apps/ffdd/906</a>
                    </li>
