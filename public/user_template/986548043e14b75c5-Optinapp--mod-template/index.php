<img src="https://test.scampaigns.com/img/divider.png" id="imgdragable" style="position: absolute; top: 904px; display: none;">
...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/986548043e14b75c5-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/986548043e14b75c5-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div class="SFPTWO_IMAGEEDIT tagsimg_1"><img id="images1" src="//test.scampaigns.com/user_template/986548043e14b75c5-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%; margin:0 0 8px 0;"></div> 
<div class="SFPTWO_IMAGEEDIT tagsimg_2"><img id="images1" src="//test.scampaigns.com/user_template/986548043e14b75c5-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"></div>         
...
<form name="form_783831" id="editable" action="" class="SFPTWO_EDITFORM" style="margin-top:25px;" method="post">

 <img src="https://test.scampaigns.com/img/divider.png" id="imgdrag" style="position: relative; top: 282px; display: none;">
...
<li id="trigme" style="display: none;">
  <div>dd</div> 
	...
	<li style="display: list-item;" class="">
    	<li class="dottedLi SFPTWO_TEXTEDIT tags_5"><div id="labeledit" class="labeledit timedrag"><p id="pid_588" class="opt SFPTWO_TAGEDIT tag_8"><font color="#15ace7">time</font></p></div><input name="timepicker" id="timepicker1" onclick="timepick(1)" type="text"></li>
