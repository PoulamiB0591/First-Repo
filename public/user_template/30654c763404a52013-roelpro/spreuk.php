...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
      ...
      <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/30654c763404a52013-roelpro/img/favicon.ico"> SFPhide-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/30654c763404a52013-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/30654c763404a52013-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/30654c763404a52013-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/30654c763404a52013-roelpro/js/app.js"></SFPScript-->
    ...
    <div class="main_wrapper SFPTWO_BACKGROUND">
          <div class="container-fluid top"> 
                ...
                <div class="SFPTWO_IMAGEEDIT expl tagsimg_1">
                   ...
                   <div class="setting-2" style="display: none;"><a title="Edit" class="edit" href="javascript:void(0)"></a><a title="delete" class="delete" href="javascript:void(0)"></a><input value="30654c763404a52013-roelpro" id="hid" type="hidden"><input value="0" id="imgCount" type="hidden"></div></div>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container SFP_ROW">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_1 bydelete" contenteditable="false"><a class="disabled" href="SFP_index" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_2 bydelete" contenteditable="false"><a class="disabled" href="SFP_Redirect/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_3 bydelete editme" contenteditable="false"><a class="disabled" href="SFP_Redirect/bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="SFP_BOOT-lg-12">
                    <div class="SFPTWO_TEXTEDIT tags_1"><h2 class="SFPTWO_TAGEDIT explicit_edit  tag_4 justifyme" contenteditable="false">Voer je spreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
