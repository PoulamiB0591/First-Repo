       ...
       <!--SFPhide  <div class="overlay_div">
        ...
        <div class="main_wrapper">
            ...
            <div class="main_content">
                ...
                <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">fdf!</h2><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/9095472daf46b1587-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</!--SFPScript> 
