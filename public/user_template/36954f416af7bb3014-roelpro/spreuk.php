...
file_put_contents("/var/www/staging/public/Apps/gtdfgdfghdfgd/93/upload/".$imgs, $unencodedData);
$imglink = "/var/www/staging/public/Apps/gtdfgdfghdfgd/93/upload/".$imgs;
//echo $imglink;
...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
       ...
       <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/36954f416af7bb3014-roelpro/img/favicon.ico"> 
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/36954f416af7bb3014-roelpro/js/style.css">
        ...
        <script type="text/javascript" src="//test.scampaigns.com/user_template/36954f416af7bb3014-roelpro/js/html2canvas.js"></script>
        <script type="text/javascript" src="//test.scampaigns.com/user_template/36954f416af7bb3014-roelpro/js/jquery.plugin.html2canvas.js"></script>
        <script src="//test.scampaigns.com/user_template/36954f416af7bb3014-roelpro/js/app.js"></script>
          ...
          <div class="container-fluid top"> 
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_1 tagdelete" contenteditable="false"><a class="disabled" href="/Apps/gtdfgdfghdfgd/93/index.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_2 tagdelete" contenteditable="false"><a class="disabled" href="//test.scampaigns.com/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Persoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT tag_3 tagdelete" contenteditable="false"><a class="disabled" href="//test.scampaigns.com/bedankt.php" id="Bedankt" title="Bedankt">3) Bedankt</a></li>
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div style="height: 0px;" class="textme"></div><div class="textme"></div><div class="SFPTWO_TEXTEDIT tags_1 texttagdelete spaceedit"><h2 class="SFPTWO_TAGEDIT explicit_edit  tag_4 tagdelete editme bydelete justifyme" contenteditable="false">Voer je sxbcvbcvbcvbcbcvbcvbcvbcvbpreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                    ...
                    <div class="textme"></div><div class="textme"></div><div class="SFPTWO_TEXTEDIT tags_2 texttagdelete"><h3 class="SFPTWO_TAGEDIT explicit_edit tag_5 tagdelete" contenteditable="false">Wat is jouw lijfspreuk als professional?</h3><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div><div class="setting-2" id="text" style="display:none"><a title="delete" class="delete" href="javascript:void(0)"></a><a title="Spacing" class="spacing" href="javascript:void(0)"></a></div></div>
                </div>
                </div><!-- end of container -->
