...
<style>
    ...
    <body style="position: inherit;">
       ...
       <!--SFPhide  <div class="overlay_div">
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff" contenteditable="false"><a class="disabled" href="SFP_index" title="Kies je tegel en foto" id="Kies">1) Kies je tggggggggegel en foto</a></li>
                    	<li class="explicit_edit enteroff" contenteditable="false"><a class="disabled" href="SFP_Redirect/spreuk.php" id="spreuk" title="Persoonlijke spreuk">2) Pggggggggersoonlijke spreuk</a></li>
                    	<li class="explicit_edit enteroff" contenteditable="false"><a class="disabled" href="SFP_Redirect/bedankt.php" id="Bedankt" title="Bedankt">3) Bhhhhhhhhhhhhhedankt</a></li>
                    </ul>
                    </div>
                </div><!-- end of container -->
            </div><!-- end of top -->
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/3755474715611f117-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</!--SFPScript> 
