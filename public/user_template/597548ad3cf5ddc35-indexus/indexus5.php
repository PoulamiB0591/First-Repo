            ...
            <div class="container">
                        ...
                        <div class="main_content">
                            ...
                            <fieldset class="radios">
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s1">2</span></label>
                                <label class="label_radio"><input value="2" name="indexusapp" type="radio"> <span id="s2">1</span></label>
