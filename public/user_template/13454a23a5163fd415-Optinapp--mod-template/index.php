...
<link rel="stylesheet" href="//test.scampaigns.com/user_template/13454a23a5163fd415-Optinapp--mod-template/css/style.css">
...
<link rel="stylesheet" type="text/css" media="all" href="//test.scampaigns.com/user_template/13454a23a5163fd415-Optinapp--mod-template/css/jui.checkboxes.css">
...
<div style="height: 299px; width: 762px;" id="editable" class="SFPTWO_IMAGEEDIT tagsimg_1 imgEdit1 ui-resizable imgEdit2 imgEdit3"><div class="ui-draggable" id="draggable0" style="z-index: 0; position: absolute; left: -168px; top: -199px;"><div><div class="ui-resizable" id="resizable0" style="z-index: 0; height: 284px; width: 243.213px; top: 201px; left: 172px;"><img class="layeredImage" id="images0" src="http://test.scampaigns.com/library/b7444c9aa69a9d19e4876f368c1dd974.jpg" style="height:100%; width:100%; z-index:0;"></div></div></div></div> 
<!--<div class="SFPTWO_IMAGEEDIT"><img id="images1" src="//test.scampaigns.com/user_template/13454a23a5163fd415-Optinapp--mod-template/img/top-img.jpg" alt="" style="width: 100%;"/></div>         
 -->       
