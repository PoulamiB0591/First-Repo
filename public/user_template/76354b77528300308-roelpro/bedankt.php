...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]--><head>
        ...
        <title>Roel - Welcome to our Website!</title>
         <!--SFPhide <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/76354b77528300308-roelpro/img/favicon.ico"> SFPhide-->
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <!-- Place favicon.ico and apple-touch-icon.png in the root directory -->

        <link rel="stylesheet" href="//test.scampaigns.com/user_template/76354b77528300308-roelpro/css/normalize.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/76354b77528300308-roelpro/css/bootstrap.min.css">
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/76354b77528300308-roelpro//css/main.css">
        <!--SFPScript type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/html2canvas.js"></SFPScript-->
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/jquery.plugin.html2canvas.js"></SFPScript-->   
       <!--SFPScript src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/vendor/modernizr-2.6.2.min.js"></SFPScript-->
...
<style>
    ...
    <body style="position: inherit;">
       ...
       <!--SFPhide  <div class="overlay_div">
        <img class="loading_img" src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/712.GIF" /> 
        </div> SFPhide-->
    ...
    <div class="main_wrapper">
         ...
         <div class="container-fluid top">
                ...
                <div class="SFPTWO_IMAGEEDIT expl">
                	<img id="images1" src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/img/logo.jpg" alt=""/><!-- end of logo -->
                   </div>
                      <div  class="explicit_edit"><a style="cursor: pointor;"  title="Nodig je vrienden uit" class="invite" onclick="invite()"><img src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/img/facebook_icon.png" alt=""><span class="explicit_edit">Nodig je<br>vrienden uit</span></a><!-- end of invite -->
                    </div>
        ...
        <!--SFPScript> window.jQuery || document.write('<!--SFPScript src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/vendor/jquery-1.10.2.min.js"><\/script>')</SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/plugins.js"></SFPScript-->
        <!--SFPScript src="//test.scampaigns.com/user_template/76354b77528300308-roelpro/js/main.js"></SFPScript-->
