...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <section class="main_step4">
            <div class="container">
                        <header>
                            <a title="Indexus" class="logo disabled"><div class="SFPTWO_IMAGEEDIT"><img src="//test.scampaigns.com/user_template/3015481ab533bc4d7-indexus/img/logo.png" alt=""></div></a>
                        ...
                        <div class="main_content">
                            ...
                            <ul class="profiel">
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/3015481ab533bc4d7-indexus/img/defensief_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Defensief</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/3015481ab533bc4d7-indexus/img/neutraal_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Neutraal</span>
                                </li>
                            	<li>
                                	<img src="//test.scampaigns.com/user_template/3015481ab533bc4d7-indexus/img/offensief_img.png" alt="">
                                    <label class="label_radio"><input type="radio"></label>
                                    <span>Offensief</span>
                                </li>
                            </ul>
                             <a class="button_btn disabled" style="cursor: pointer;" onclick="validation();">Volgende stap<img src="//test.scampaigns.com/user_template/3015481ab533bc4d7-indexus/img/icon3.png" alt=""></a>
