...
<!--[if gt IE 8]><!-->  <!--<![endif]-->
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/style.css">
        ...
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/html2canvas.js"></!--SFPScript> 
        <!--SFPScript type="text/javascript" src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/jquery.plugin.html2canvas.js"></!--SFPScript> 
        <!--SFPScript src="//test.scampaigns.com/user_template/2215476f9024b8715-roelpro/js/app.js"></!--SFPScript> 
          ...
          <div class="container-fluid top">
            ...
            <div class="main_content">
            	<div class="container-fluid bedankt-wrap">
                 <div class="col-lg-12">
                    <div class="SFPTWO_TEXTEDIT"><h2 class="SFPTWO_TAGEDIT explicit_edit" contenteditable="false">Voer je ukykyukykykspreuk in ...</h2><div class="setting-2" id="text" style="display: none;"><a title="delete" class="delete" href="javascript:void(0)"></a></div></div>
        ...
        <div id="target" class="img-cont">
             ...
             <p class="info fittext" id="mepreview" text="myText"></p>
               <p class="info-new fittext" id="mepreview2" text="myText"></p>
                ...
                <form enctype="multipart/form-data" action="bedankt.php" id="frms" name="form_1696771" method="post" class="lijfspreuk">
