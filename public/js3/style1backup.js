...
//strt...........
	$(document).ready(function() {
		...
		$('#content-editor').freshereditor({toolbar_selector: "#toolbar", excludes: ['removeFormat','justifyleft','justifycenter','justifyright','justifyfull', 'insertheading4','strikethrough','insertimage','insertorderedlist','insertunorderedlist','insertparagraph','insertheading1','insertheading2','insertheading3','blockquote','superscript','code','subscript','backcolor']});
