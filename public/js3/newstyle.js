  ...
  //Save Page on save Button click
   ...
   // $('.urlset').removeClass('disabled'); 
        ...
        $.ajax({
            ...
            $(".wrapper .SFPTWO_TAGEDIT").parent().append("<div class='setting-2' id='text' style='display:none'><a title='delete' class='delete' href='javascript:void(0)'></a><a title='Spacing' class='spacing' href='javascript:void(0)'></a><a title='Background change' class='SFPTWO_BACKGROUNDSingle' href='javascript:void(0)'></a></div>");
              $(".wrapper .SFPTWO_EDITFORM ul").find("li").find(".selectboxaddnow").append('<div class="seteditopt"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> ');
            $(".wrapper .SFPTWO_EDITFORM ul").find("li").find(".chkboxaddnow").append('<div class="setedit"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> ');
            $(".wrapper .SFPTWO_EDITFORM ul").find("li").find(".dropdowndrag").append('<div class="seteditdrop"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> ');
...
//        $("#editable").css('height',containHeight);
    ...
    // Set the options for the effect type chosen
     ...
     $('.in_back').val('SFPTWO_BACKGROUNDSingle');
      $("div.popup, div.popupusbackground").toggle(effect, options, duration);              
...
//            alert(found);
    ...
    $(".wrapper .SFPTWO_TAGEDIT").parent().append("<div class='setting-2' id='text' style='display:none'><a title='delete' class='delete' href='javascript:void(0)'></a><a title='Spacing' class='spacing' href='javascript:void(0)'>spacing</a><a title='Background change' class='SFPTWO_BACKGROUNDSingle' href='javascript:void(0)'></a></div>");
   // $(".SFPTWO_EDITFORM").append("<div class='setting-2' style='display:none'><a title='setup' class='setup' href='javascript:void(0)'></a><a title='delete' class='delete' href='javascript:void(0)'></a><input type='hidden' value='"+newurl+"' id='hid' /></div>"); 
   // $(".overlay").hide();
...
function getSelected() {
     ...
     $('body').on('mouseup', '.wrapper', function(e) {
              ...
              $(document).click(function(e){
                ...
                if($(e.target).is(".setSFPic") || $(e.target).closest(".setSFPic").length)
            	{
                  ...
                  $('.SFPTWO_TEXTEDIT').removeClass('SFPonlyIcon');
                	...
                	$('.SFPcloneIcon').html('');
                	$(e.target).parent().parent().find('.setting-2').first().clone().appendTo('.SFPcloneIcon');
    	            ...
    	            $('.SFPcloneIcon').find('a.SFPTWO_BACKGROUNDSingle').text("Background Change"); 
        ...
        $('body').on('click', '.SFPcloneIcon a.urlset', function(e) { 
          ...
          $('body').on('click', '.SFPcloneIcon a.SFPTWO_BACKGROUNDSingle', function(e) { 
              
        	  $('.SFPonlyIcon').find('a.SFPTWO_BACKGROUNDSingle').trigger('click');
      });  
