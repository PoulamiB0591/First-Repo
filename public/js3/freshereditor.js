    ...
    methods = {
      ...
      init: function(opts) {
        ...
        if (jQuery.inArray('forecolor', excludes) < 0) {
          $('a.toolbar_forecolor').after("<ul class='dropdown-menu colorpanel'><input type='text' id='forecolor-input' value='' /><div id='forecolor-picker'></div></ul>");
        ...
        if (jQuery.inArray('backcolor', excludes) < 0) {
          $('a.toolbar_bgcolor').after("<ul class='dropdown-menu colorpanel'><input type='text' id='bgcolor-input' value='' /><div id='bgcolor-picker'></div></ul>");
