            ...
            init: function(c) {
                ...
                p = c || {},
                    o = [
                        ...
                        [{
                            name: "FontSize",
                            label: "<span style='font:bold 16px;'>A</span><span style='font-size:8px;'>A</span>" +
                    ...
                    for (t = 0, x = g.length; t < x; t++) f = g[t],
                        jQuery.inArray(f.name, h) < 0 && (e =
                            ...
                            f.title + "' command='" + f.name + "'", f.userinput != null && (e +=
                                ...
                                e += " block='" + f.block + "'"), f.dropdown && (e += " data-toggle='dropdown'"), e += ">" + f.label + "</a>", n += e);
                ...
                if (jQuery.inArray("fontname", h) < 0) {
                    k = ["Arial", "Arial Black", "Comic Sans MS", "Courier New", "Georgia", "Helvetica", "Sans Serif", "Tahoma", "Times New Roman", "Trebuchet MS", "Verdana"], j = "";
                ...
                if (jQuery.inArray("FontSize", h) < 0) {
                    ...
                    a(".toolbar_fontsize").after("<ul class='dropdown-menu'>" + r + "</ul>"), a("a.fontsize-option").on("click", function() {
                        document.execCommand("FontSize", !1, a(this).attr("fontsize"));
                        $(".justifyme").css('line-height','normal');
                        $(".editme").css('line-height','normal');
                        $(".editme font[size]").find('font').css('font-size', '');
                        $(".editme font[size]").css('font-size', $(this).attr('fontsize') + "px").removeAttr('size') /*document.execCommand("insertHTML", !1,"<font style='font-size:" + ($(this).attr('fontsize')) + "px;'>"+ document.getSelection()+"</font>")*/ , a(this).closest(".btn-group").removeClass("open"), !1
                    })
                }
                return jQuery.inArray("forecolor", h) < 0 && (a("a.toolbar_forecolor").after("<ul class='dropdown-menu colorpanel'><input type='text' id='forecolor-input' value='' /><div id='forecolor-picker'></div></ul>"), a("#forecolor-picker").farbtastic(function(b) {
                ...
                })), jQuery.inArray("backcolor", h) < 0 && (a("a.toolbar_bgcolor").after("<ul class='dropdown-menu colorpanel'><input type='text' id='bgcolor-input' value='' /><div id='bgcolor-picker'></div></ul>"), a("#bgcolor-picker").farbtastic(function(b) {
                ...
                })),jQuery.inArray("textcolor", h) < 0 && (a("a.toolbar_text").after('<div class="form-groups" style="display:none;" onmousedown="event.preventDefault();"></div><div  id="hue-demo" class="demo" data-control="hue" onmousedown="event.preventDefault();" onclick="event.stopPropagation();"></div>')), a(this).on("focus", function() {
                	var b;
                    ...
                    if (a(this).attr("userinput") === "yes") b[d].apply(this);
                        ...
                        if ($(this).hasClass('toolbar_justifyright')) {
                            $(".editme").css('text-align', 'right');
                        }
                        if ($(this).hasClass('toolbar_justifyleft')) {
                            $(".editme").css('text-align', 'left');
                        }
                        if ($(this).hasClass('toolbar_justifycenter')) {
                            $(".editme").css('text-align', 'center');
                        }
                        if ($(this).hasClass('toolbar_justifyfull')) {
                            $(".editme").css('text-align', 'left');
                        }
