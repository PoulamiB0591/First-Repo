...
if ( !file_exists($_SERVER['DOCUMENT_ROOT']."/facebook/temporary/temp-".$values.".php") ) {

fopen($_SERVER['DOCUMENT_ROOT']."/facebook/temporary/temp-".$values.".php", "w");
...
$newfile = $_SERVER['DOCUMENT_ROOT']."/facebook/temporary/temp-".$values.".php";
...
$dst1 = $_SERVER['DOCUMENT_ROOT']."/facebook/".$values2."/".$values;
...
//
////Output to new file
//$fh = fopen($_SERVER['DOCUMENT_ROOT']."/facebook/".$values2."/".$values."/index.php", 'w+');
//
...
foreach (glob($userfolder."/*.php") as $search) {
   ...
   $contents = str_replace("SFPUPLOAD",$_SERVER['DOCUMENT_ROOT']."/facebook/".$values2."/".$values,$contents);
   ...
   $contents = str_replace("SFP_Link/","/facebook/".$values2."/".$values."/",$contents);
   $contents = str_replace("!--SFPScript","script",$contents);
   $contents = str_replace("SFPScript--","script",$contents);
    $contents=str_replace("/*SFPScript"," ",$contents);
  $contents=str_replace("SFPScript*/"," ",$contents);
  ...
  $contents=str_replace("SFPfacebookECRET",$sql['facebookecret'],$contents);
 ...
 $str = str_replace("SFP_Link/","/facebook/".$values2."/".$values."/",$str);
  $str=str_replace("SFP_index",$getindex,$str);
 $str=str_replace("SFPUPLOAD",$_SERVER['DOCUMENT_ROOT']."/facebook/".$values2."/".$values,$str);
 $str = str_replace("//PHP"," ",$str);
 $str=str_replace('SFPFBSCOPE',$var,$str);
 $str=str_replace("SFPAPPID",$sql['appid'],$str);
 $str=str_replace("SFPfacebookECRET",$sql['facebookecret'],$str);
...
include $tempfile;
 $pathfolder = $_SERVER['DOCUMENT_ROOT'].'/user_template/'.$value;
    $pathfolder1 = $_SERVER['DOCUMENT_ROOT']."/facebook/".$values2."/".$values;
...
chmod($pathfolder1, 0777);
  ...
  if($searches != $userfolder."/index.php"){ 
   ...
   $file_contents = str_replace("SFP_Link/","/facebook/".$values2."/".$values."/",$contents); 
