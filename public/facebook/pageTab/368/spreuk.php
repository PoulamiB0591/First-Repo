...
<script type="text/javascript" src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/js/jquery.cropit.js"></script>
</head>
...
//right slide	
        ...
        $('.image-editor').cropit({
          imageState: {
            src: 'http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/bg_img.png'
          }
        });
...
<form method="POST" enctype="multipart/form-data" action="fileupload.php" id="myForm">
	...
	<input type='hidden' class='sfpwatermarkbai'/>
<input type='hidden' class='watermarkdefltsfp' name ="SfpDefault" value='http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/watermark/watermark.png'/>

 
</form>
  <div class="container SFPTWO_BACKGROUND">
  <div style="display: none;" id="loaderTime" class="loaderOverlay">
	<img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/loading.gif">
	</div>
   <div class="top_section">
        <div class="SFPTWO_IMAGEEDIT logo"><a href="/facebook/pageTab/368/index.phpindex.php" title="H &amp; M"><img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/logo.png" alt="" /></a></div><!-- end of logo -->
        <div class="SFPTWO_IMAGEEDIT top_banner"><img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/top_banner.jpg" alt="" /></div><!-- end of top_banner -->
        </div>
         <div class="contest">
            <div class="text two">
            ...
            <div class="SFPTWO_TAGEDIT explicit_edit">
                ...
                <a href="#"><div class="SFPTWO_IMAGEEDIT"><img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/join_arrow.png" alt="" /></div></a>
            </div><!-- end of text/two -->
 ...
 <div class="image-editor">
         <div class="drop_browse">
         	<span><img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/drag.png" alt="" /></span>
     ...
     <!-- <div class="image-size-label">
      ...
      <div class="footer">
        ...
        <div class="SFPTWO_TAGEDIT explicit_edit">
            ...
            <div class="SFPTWO_IMAGEEDIT"><a href="#"><img src="http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/footer_logo.png" alt="" /></a></div>
        </div>
        </div>
