...
<?php
	...
	if($lastId =="")
	{
	header("Location: /facebook/pageTab/368/index.phpindex.php");
	}
...
//echo "/facebook/pageTab/368/". $rowFetchCurrent['imagePath'];
session_unset();  ?>
<body>
<div id="fb-root"></div>
<script>
...
<div class="thanks">
        <img src="<?php if($resultCurrent[0]['watermarkImage']==""){echo "http://test.scampaigns.com/user_template/1495530c5045b24915-hmPhotoSfpContest/images/thanks_img.jpg";}else{ echo "/facebook/pageTab/368/". $resultCurrent[0]['watermarkImage'];}?>"  id="ImgCanvas">
            ...
            <div class="advertise">
                ...
                <div class="FacebookLike"><div class="fb-like" data-href="<?php if($resultCurrent[0]['watermarkImage']==""){echo "";}else{ echo "/facebook/pageTab/368/". $resultCurrent[0]['watermarkImage'];}?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></div>
                </div>
