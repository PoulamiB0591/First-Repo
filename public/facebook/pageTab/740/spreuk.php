...
<!--[if gt IE 8]><!--> <html class="no-js" ng-app="plnkr"> <!--<![endif]--><head>
       ...
       <link rel="shortcut icon" type="image/x-icon" href="//test.scampaigns.com/user_template/65754ae959fba7ae5-roelpro/img/favicon.ico"> 
        ...
        <link rel="stylesheet" href="//test.scampaigns.com/user_template/65754ae959fba7ae5-roelpro/js/style.css" />
        ...
        <script src="//test.scampaigns.com/user_template/65754ae959fba7ae5-roelpro/js/app.js"></script>
        	...
        	<div class="main_navigation">
             <div class="container-fluid">
            	<div class="roel-container row">
                	<ul>
                    	<li class="explicit_edit enteroff SFPTWO_TAGEDIT"><a class=""  href="/facebook/pageTab/740/index.phpindex.php" title="Kies je tegel en foto" id="Kies">1) Kies je tegel en foto</a></li>
