...
<div class="main-heading tool-tip">
 <div class="SFPTWO_TEXTEDIT tags_1">      
    <h1 class="textedit SFPTWO_TAGEDIT edit tag_1 bydelete"><u><b><i><font style="font-size: 67px;" face="Helvetica" color="#50d1f1">5 Conversion Tricks You’re Missing</font></i></b></u></h1></div>
    ...
    <div class="col-sm-6 col-md-5">
        <div class="row">
            ...
            <div class="SFPTWO_TEXTEDIT tags_3">
                <h3 class="textedit SFPTWO_TAGEDIT edit tag_3 editme bydelete">Get the Free <br> 5-day Email Course</h3></div>
                <div style="overflow: hidden; width: 100%;">
                 
              <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a class="" style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label"><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form name="form_1402994" id="" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="position: relative; top: 369px; display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul class="sortable-list"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_827" class="opt SFPTWO_TAGEDIT getme tag_4"><font class="SFPCOLOR">First Name *</font></p></div><input name="textboxelement1" id="txtbox_933" class="SFPTEXT form-control" type="text"></li>
              <li style="display: list-item;" class="ui-draggable">
    	<li style="min-height: 109px; display: none;" class="dottedLi SFPTWO_TEXTEDIT tags_27 randtxt_625 element2"><p id="pid_591" class="opt SFPTWO_TAGEDIT  getme tag_24"><font class="SFPCOLOR">Label</font></p><div class="dropdowndrag adddrop"><select name="selectboxelement2" class="select form-control" id="hours414" style="font-family: times new roman;font-size: 15px; height: 30px;margin-bottom: 10px;width: 120px;"><option value="0">Select</option><option id="1" value="option1">option1</option><option id="2" value="option2">option2</option><option value="Option3">Option3</option></select> <div class="seteditdrop"><a title="edit" class="editnow" href="javascript:void(0)"></a></div> </div></li>
    </li><li class="dottedLi SFPTWO_TEXTEDIT tags_5 element3"><div id="labeledit" class="labeledit emaildrag"><p id="pid_225" class="opt SFPTWO_TAGEDIT getme tag_5"><font class="SFPCOLOR">Email *</font></p></div><input name="textBoxEmailelement3" id="email_250" class="SFPEMAIL form-control" type="email"></li>  
             <li class="dottedLi SFPTWO_TEXTEDIT tags_6 element4"><div id="getbtnme" class="submitdrag"><input class="btn btn-lg btn-block" name="submit" value="Send the eCourse" type="submit"></div></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_7 element5"><div id="labeledit" class="labeledit singledrag"><p id="pid_63" class="opt SFPTWO_TAGEDIT note tag_6"><font class="SFPCOLOR">Tell them you're not going to spam them and point them to your <a href="#">privacy policy</a></font></p></div></li>
             <!--[form]-->
	...
	<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
        ...
        <div class="row has-bullet-line">
            <div class="col-xs-2 col-sm-1">
             <div style="display: none;" class="SFPTWO_TEXTEDIT tags_10 randtxt_863">
            	<span class="bullet-number textedit SFPTWO_TAGEDIT edit tag_9">1</span>
                </div>
            </div>
            <div class="col-xs-10 col-sm-11 tool-tip">
            <div style="display: none;" class="SFPTWO_TEXTEDIT tags_11 randtxt_439">
                <h4 class="textedit SFPTWO_TAGEDIT edit tag_10">Here's what they Learn in Lesson 1</h4></div>
             <div style="display: none;" class="SFPTWO_TEXTEDIT tags_12 randtxt_652">   
        ...
        <div class="row has-bullet-line">
            <div class="col-xs-2 col-sm-1">
            <div style="display: none;" class="SFPTWO_TEXTEDIT tags_13 randtxt_971">
            	<span class="bullet-number textedit SFPTWO_TAGEDIT edit tag_12">2</span>
                </div>
            </div>
            <div class="col-xs-10 col-sm-11 tool-tip">
             <div style="display: none;" class="SFPTWO_TEXTEDIT tags_14 randtxt_316">
                <h4 class="textedit SFPTWO_TAGEDIT edit tag_13">A Bit About What they Learn in Lesson 2 </h4> </div>
               <div style="display: none;" class="SFPTWO_TEXTEDIT tags_15 randtxt_563">
        ...
        <div class="row has-bullet-line">
            <div class="col-xs-2 col-sm-1">
            	<div style="display: none;" class="SFPTWO_TEXTEDIT tags_16 randtxt_535">
            	<span class="bullet-number textedit SFPTWO_TAGEDIT edit tag_15">3</span>
                </div>
            </div>
            <div class="col-xs-10 col-sm-11 tool-tip">
              <div style="display: none;" class="SFPTWO_TEXTEDIT tags_17 randtxt_843">
