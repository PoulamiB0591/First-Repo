...
<div class="header">
  <div class="container">
    ...
    <img src="//test.scampaigns.com/user_template/109550164eed734112-Loretta_FreeeBook/images/1b2ayl6-fake-logo.png" class="company-logo"></div>
  </div>
</div>
<div class="main">
  <div class="container">
        ...
        <div class="row">
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <span style="position:relative;"><ul class="designelements clearfix" style="position:absolute;left:0; z-index:9999;"><li id="lilabelme" style="display:none;"><a style="cursor: pointer;" onclick="chechTypeAndAdd(this.rel)" rel="label" id="label" class=""><span>Title</span><img src="/formbuild/title_icon.png" alt=""></a></li></ul><form id="editable" action="" class="SFPTWO_EDITFORM extendform" style="margin-top:25px; clear:both;" method="post"><img src="/img/divider.png" id="imgdrag" style="display: none;"><img src="/img/divider.png" id="imgdragable" style="display: none;"><ul class="sortable-list ui-sortable"><li id="trigme" style="display: none;"><div>dd</div></li> 
              <li class="dottedLi SFPTWO_TEXTEDIT tags_4 texttagdelete element1"><div id="labeledit" class="labeledit textdrag"><p id="pid_677" class="opt SFPTWO_TAGEDIT getme tag_4 tagdelete"><font class="SFPCOLOR">First Name *</font></p></div><input type="text" name="textboxelement1" id="txtbox_177" class="SFPTEXT form-control"></li>
              <li class="dottedLi SFPTWO_TEXTEDIT tags_5 texttagdelete element2"><div id="labeledit" class="labeledit emaildrag"><p id="pid_112" class="opt SFPTWO_TAGEDIT getme tag_5 tagdelete"><font class="SFPCOLOR">Email *</font></p></div><input type="email" name="textBoxEmailelement2" id="email_29" required="required" class="SFPEMAIL form-control"></li>  
      ...
      <div class="col-sm-10 col-sm-offset-1">
        ...
        <div class="row feature-list">
          <div class="col-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/109550164eed734112-Loretta_FreeeBook/images/1s37lxi-icon-camera.png"></div>
          ...
          <div class="col-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/109550164eed734112-Loretta_FreeeBook/images/p04nuf-icon-pencil.png"></div>
          ...
          <div class="col-sm-4">
            ...
            <img src="//test.scampaigns.com/user_template/109550164eed734112-Loretta_FreeeBook/images/1enkdxx-icon-handshake.png"></div>
